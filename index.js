...
(() => {
  ...
  var $lazy_functorEffect = /* @__PURE__ */ $runtime_lazy(
    "functorEffect",
    "Effect",
    function () {
      return {
  ...
  var $lazy_applyEffect = /* @__PURE__ */ $runtime_lazy(
    "applyEffect",
    "Effect",
    function () {
      return {
  ...
  var fromCharCode2 = /* @__PURE__ */ (function () {
    var $75 = toEnumWithDefaults(boundedEnumChar)(bottom(boundedChar))(
      top(boundedChar)
    );
    return function ($76) {
  ...
  var takeFallback = function (v) {
    return function (v1) {
      ...
      if (v2 instanceof Just) {
        return (
          singleton3(v2.value0.head) + takeFallback((v - 1) | 0)(v2.value0.tail)
        );
      }
      return v1;
    };
  ...
  var $lazy_applyAff = /* @__PURE__ */ $runtime_lazy2(
    "applyAff",
    "Effect.Aff",
    function () {
      return {
    ...
    return function __do2() {
      ...
      if (rs instanceof Loading) {
        ...
        return effectCanceler(
          removeEventListener(domcontentloaded)(listener)(false)(et)
        );
      }
  ...
  var $lazy_unsafeSplit = /* @__PURE__ */ $runtime_lazy3(
    "unsafeSplit",
    "Data.Map.Internal",
    function () {
  ...
  var $lazy_unsafeSplitLast = /* @__PURE__ */ $runtime_lazy3(
    "unsafeSplitLast",
    "Data.Map.Internal",
    function () {
      return function (k, v, l, r) {
  ...
  var $lazy_patchWidget = /* @__PURE__ */ $runtime_lazy4(
    "patchWidget",
    "Halogen.VDom.DOM",
    function () {
  ...
  var $lazy_patchText = /* @__PURE__ */ $runtime_lazy4(
    "patchText",
    "Halogen.VDom.DOM",
    function () {
      return function (state3, vdom) {
  ...
  var $lazy_patchElem = /* @__PURE__ */ $runtime_lazy4(
    "patchElem",
    "Halogen.VDom.DOM",
    function () {
      return function (state3, vdom) {
  ...
  var $lazy_patchKeyed = /* @__PURE__ */ $runtime_lazy4(
    "patchKeyed",
    "Halogen.VDom.DOM",
    function () {
      return function (state3, vdom) {
  ...
  var buildProp = function (emit) {
    return function (el) {
      ...
      var $lazy_patchProp = $runtime_lazy5(
        "patchProp",
  ...
  var $lazy_freeApply = /* @__PURE__ */ $runtime_lazy6(
    "freeApply",
    "Control.Monad.Free",
    function () {
      return {
                  ...
                  return discard1(
                    ...
                    return discard1(
                      handleLifecycle(v2.lifecycleHandlers)(
                        render(v2.lifecycleHandlers)(ref2)
                      )
                    )(function () {
                      return pure6(v3.value0);
                    });
              ...
              return bind12(fresh(SubscriptionId)(ref2))(function (sid) {
                return bind12(
                  ...
                  return bind12(liftEffect4(read(ref2)))(function (v2) {
                    return discard1(
                      liftEffect4(
                        modify_2(map22(insert3(sid)(finalize)))(
                          v2.subscriptions
                        )
                      )
                    )(function () {
                  ...
                  return bind12(liftEffect4($$new(false)))(function (doneRef) {
                    return bind12(
                      fork3(
                        ...
                        )(evalM(render)(ref2)(v1.value0))
                      )
                    )(function (fiber) {
                      return discard1(
                        liftEffect4(
                          unlessM2(read(doneRef))(
                            modify_2(insert1(fid)(fiber))(v2.forks)
                          )
                        )
                      )(function () {
      ...
      return function (i2) {
        var squashChildInitializers = function (lchs) {
          return function (preInits) {
            return unDriverStateX(function (st) {
              var parentInitializer = evalM(render)(st.selfRef)(
  ...
  var renderHero = /* @__PURE__ */ section([
    /* @__PURE__ */ id2("home"),
    ...
    /* @__PURE__ */ div3([
      /* @__PURE__ */ class_("buttons"),
      /* @__PURE__ */ style(
        "display: flex; gap: 1.5rem; flex-wrap: wrap; justify-content: center;"
      )
    ])([
      /* @__PURE__ */ a([
        /* @__PURE__ */ href4("https://github.com/PolyTorus/polytorus"),
        /* @__PURE__ */ style(
        ...
        /* @__PURE__ */ target6("_blank")
      ])([/* @__PURE__ */ text5("\u4ECA\u3059\u3050\u59CB\u3081\u308B")]),
      /* @__PURE__ */ a([
        /* @__PURE__ */ href4("#docs"),
        /* @__PURE__ */ onClick(function (v) {
  ...
  var renderHeader = function (state3) {
    ...
    return header([
      ...
      nav([
        ...
        div3([style("display: flex; align-items: center; gap: 0.5rem;")])([
          div3([
            style(
        ...
        ul([
          ...
          renderNavItem("\u30DB\u30FC\u30E0")("#home")(
            state3.activeSection === "home"
          ),
          renderNavItem("\u7279\u5FB4")("#features")(
            state3.activeSection === "features"
          ),
          renderNavItem("\u30A2\u30FC\u30AD\u30C6\u30AF\u30C1\u30E3")(
            "#architecture"
          )(state3.activeSection === "architecture"),
          renderNavItem("\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8")("#docs")(
            state3.activeSection === "docs"
          ),
          li_([
            a([
              href4("https://github.com/PolyTorus/polytorus"),
              style(
  ...
  var renderGetStarted = /* @__PURE__ */ section([
    /* @__PURE__ */ id2("docs"),
    ...
    /* @__PURE__ */ div3([
      ...
      /* @__PURE__ */ div3([
        ...
        /* @__PURE__ */ ul([
          /* @__PURE__ */ style(
            "list-style: none; color: #666; line-height: 2;"
          )
        ])([
          /* @__PURE__ */ li_([
            /* @__PURE__ */ text5(
          ...
          /* @__PURE__ */ li_([/* @__PURE__ */ text5("\u2713 Git")]),
          /* @__PURE__ */ li_([
            /* @__PURE__ */ text5(
      ...
      /* @__PURE__ */ div3([/* @__PURE__ */ style("margin-bottom: 3rem;")])([
        /* @__PURE__ */ h3([
          /* @__PURE__ */ style(
            "font-size: 1.5rem; font-weight: 600; margin-bottom: 1rem; color: #333;"
          )
        ])([/* @__PURE__ */ text5("\u30A4\u30F3\u30B9\u30C8\u30FC\u30EB")]),
        /* @__PURE__ */ pre([
          /* @__PURE__ */ style(
          ...
          /* @__PURE__ */ code_([
            ...
            /* @__PURE__ */ text5("cargo build --release")
          ])
        ])
      ]),
      /* @__PURE__ */ div3([/* @__PURE__ */ style("text-align: center;")])([
        /* @__PURE__ */ a([
          /* @__PURE__ */ href4(
  ...
  var renderFooter = /* @__PURE__ */ footer([
    /* @__PURE__ */ style(
      "padding: 4rem 2rem; text-align: center; color: rgba(255,255,255,0.8);"
    )
  ])([
    /* @__PURE__ */ div3([
      /* @__PURE__ */ style("max-width: 1200px; margin: 0 auto;")
    ])([
      /* @__PURE__ */ div3([
        /* @__PURE__ */ style(
        ...
        /* @__PURE__ */ a([
          /* @__PURE__ */ href4("https://github.com/PolyTorus/polytorus"),
          /* @__PURE__ */ style("color: white; text-decoration: none;"),
          /* @__PURE__ */ target6("_blank")
        ])([/* @__PURE__ */ text5("GitHub")]),
        /* @__PURE__ */ a([
          /* @__PURE__ */ href4(
            "https://github.com/PolyTorus/polytorus/blob/main/README.ja.md"
          ),
          /* @__PURE__ */ style("color: white; text-decoration: none;"),
          /* @__PURE__ */ target6("_blank")
        ])([/* @__PURE__ */ text5("\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8")]),
        /* @__PURE__ */ a([
          /* @__PURE__ */ href4(
            "https://github.com/PolyTorus/polytorus/issues"
          ),
          /* @__PURE__ */ style("color: white; text-decoration: none;"),
          /* @__PURE__ */ target6("_blank")
        ])([/* @__PURE__ */ text5("Issues")])
      ]),
      /* @__PURE__ */ p([
        /* @__PURE__ */ style("font-size: 0.9rem; opacity: 0.8;")
      ])([
        /* @__PURE__ */ text5(
          "\xA9 2025 PolyTorus Project. All rights reserved."
        )
      ])
    ])
  ]);
  var renderFeatures = /* @__PURE__ */ (function () {
      ...
      return function (title3) {
        return function (description) {
          return div3([
            ...
            div3([style("font-size: 3rem; margin-bottom: 1rem;")])([
              text5(icon)
            ]),
            h3([
              style(
            ...
            p([style("color: #666; line-height: 1.6;")])([text5(description)])
          ]);
        };
      };
    };
    return section([
      ...
      div3([style("max-width: 1000px; margin: 0 auto; padding: 0 2rem;")])([
        h2([
          style(
    ...
    return section([
      ...
      div3([style("max-width: 1000px; margin: 0 auto; padding: 0 2rem;")])([
        ...
        div3([
          ...
          renderLayerCard("\u6C7A\u6E08\u5C64")(
            "Optimistic Rollup \u51E6\u7406"
          )("#764ba2"),
          renderLayerCard("\u5408\u610F\u5C64")(
            "Proof-of-Work \u30B3\u30F3\u30BB\u30F3\u30B5\u30B9"
          )("#667eea"),
          renderLayerCard("\u30C7\u30FC\u30BF\u53EF\u7528\u6027\u5C64")(
            "Merkle Tree \u3068\u30C7\u30FC\u30BF\u5206\u6563"
          )("#764ba2")
        ]),
        div3([
  ...
  var renderMain = /* @__PURE__ */ main([
    /* @__PURE__ */ style(
      "padding: 80px 2rem 2rem 2rem; max-width: 1200px; margin: 0 auto;"
    )
  ])([renderHero, renderFeatures, renderArchitecture, renderGetStarted]);
  var component = /* @__PURE__ */ (function () {
    var render = function (state3) {
      return div3([class_("app-root")])([
        renderHeader(state3),
        renderMain,
        renderFooter
      ]);
