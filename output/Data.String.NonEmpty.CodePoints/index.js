...
var take = function (i) {
  return function (nes) {
    ...
    return new Data_Maybe.Just(
      toNonEmptyString(Data_String_CodePoints.take(i)(s))
    );
  };
};
...
var uncons = function (nes) {
  ...
  return {
    ...
    tail: Data_String_NonEmpty_Internal.fromString(
      Data_String_CodePoints.drop(1)(s)
    )
  };
};
var fromFoldable1 = function (dictFoldable1) {
  return Data_Semigroup_Foldable.foldMap1(dictFoldable1)(
...
var fromCodePointArray = function (v) {
  ...
  return new Data_Maybe.Just(
    toNonEmptyString(Data_String_CodePoints.fromCodePointArray(v))
  );
};
...
var drop = function (i) {
  return function (nes) {
    ...
    return new Data_Maybe.Just(
      toNonEmptyString(Data_String_CodePoints.drop(i)(s))
    );
  };
};
