...
var toNullable = /* #__PURE__ */ Data_Maybe.maybe($foreign["null"])(
  $foreign.notNull
);
...
var ordNullable = function (dictOrd) {
  ...
  return {
    compare: Data_Function.on(Data_Ord.compare(Data_Maybe.ordMaybe(dictOrd)))(
      toMaybe
    ),
    Eq0: function () {
      return eqNullable1;
...
export { null, notNull } from "./foreign.js";
export {
  toMaybe,
  toNullable,
  showNullable,
