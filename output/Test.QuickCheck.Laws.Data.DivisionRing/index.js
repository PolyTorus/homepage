    ...
    return function (gen) {
      ...
      var inverse = function (dictDivisionRing1) {
        return function (a) {
          ...
          if (
            eq(mul(recip(a))(a))(mul(a)(recip(a))) &&
            eq(mul(recip(a))(a))(one) &&
            eq(mul(a)(recip(a)))(one)
          ) {
            return true;
          }
          ...
          throw new Error(
            "Failed pattern match at Test.QuickCheck.Laws.Data.DivisionRing (line 42, column 3 - line 42, column 42): " +
              [a.constructor.name]
          );
        };
      };
      ...
      return function __do() {
        ...
        Effect_Console.log(
          "Checking 'Non-zero multiplicative inverse' law for DivisionRing"
        )();
