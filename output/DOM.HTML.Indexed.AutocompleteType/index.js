...
var AutocompleteCreditCardAdditionalName = /* #__PURE__ */ (function () {
  ...
  AutocompleteCreditCardAdditionalName.value =
    new AutocompleteCreditCardAdditionalName();
...
var AutocompleteCreditCardFamilyName = /* #__PURE__ */ (function () {
  ...
  AutocompleteCreditCardFamilyName.value =
    new AutocompleteCreditCardFamilyName();
...
var AutocompleteCreditCardExpiration = /* #__PURE__ */ (function () {
  ...
  AutocompleteCreditCardExpiration.value =
    new AutocompleteCreditCardExpiration();
...
var AutocompleteCreditCardExpirationMonth = /* #__PURE__ */ (function () {
  ...
  AutocompleteCreditCardExpirationMonth.value =
    new AutocompleteCreditCardExpirationMonth();
...
var AutocompleteCreditCardExpirationYear = /* #__PURE__ */ (function () {
  ...
  AutocompleteCreditCardExpirationYear.value =
    new AutocompleteCreditCardExpirationYear();
...
var AutocompleteCreditCardSecurityCode = /* #__PURE__ */ (function () {
  ...
  AutocompleteCreditCardSecurityCode.value =
    new AutocompleteCreditCardSecurityCode();
...
var AutocompleteTelephoneCountryCode = /* #__PURE__ */ (function () {
  ...
  AutocompleteTelephoneCountryCode.value =
    new AutocompleteTelephoneCountryCode();
...
var AutocompleteTelephoneLocalPrefix = /* #__PURE__ */ (function () {
  ...
  AutocompleteTelephoneLocalPrefix.value =
    new AutocompleteTelephoneLocalPrefix();
...
var AutocompleteTelephoneLocalSuffix = /* #__PURE__ */ (function () {
  ...
  AutocompleteTelephoneLocalSuffix.value =
    new AutocompleteTelephoneLocalSuffix();
...
var renderAutocompleteType = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.AutocompleteType (line 67, column 26 - line 123, column 31): " +
      [v.constructor.name]
  );
};
var eqAutocompleteType = {
  eq: function (x) {
    return function (y) {
      ...
      if (
        x instanceof AutocompleteHonorificPrefix &&
        y instanceof AutocompleteHonorificPrefix
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteGivenName &&
        y instanceof AutocompleteGivenName
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteAdditionalName &&
        y instanceof AutocompleteAdditionalName
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteFamilyName &&
        y instanceof AutocompleteFamilyName
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteHonorificSuffix &&
        y instanceof AutocompleteHonorificSuffix
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteNickname &&
        y instanceof AutocompleteNickname
      ) {
        return true;
      }
      ...
      if (
        x instanceof AutocompleteUsername &&
        y instanceof AutocompleteUsername
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteNewPassword &&
        y instanceof AutocompleteNewPassword
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCurrentPassword &&
        y instanceof AutocompleteCurrentPassword
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteOneTimeCode &&
        y instanceof AutocompleteOneTimeCode
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteOrganizationTitle &&
        y instanceof AutocompleteOrganizationTitle
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteOrganization &&
        y instanceof AutocompleteOrganization
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteStreetAddress &&
        y instanceof AutocompleteStreetAddress
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteAddressLine1 &&
        y instanceof AutocompleteAddressLine1
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteAddressLine2 &&
        y instanceof AutocompleteAddressLine2
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteAddressLine3 &&
        y instanceof AutocompleteAddressLine3
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteAddressLevel1 &&
        y instanceof AutocompleteAddressLevel1
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteAddressLevel2 &&
        y instanceof AutocompleteAddressLevel2
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteAddressLevel3 &&
        y instanceof AutocompleteAddressLevel3
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteAddressLevel4 &&
        y instanceof AutocompleteAddressLevel4
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCountry &&
        y instanceof AutocompleteCountry
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCountryName &&
        y instanceof AutocompleteCountryName
      ) {
        return true;
      }
      if (
        x instanceof AutocompletePostalCode &&
        y instanceof AutocompletePostalCode
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardName &&
        y instanceof AutocompleteCreditCardName
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardGivenName &&
        y instanceof AutocompleteCreditCardGivenName
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardAdditionalName &&
        y instanceof AutocompleteCreditCardAdditionalName
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardFamilyName &&
        y instanceof AutocompleteCreditCardFamilyName
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardNumber &&
        y instanceof AutocompleteCreditCardNumber
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardExpiration &&
        y instanceof AutocompleteCreditCardExpiration
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardExpirationMonth &&
        y instanceof AutocompleteCreditCardExpirationMonth
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardExpirationYear &&
        y instanceof AutocompleteCreditCardExpirationYear
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardSecurityCode &&
        y instanceof AutocompleteCreditCardSecurityCode
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteCreditCardType &&
        y instanceof AutocompleteCreditCardType
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteTransactionCurrency &&
        y instanceof AutocompleteTransactionCurrency
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteTransactionAmount &&
        y instanceof AutocompleteTransactionAmount
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteLanguage &&
        y instanceof AutocompleteLanguage
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteBirthday &&
        y instanceof AutocompleteBirthday
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteBirthdayDay &&
        y instanceof AutocompleteBirthdayDay
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteBirthdayMonth &&
        y instanceof AutocompleteBirthdayMonth
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteBirthdayYear &&
        y instanceof AutocompleteBirthdayYear
      ) {
        return true;
      }
      ...
      if (
        x instanceof AutocompleteTelephone &&
        y instanceof AutocompleteTelephone
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteTelephoneCountryCode &&
        y instanceof AutocompleteTelephoneCountryCode
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteTelephoneNational &&
        y instanceof AutocompleteTelephoneNational
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteTelephoneAreaCode &&
        y instanceof AutocompleteTelephoneAreaCode
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteTelephoneLocal &&
        y instanceof AutocompleteTelephoneLocal
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteTelephoneLocalPrefix &&
        y instanceof AutocompleteTelephoneLocalPrefix
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteTelephoneLocalSuffix &&
        y instanceof AutocompleteTelephoneLocalSuffix
      ) {
        return true;
      }
      if (
        x instanceof AutocompleteTelephoneExtension &&
        y instanceof AutocompleteTelephoneExtension
      ) {
        return true;
      }
...
var ordAutocompleteType = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.AutocompleteType (line 0, column 0 - line 0, column 0): " +
