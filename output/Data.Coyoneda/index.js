...
var foldable1Coyoneda = function (dictFoldable1) {
  ...
  return {
    ...
    foldr1: Data_Semigroup_Foldable.foldr1Default(
      foldable1Coyoneda(dictFoldable1)
    ),
    foldl1: Data_Semigroup_Foldable.foldl1Default(
      foldable1Coyoneda(dictFoldable1)
    ),
    Foldable0: function () {
...
var bindCoyoneda = function (dictBind) {
  ...
  return {
    bind: function (v) {
      return function (f) {
        return liftCoyoneda(
          Data_Exists.runExists(function (v1) {
...
var alternativeCoyoneda = function (dictAlternative) {
  var applicativeCoyoneda1 = applicativeCoyoneda(
