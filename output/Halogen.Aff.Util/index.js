...
var bindFlipped1 = /* #__PURE__ */ Control_Bind.bindFlipped(
  Data_Maybe.bindMaybe
);
var pure1 = /* #__PURE__ */ Control_Applicative.pure(Effect.applicativeEffect);
var map = /* #__PURE__ */ Data_Functor.map(Effect.functorEffect);
var discard = /* #__PURE__ */ Control_Bind.discard(Control_Bind.discardUnit);
var throwError = /* #__PURE__ */ Control_Monad_Error_Class.throwError(
  Effect_Aff.monadThrowAff
);
...
var runHalogenAff = /* #__PURE__ */ Effect_Aff.runAff_(
  /* #__PURE__ */ Data_Either.either(Effect_Exception.throwException)(
    /* #__PURE__ */ Data_Function["const"](
      /* #__PURE__ */ pure1(Data_Unit.unit)
    )
  )
);
var awaitLoad = /* #__PURE__ */ Effect_Aff.makeAff(function (callback) {
  return function __do() {
    var rs = bindFlipped(Web_HTML_HTMLDocument.readyState)(
      bindFlipped(Web_HTML_Window.document)(Web_HTML.window)
    )();
    if (rs instanceof Web_HTML_HTMLDocument_ReadyState.Loading) {
      ...
      Web_Event_EventTarget.addEventListener(
        Web_HTML_Event_EventTypes.domcontentloaded
      )(listener)(false)(et)();
      return Effect_Aff.effectCanceler(
        Web_Event_EventTarget.removeEventListener(
          Web_HTML_Event_EventTypes.domcontentloaded
        )(listener)(false)(et)
      );
    }
...
var awaitBody = /* #__PURE__ */ discard(Effect_Aff.bindAff)(awaitLoad)(
  function () {
    return bind(selectElement("body"))(function (body) {
      return Data_Maybe.maybe(
        throwError(Effect_Exception.error("Could not find body"))
      )(pure)(body);
    });
  }
);
export { awaitLoad, awaitBody, selectElement, runHalogenAff };
