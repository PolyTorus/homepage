  ...
  left: function (v) {
    return new Stall(
      function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Lens.Internal.Stall (line 36, column 9 - line 38, column 35): " +
            [v1.constructor.name]
        );
      },
      function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Lens.Internal.Stall (line 40, column 9 - line 42, column 36): " +
            [v1.constructor.name]
        );
      }
    );
  ...
  right: function (v) {
    return new Stall(
      function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Lens.Internal.Stall (line 47, column 9 - line 49, column 41): " +
            [v1.constructor.name]
        );
      },
      function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Lens.Internal.Stall (line 51, column 9 - line 53, column 38): " +
            [v1.constructor.name]
        );
      }
    );
...
export { Stall, functorStall, profunctorStall, strongStall, choiceStall };
