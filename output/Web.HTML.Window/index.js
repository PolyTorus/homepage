...
var promptDefault = function (msg) {
  return function (defaultText) {
    return function (window) {
      return map(Data_Nullable.toMaybe)(
        $foreign["_prompt"](msg)(defaultText)(window)
      );
    };
  };
};
...
var open = function (url$prime) {
  return function (name) {
    return function (features) {
      return function (window) {
        return map(Data_Nullable.toMaybe)(
          $foreign["_open"](url$prime)(name)(features)(window)
        );
      };
    };
  };
...
var fromEventTarget =
  /* #__PURE__ */ Web_Internal_FFI.unsafeReadProtoTagged("Window");
