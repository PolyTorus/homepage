  ...
  return {
    append: function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Maybe (line 182, column 1 - line 185, column 43): " +
...
var maybe$prime = function (v) {
  return function (v1) {
    return function (v2) {
      ...
      throw new Error(
        "Failed pattern match at Data.Maybe (line 250, column 1 - line 250, column 62): " +
...
var isNothing = /* #__PURE__ */ maybe(true)(
  /* #__PURE__ */ Data_Function["const"](false)
);
var isJust = /* #__PURE__ */ maybe(false)(
  /* #__PURE__ */ Data_Function["const"](true)
);
var genericMaybe = {
  to: function (x) {
    ...
    throw new Error(
      "Failed pattern match at Data.Maybe (line 227, column 1 - line 227, column 52): " +
        [x.constructor.name]
    );
  },
  from: function (x) {
  ...
  return {
    compare: function (x) {
      return function (y) {
        ...
        throw new Error(
          "Failed pattern match at Data.Maybe (line 0, column 0 - line 0, column 0): " +
  ...
  return {
    ...
    add: function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Maybe (line 190, column 1 - line 198, column 28): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    },
