...
var lower = /* #__PURE__ */ Control_Comonad_Trans_Class.lower(
...
var seeks = function (dictComonadStore) {
  ...
  var duplicate = Control_Extend.duplicate(
    dictComonadStore.Comonad0().Extend0()
  );
  return function (f) {
    var $50 = peeks1(f);
    return function ($51) {
...
var comonadStoreTracedT = function (dictComonadStore) {
  ...
  return function (dictMonoid) {
    var lower1 = Control_Comonad_Trans_Class.lower(
      Control_Comonad_Traced_Trans.comonadTransTracedT(dictMonoid)
    )(Comonad0);
