...
var thisOrBoth = function (v) {
  return function (v1) {
    ...
    throw new Error(
      "Failed pattern match at Data.These (line 110, column 1 - line 110, column 52): " +
  ...
  return function (v1) {
    return function (v2) {
      return function (v3) {
        ...
        throw new Error(
          "Failed pattern match at Data.These (line 105, column 1 - line 105, column 79): " +
            [
              v.constructor.name,
              v1.constructor.name,
              v2.constructor.name,
...
var thatOrBoth = function (v) {
  return function (v1) {
    ...
    throw new Error(
      "Failed pattern match at Data.These (line 114, column 1 - line 114, column 52): " +
        [v.constructor.name, v1.constructor.name]
    );
  };
};
  ...
  return function (dictShow1) {
    ...
    return {
      show: function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.These (line 98, column 1 - line 101, column 63): " +
            [v.constructor.name]
        );
      }
    };
      ...
      append: function (v) {
        return function (v1) {
          ...
          if (v instanceof Both && v1 instanceof Both) {
            return new Both(
              append1(v.value0)(v1.value0),
              append2(v.value1)(v1.value1)
            );
          }
          throw new Error(
            "Failed pattern match at Data.These (line 23, column 1 - line 32, column 56): " +
              [v.constructor.name, v1.constructor.name]
          );
        };
      }
...
var maybeThese = function (v) {
  return function (v1) {
    ...
    throw new Error(
      "Failed pattern match at Data.These (line 120, column 14 - line 124, column 30): " +
        [v.constructor.name, v1.constructor.name]
    );
  };
};
...
var functorThese = {
  map: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.These (line 34, column 1 - line 37, column 26): " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  }
...
var fromThese = function (v) {
  return function (v1) {
    return function (v2) {
      ...
      throw new Error(
        "Failed pattern match at Data.These (line 130, column 1 - line 130, column 58): " +
  ...
  traverse: function (dictApplicative) {
    ...
    return function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.These (line 47, column 1 - line 53, column 37): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    };
    ...
    return {
      compare: function (x) {
        return function (y) {
          ...
          throw new Error(
            "Failed pattern match at Data.These (line 0, column 0 - line 0, column 0): " +
  ...
  bimap: function (v) {
    return function (v1) {
      return function (v2) {
        ...
        throw new Error(
          "Failed pattern match at Data.These (line 55, column 1 - line 58, column 42): " +
            [v.constructor.name, v1.constructor.name, v2.constructor.name]
        );
      };
    };
...
var bitraversableThese = {
    ...
    return function (v) {
      return function (v1) {
        return function (v2) {
          ...
          throw new Error(
            "Failed pattern match at Data.These (line 65, column 1 - line 69, column 44): " +
              [v.constructor.name, v1.constructor.name, v2.constructor.name]
          );
        };
      };
  ...
  bisequence: function (dictApplicative) {
    return Data_Bitraversable.bitraverse(bitraversableThese)(dictApplicative)(
      identity
    )(identity);
  },
  Bifunctor0: function () {
...
var assoc = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.These (line 184, column 9 - line 191, column 41): " +
      [v.constructor.name]
  );
};
  ...
  return {
    apply: function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.These (line 71, column 1 - line 78, column 52): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    },
    ...
    bind: function (v) {
      return function (v1) {
        ...
        if (v instanceof Both) {
          ...
          throw new Error(
            "Failed pattern match at Data.These (line 87, column 5 - line 90, column 34): " +
              [v2.constructor.name]
          );
        }
        throw new Error(
          "Failed pattern match at Data.These (line 83, column 1 - line 90, column 34): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    },
