...
var semigroupDual =
  /* #__PURE__ */ Data_Monoid_Dual.semigroupDual(foldRight1Semigroup);
...
var foldl1Default = function (dictFoldable1) {
  var $165 = Data_Function.flip(
    (function () {
      var $167 = alaF(Data_Monoid_Dual.Dual)(
        foldMap1(dictFoldable1)(semigroupDual)
      )(mkFoldRight1);
      return function ($168) {
...
var traverse1_ = function (dictFoldable1) {
  ...
  return function (dictApply) {
    ...
    return function (f) {
      return function (t) {
        return voidRight(Data_Unit.unit)(
          getAct(
            foldMap12(function ($172) {
              return Act(f($172));
            })(t)
          )
        );
