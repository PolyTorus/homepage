...
var value3 = /* #__PURE__ */ CSS_Property.value(
...
var valTransformOriginOffset = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.Transform (line 125, column 1 - line 131, column 45): " +
        [v.constructor.name]
    );
  }
};
var value5 = /* #__PURE__ */ CSS_Property.value(
  /* #__PURE__ */ CSS_Property.valTuple(
    /* #__PURE__ */ CSS_Property.valTuple(valTransformOriginOffset)(
...
var valTransformOrigin = {
  value: function (v) {
    if (v instanceof TransformOrigin) {
      return value5(
        new Data_Tuple.Tuple(new Data_Tuple.Tuple(v.value0, v.value1), v.value2)
      );
    }
    ...
    throw new Error(
      "Failed pattern match at CSS.Transform (line 133, column 1 - line 137, column 37): " +
        [v.constructor.name]
    );
  }
};
...
var translate3d = function (x) {
  return function (y) {
    return function (z) {
      return append(fromString("translate3d("))(
        append(value1([value(x), value(y), value(z)]))(fromString(")"))
      );
    };
  };
};
var translate = function (x) {
  return function (y) {
    return append(fromString("translate("))(
      append(value1([value(x), value(y)]))(fromString(")"))
    );
  };
};
...
var transform = /* #__PURE__ */ CSS_Stylesheet.key(valTransformation)(
  /* #__PURE__ */ fromString1("transform")
);
...
var scale3d = function (x) {
  return function (y) {
    return function (z) {
      return append(fromString("scale3d("))(
        append(value3([x, y, z]))(fromString(")"))
      );
    };
  };
};
var scale = function (x) {
  return function (y) {
    return append(fromString("scale("))(
      append(value3([x, y]))(fromString(")"))
    );
  };
};
...
var rotate3d = function (x) {
  return function (y) {
    return function (z) {
      return function (a) {
        return append(fromString("rotate3d("))(
          append(value1([value2(x), value2(y), value2(z), value4(a)]))(
            fromString(")")
          )
        );
      };
                      ...
                      return function (z2) {
                        return function (w3) {
                          return function (x3) {
                            return function (y3) {
                              return function (z3) {
                                return append(fromString("matrix3d("))(
                                  append(
                                    value3([
                                      w0,
                                      x0,
    ...
    return function (w) {
      return function (x) {
        return function (y) {
          return function (z) {
            return append(fromString("matrix3d("))(
              append(value3([u, v, w, x, y, z]))(fromString(")"))
            );
          };
        };
      };
