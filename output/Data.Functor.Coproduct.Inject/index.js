...
var injectLeft = /* #__PURE__ */ (function () {
  return {
    ...
    prj: Data_Functor_Coproduct.coproduct(Data_Maybe.Just.create)(
    ...
    inj: (function () {
      ...
      return function ($9) {
        return Data_Functor_Coproduct.Coproduct(
          Data_Either.Right.create($8($9))
        );
      };
    })(),
    prj: Data_Functor_Coproduct.coproduct(
      Data_Function["const"](Data_Maybe.Nothing.value)
    )(prj(dictInject))
  };
};
export { inj, prj, injectReflexive, injectLeft, injectRight };
