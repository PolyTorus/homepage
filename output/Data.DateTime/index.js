...
var fromEnum4 = /* #__PURE__ */ Data_Enum.fromEnum(
  Data_Time_Component.boundedEnumMinute
);
var fromEnum5 = /* #__PURE__ */ Data_Enum.fromEnum(
  Data_Time_Component.boundedEnumSecond
);
var fromEnum6 = /* #__PURE__ */ Data_Enum.fromEnum(
...
var toEnum4 = /* #__PURE__ */ Data_Enum.toEnum(
  Data_Time_Component.boundedEnumMinute
);
var toEnum5 = /* #__PURE__ */ Data_Enum.toEnum(
  Data_Time_Component.boundedEnumSecond
);
var toEnum6 = /* #__PURE__ */ Data_Enum.toEnum(
  Data_Time_Component.boundedEnumMillisecond
);
...
var boundedDateTime = /* #__PURE__ */ (function () {
  return {
    bottom: new DateTime(
      Data_Bounded.bottom(Data_Date.boundedDate),
      Data_Bounded.bottom(Data_Time.boundedTime)
    ),
    top: new DateTime(
      Data_Bounded.top(Data_Date.boundedDate),
      Data_Bounded.top(Data_Time.boundedTime)
    ),
    Ord0: function () {
      return ordDateTime;
    }
...
var adjust = function (dictDuration) {
  ...
  return function (d) {
    return function (dt) {
      return bind(
        $foreign.adjustImpl(Data_Maybe.Just.create)(Data_Maybe.Nothing.value)(
          fromDuration(d)
        )(toRecord(dt))
      )(function (rec) {
        return apply(
          map(DateTime.create)(
            join(
              apply(
                apply(map(Data_Date.exactDate)(toEnum(rec.year)))(
                  toEnum1(rec.month)
                )
              )(toEnum2(rec.day))
            )
          ...
          apply(
            apply(
              apply(map(Data_Time.Time.create)(toEnum3(rec.hour)))(
                toEnum4(rec.minute)
              )
            )(toEnum5(rec.second))
          )(toEnum6(rec.millisecond))
        );
      });
    };
  };
