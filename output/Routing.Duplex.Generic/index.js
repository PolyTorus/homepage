...
var dimap = /* #__PURE__ */ Data_Profunctor.dimap(
  Routing_Duplex.profunctorRouteDuplex
);
var noArgs = /* #__PURE__ */ (function () {
  return Control_Applicative.pure(Routing_Duplex.applicativeRouteDuplex)(
      ...
      gRouteDuplex: function (end$prime) {
        return function (r) {
          ...
          var enc = function (v2) {
            ...
            throw new Error(
              "Failed pattern match at Routing.Duplex.Generic (line 51, column 11 - line 53, column 22): " +
                [v2.constructor.name]
            );
          };
          var dec = alt(map(Data_Generic_Rep.Inl.create)(v.value1))(
            map(Data_Generic_Rep.Inr.create)(v1.value1)
          );
          return new Routing_Duplex.RouteDuplex(enc, dec);
        };
      }
    ...
    return function (dictGRouteDuplexCtr) {
      ...
      return {
        gRouteDuplex: function (end$prime) {
          return function (r) {
            var v = end$prime(
              gRouteDuplexCtr1(get(Type_Proxy["Proxy"].value)(r))
            );
            var enc = function (v1) {
              return v.value0(v1);
            };
