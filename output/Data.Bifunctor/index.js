...
var bivoid = function (dictBifunctor) {
  return bimap(dictBifunctor)(Data_Function["const"](Data_Unit.unit))(
  ...
  bimap: function (v) {
    return function (v1) {
      return function (v2) {
        ...
        throw new Error(
          "Failed pattern match at Data.Bifunctor (line 38, column 1 - line 40, column 36): " +
