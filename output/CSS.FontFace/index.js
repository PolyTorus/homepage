...
var formatName = function (v) {
  ...
  throw new Error(
    "Failed pattern match at CSS.FontFace (line 26, column 1 - line 26, column 39): " +
      [v.constructor.name]
  );
};
var valFontFaceSrc = {
  value: function (v) {
    if (v instanceof FontFaceSrcUrl) {
      return fromString(
        "url(" +
          (CSS_Property.quote(v.value0) +
            (")" +
              Data_Maybe.maybe("")(function (f$prime) {
                return (
                  " format(" + (CSS_Property.quote(formatName(f$prime)) + ")")
                );
              })(v.value1)))
      );
    }
    ...
    throw new Error(
      "Failed pattern match at CSS.FontFace (line 41, column 1 - line 43, column 71): " +
        [v.constructor.name]
    );
  }
};
var fontFaceSrc = /* #__PURE__ */ CSS_Stylesheet.key(
  /* #__PURE__ */ CSS_Property.valNonEmpty(valFontFaceSrc)
)(/* #__PURE__ */ fromString1("src"));
var fontFaceFamily = /* #__PURE__ */ (function () {
  var $67 = CSS_Stylesheet.key(CSS_Property.valLiteral)(
    fromString1("font-family")
  );
  return function ($68) {
...
var eq1 = /* #__PURE__ */ Data_Eq.eq(
  /* #__PURE__ */ Data_Maybe.eqMaybe(eqFontFaceFormat)
);
var eqFontFaceSrc = {
  eq: function (x) {
    return function (y) {
...
var ordFontFaceFormat = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.FontFace (line 0, column 0 - line 0, column 0): " +
...
var compare1 = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ Data_Maybe.ordMaybe(ordFontFaceFormat)
);
var ordFontFaceSrc = {
  compare: function (x) {
    return function (y) {
