  ...
  return function (dictEq) {
    ...
    return function (gen) {
      var implications = function (a) {
        return function (b) {
          return (
            eq(conj1(a)(implies(a)(b)))(conj1(a)(b)) &&
            eq(conj1(b)(implies(a)(b)))(b)
          );
        };
      };
      ...
      var distributiveImplication = function (a) {
        return function (b) {
          return function (c) {
            return eq(implies(a)(conj1(b)(c)))(
              conj1(implies(a)(b))(implies(a)(c))
            );
          };
        };
      };
      ...
      return function __do() {
        Effect_Console.log(
          "Checking 'Associativity of disjunction' law for HeytingAlgebra"
        )();
        quickCheck$prime(1000)(lift3(associativity(disj))(gen)(gen)(gen))();
        Effect_Console.log(
          "Checking 'Associativity of conjunction' law for HeytingAlgebra"
        )();
        quickCheck$prime(1000)(lift3(associativity(conj1))(gen)(gen)(gen))();
        Effect_Console.log(
          "Checking 'Commutativity of disjunction' law for HeytingAlgebra"
        )();
        quickCheck$prime(1000)(lift2(commutativity(disj))(gen)(gen))();
        Effect_Console.log(
          "Checking 'Commutativity of conjunction' law for HeytingAlgebra"
        )();
        quickCheck$prime(1000)(lift2(commutativity(conj1))(gen)(gen))();
        Effect_Console.log(
          "Checking 'Absorption of disjunction' law for HeytingAlgebra"
        )();
        quickCheck$prime(1000)(lift2(absorption(disj)(conj1))(gen)(gen))();
        Effect_Console.log(
          "Checking 'Absorption of conjunction' law for HeytingAlgebra"
        )();
        quickCheck$prime(1000)(lift2(absorption(conj1)(disj))(gen)(gen))();
        Effect_Console.log(
          "Checking 'Idempotent disjunction' law for HeytingAlgebra"
        )();
        quickCheck$prime(1000)(lift2(idempotent(disj))(gen)(gen))();
        Effect_Console.log(
          "Checking 'Idempotent conjunction' law for HeytingAlgebra"
        )();
        quickCheck$prime(1000)(lift2(idempotent(conj1))(gen)(gen))();
        Effect_Console.log(
          "Checking 'Disjunction identity' law for HeytingAlgebra"
        )();
        quickCheck$prime(1000)(map(identity(disj)(ff))(gen))();
        Effect_Console.log(
          "Checking 'Conjunction identity' law for HeytingAlgebra"
        )();
