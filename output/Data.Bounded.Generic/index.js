...
var genericTopProduct = function (dictGenericTop) {
  ...
  return function (dictGenericTop1) {
    return {
      "genericTop'": new Data_Generic_Rep.Product(
        genericTop$prime1,
        genericTop$prime(dictGenericTop1)
      )
    };
  };
};
...
var genericBottomProduct = function (dictGenericBottom) {
  ...
  return function (dictGenericBottom1) {
    return {
      "genericBottom'": new Data_Generic_Rep.Product(
        genericBottom$prime1,
        genericBottom$prime(dictGenericBottom1)
      )
    };
  };
};
var genericBottomSum = function (dictGenericBottom) {
  return {
    "genericBottom'": new Data_Generic_Rep.Inl(
      genericBottom$prime(dictGenericBottom)
    )
  };
};
