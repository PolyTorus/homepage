...
var renderStepValue = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.StepValue (line 13, column 19 - line 15, column 19): " +
      [v.constructor.name]
  );
};
var eqStepValue = {
...
var ordStepValue = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.StepValue (line 0, column 0 - line 0, column 0): " +
...
export { Any, Step, renderStepValue, eqStepValue, ordStepValue };
