...
var take = function (i) {
  return function (nes) {
    ...
    return new Data_Maybe.Just(
      toNonEmptyString(Data_String_CodeUnits.take(i)(s))
    );
  };
};
var takeRight = function (i) {
  return function (nes) {
    ...
    return new Data_Maybe.Just(
      toNonEmptyString(Data_String_CodeUnits.takeRight(i)(s))
    );
  };
};
...
var uncons = function (nes) {
  ...
  return {
    ...
    tail: Data_String_NonEmpty_Internal.fromString(
      Data_String_CodeUnits.drop(1)(s)
    )
  };
};
var fromFoldable1 = function (dictFoldable1) {
  var $37 = Data_Semigroup_Foldable.fold1(dictFoldable1)(
    Data_String_NonEmpty_Internal.semigroupNonEmptyString
  );
  return function ($38) {
    return $37($38);
  };
...
var fromCharArray = function (v) {
  ...
  return new Data_Maybe.Just(
    toNonEmptyString(Data_String_CodeUnits.fromCharArray(v))
  );
};
...
var dropRight = function (i) {
  return function (nes) {
    ...
    return new Data_Maybe.Just(
      toNonEmptyString(Data_String_CodeUnits.dropRight(i)(s))
    );
  };
};
var drop = function (i) {
  return function (nes) {
    ...
    return new Data_Maybe.Just(
      toNonEmptyString(Data_String_CodeUnits.drop(i)(s))
    );
  };
};
