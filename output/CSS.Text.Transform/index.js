...
var valTextTransform = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.Text.Transform (line 29, column 1 - line 35, column 39): " +
        [v.constructor.name]
    );
  }
};
...
var textTransform = /* #__PURE__ */ CSS_Stylesheet.key(valTextTransform)(
...
var showTextTransform = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.Text.Transform (line 37, column 1 - line 43, column 27): " +
        [v.constructor.name]
    );
  }
};
...
var ordTextTransform = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.Text.Transform (line 0, column 0 - line 0, column 0): " +
