...
var monoidAdditive = /* #__PURE__ */ Data_Monoid_Additive.monoidAdditive(
    ...
    return function (dictUnfoldable) {
      ...
      return function (gen) {
        var unfold = function (v) {
          ...
          if (v instanceof Cons) {
            return new Data_Maybe.Just(
              new Data_Tuple.Tuple(v.value0, v.value1)
            );
          }
          throw new Error(
            "Failed pattern match at Control.Monad.Gen (line 102, column 12 - line 104, column 35): " +
              [v.constructor.name]
          );
        };
        var loopGen = function (v) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.Gen (line 94, column 3 - line 94, column 68): " +
              [v.constructor.name]
          );
        };
        return map(unfoldr(unfold))(
          sized(
            (function () {
...
var fromIndex = function (dictFoldable1) {
  var foldMap1 = Data_Semigroup_Foldable.foldMap1(dictFoldable1)(
    Data_Semigroup_Last.semigroupLast
  );
        ...
        return function ($copy_v1) {
          ...
          function $tco_loop(v, v1) {
            ...
            if (v1 instanceof Nil) {
              $tco_done = true;
              return un(Data_Semigroup_Last.Last)(
                foldMap1(Data_Semigroup_Last.Last)(xs)
              );
            }
            throw new Error(
              "Failed pattern match at Control.Monad.Gen (line 128, column 5 - line 128, column 26): " +
...
var oneOf = function (dictMonadGen) {
  ...
  return function (dictFoldable1) {
    var length = Data_Foldable.length(dictFoldable1.Foldable0())(
  ...
  return function (pos) {
    ...
    if ($119) {
      return new Data_Tuple.Tuple(
        new Data_Maybe.Just(pos - v.value0),
        v.value1
      );
    }
...
var frequency = function (dictMonadGen) {
  ...
  return function (dictFoldable1) {
    var foldMap = Data_Foldable.foldMap(dictFoldable1.Foldable0())(
      monoidAdditive
    );
    var foldMap1 = Data_Semigroup_Foldable.foldMap1(dictFoldable1)(
    ...
    return function (xs) {
      var total = alaF(Data_Monoid_Additive.Additive)(foldMap)(Data_Tuple.fst)(
        xs
      );
      return bind(chooseFloat(0.0)(total))(
        getFreqVal(foldMap1(freqSemigroup)(xs))
      );
    };
  };
};
var filtered = function (dictMonadRec) {
  var tailRecM = Control_Monad_Rec_Class.tailRecM(dictMonadRec);
  return function (dictMonadGen) {
    var mapFlipped = Data_Functor.mapFlipped(
      dictMonadGen.Monad0().Bind1().Apply0().Functor0()
    );
    return function (gen) {
      var go = function (v) {
        return mapFlipped(gen)(function (a) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.Gen (line 118, column 24 - line 120, column 23): " +
              [a.constructor.name]
          );
        });
      };
...
export { choose, oneOf, frequency, elements, unfoldable, suchThat, filtered };
export {
  chooseBool,
  chooseFloat,
  chooseInt,
