    ...
    ix: function (x) {
      return function (dictStrong) {
        return function (dictChoice) {
          ...
          return Data_Lens_AffineTraversal.affineTraversal(set)(pre)(
            dictStrong
          )(dictChoice);
        };
      };
  ...
  ix: function (n) {
    return function (dictStrong) {
      return function (dictChoice) {
        var set = function (s) {
          return function (b) {
            return Data_Maybe.fromMaybe(s)(
              Data_Array_NonEmpty.updateAt(n)(b)(s)
            );
          };
        };
        var pre = function (s) {
          ...
          )(Data_Array_NonEmpty.index(s)(n));
        };
        return Data_Lens_AffineTraversal.affineTraversal(set)(pre)(dictStrong)(
          dictChoice
        );
      };
    };
