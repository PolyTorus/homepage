...
var thenOrCatch = function () {
  return function (k) {
    return function (c) {
      return function (p) {
        return function () {
          return Promise_Internal.thenOrCatch(
            Effect_Uncurried.mkEffectFn1(k),
            Effect_Uncurried.mkEffectFn1(c),
            p
          );
        };
      };
  ...
  return function (k) {
    return function () {
      return Promise_Internal["new"](function (onResolve, onReject) {
        return k(Effect_Uncurried.runEffectFn1(onResolve))(
...
var flattenDone = {};
var $$finally = /* #__PURE__ */ Effect_Uncurried.runEffectFn2(
  Promise_Internal["finally"]
);
...
export { reject } from "../Promise.Internal/index.js";
