...
var functorHalogenQ = {
  map: function (f) {
    return function (m) {
      ...
      throw new Error(
        "Failed pattern match at Halogen.Query.HalogenQ (line 0, column 0 - line 0, column 0): " +
          [m.constructor.name]
      );
    };
  }
  ...
  bimap: function (f) {
    return function (g) {
      return function (v) {
        ...
        throw new Error(
          "Failed pattern match at Halogen.Query.HalogenQ (line 16, column 15 - line 21, column 45): " +
            [v.constructor.name]
        );
      };
    };
