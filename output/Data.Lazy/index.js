...
var euclideanRingLazy = function (dictEuclideanRing) {
  ...
  var commutativeRingLazy1 = commutativeRingLazy(
    dictEuclideanRing.CommutativeRing0()
  );
  return {
    degree: (function () {
...
var booleanAlgebraLazy = function (dictBooleanAlgebra) {
  var heytingAlgebraLazy1 = heytingAlgebraLazy(
...
export { defer, force } from "./foreign.js";
export {
  semiringLazy,
  ringLazy,
  commutativeRingLazy,
