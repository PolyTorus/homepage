...
var print = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.UIEvent.InputEvent.InputType (line 109, column 1 - line 109, column 29): " +
      [v.constructor.name]
  );
};
var showInputType = {
...
var eqInputType = {
  eq: function (x) {
    return function (y) {
      ...
      if (
        x instanceof InsertReplacementText &&
        y instanceof InsertReplacementText
      ) {
        return true;
      }
      ...
      if (
        x instanceof InsertUnorderedList &&
        y instanceof InsertUnorderedList
      ) {
        return true;
      }
      if (
        x instanceof InsertHorizontalRule &&
        y instanceof InsertHorizontalRule
      ) {
        return true;
      }
      ...
      if (
        x instanceof InsertFromPasteAsQuotation &&
        y instanceof InsertFromPasteAsQuotation
      ) {
        return true;
      }
      ...
      if (
        x instanceof InsertCompositionText &&
        y instanceof InsertCompositionText
      ) {
        return true;
      }
      ...
      if (
        x instanceof DeleteSoftLineBackward &&
        y instanceof DeleteSoftLineBackward
      ) {
        return true;
      }
      if (
        x instanceof DeleteSoftLineForward &&
        y instanceof DeleteSoftLineForward
      ) {
        return true;
      }
      if (
        x instanceof DeleteEntireSoftLine &&
        y instanceof DeleteEntireSoftLine
      ) {
        return true;
      }
      if (
        x instanceof DeleteHardLineBackward &&
        y instanceof DeleteHardLineBackward
      ) {
        return true;
      }
      if (
        x instanceof DeleteHardLineForward &&
        y instanceof DeleteHardLineForward
      ) {
        return true;
      }
      ...
      if (
        x instanceof DeleteContentBackward &&
        y instanceof DeleteContentBackward
      ) {
        return true;
      }
      if (
        x instanceof DeleteContentForward &&
        y instanceof DeleteContentForward
      ) {
        return true;
      }
      ...
      if (
        x instanceof FormatStrikeThrough &&
        y instanceof FormatStrikeThrough
      ) {
        return true;
      }
      ...
      if (
        x instanceof FormatJustifyCenter &&
        y instanceof FormatJustifyCenter
      ) {
        return true;
      }
      ...
      if (
        x instanceof FormatSetBlockTextDirection &&
        y instanceof FormatSetBlockTextDirection
      ) {
        return true;
      }
      if (
        x instanceof FormatSetInlineTextDirection &&
        y instanceof FormatSetInlineTextDirection
      ) {
        return true;
      }
...
var ordInputType = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.UIEvent.InputEvent.InputType (line 0, column 0 - line 0, column 0): " +
