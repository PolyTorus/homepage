...
var fromUIEvent =
  /* #__PURE__ */ Web_Internal_FFI.unsafeReadProtoTagged("WheelEvent");
var fromMouseEvent =
  /* #__PURE__ */ Web_Internal_FFI.unsafeReadProtoTagged("WheelEvent");
var fromEvent =
  /* #__PURE__ */ Web_Internal_FFI.unsafeReadProtoTagged("WheelEvent");
var fromEnumDeltaMode = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.UIEvent.WheelEvent (line 91, column 3 - line 94, column 14): " +
      [v.constructor.name]
  );
};
var eqDeltaMode = {
...
var ordDeltaMode = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.UIEvent.WheelEvent (line 0, column 0 - line 0, column 0): " +
...
var enumDeltaMode = {
  succ: /* #__PURE__ */ Data_Enum.defaultSucc(toEnumDeltaMode)(
    fromEnumDeltaMode
  ),
  pred: /* #__PURE__ */ Data_Enum.defaultPred(toEnumDeltaMode)(
    fromEnumDeltaMode
  ),
  Ord0: function () {
    return ordDeltaMode;
...
export { deltaX, deltaY, deltaZ, deltaModeIndex } from "./foreign.js";
export {
  fromMouseEvent,
  fromUIEvent,
  fromEvent,
