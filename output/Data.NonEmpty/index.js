...
var showNonEmpty = function (dictShow) {
  ...
  return function (dictShow1) {
    ...
    return {
      show: function (v) {
        return (
          "(NonEmpty " + (show(v.value0) + (" " + (show1(v.value1) + ")")))
        );
      }
    };
  };
    ...
    return {
      append: function (v) {
        return function (v1) {
          return new NonEmpty(
            v.value0,
            append1(v.value1)(append1(pure(v1.value0))(v1.value1))
          );
        };
      }
    };
...
var foldableWithIndexNonEmpty = function (dictFoldableWithIndex) {
  var foldMapWithIndex = Data_FoldableWithIndex.foldMapWithIndex(
    dictFoldableWithIndex
  );
  var foldlWithIndex = Data_FoldableWithIndex.foldlWithIndex(
    dictFoldableWithIndex
  );
  var foldrWithIndex = Data_FoldableWithIndex.foldrWithIndex(
    dictFoldableWithIndex
  );
  ...
  return {
    foldMapWithIndex: function (dictMonoid) {
      ...
      return function (f) {
        return function (v) {
          return append1(f(Data_Maybe.Nothing.value)(v.value0))(
            foldMapWithIndex1(function ($246) {
    ...
    foldrWithIndex: function (f) {
      return function (b) {
        return function (v) {
          return f(Data_Maybe.Nothing.value)(v.value0)(
            foldrWithIndex(function ($248) {
...
var traversableNonEmpty = function (dictTraversable) {
  ...
  return {
    ...
    traverse: function (dictApplicative) {
      ...
      return function (f) {
        return function (v) {
          return apply(map2(NonEmpty.create)(f(v.value0)))(
            traverse1(f)(v.value1)
          );
        };
      };
    },
...
var traversableWithIndexNonEmpty = function (dictTraversableWithIndex) {
  var traverseWithIndex = Data_TraversableWithIndex.traverseWithIndex(
    dictTraversableWithIndex
  );
  var functorWithIndex1 = functorWithIndex(
    dictTraversableWithIndex.FunctorWithIndex0()
  );
  var foldableWithIndexNonEmpty1 = foldableWithIndexNonEmpty(
    dictTraversableWithIndex.FoldableWithIndex1()
  );
  var traversableNonEmpty1 = traversableNonEmpty(
  ...
  return {
    traverseWithIndex: function (dictApplicative) {
      ...
      return function (f) {
        return function (v) {
          return apply(
            map2(NonEmpty.create)(f(Data_Maybe.Nothing.value)(v.value0))
          )(
            traverseWithIndex1(function ($249) {
...
var foldable1NonEmpty = function (dictFoldable) {
  ...
  return {
    ...
    foldr1: function (f) {
      return function (v) {
        return Data_Maybe.maybe(v.value0)(f(v.value0))(
          foldr(function (a1) {
