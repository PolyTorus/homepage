  ...
  return function (m) {
    return tailRecM1(function (v) {
      return mapFlipped(m)(function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.Rec.Class (line 179, column 43 - line 181, column 19): " +
            [v1.constructor.name]
        );
      });
    })(Data_Unit.unit);
    ...
    return function (m) {
      return tailRecM1(function (v) {
        return mapFlipped(m)(function (v1) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.Rec.Class (line 172, column 45 - line 174, column 26): " +
              [v1.constructor.name]
          );
        });
      })(mempty);
...
var tailRec = function (f) {
  var go = function ($copy_v) {
    ...
    function $tco_loop(v) {
      ...
      throw new Error(
        "Failed pattern match at Control.Monad.Rec.Class (line 103, column 3 - line 103, column 25): " +
          [v.constructor.name]
      );
    }
    while (!$tco_done) {
  ...
  tailRecM: function (f) {
    return function (a0) {
      var g = function (v) {
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.Rec.Class (line 153, column 7 - line 153, column 31): " +
            [v.constructor.name]
        );
      };
  ...
  tailRecM: function (f) {
    return function (a0) {
      var g = function (v) {
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.Rec.Class (line 145, column 7 - line 145, column 33): " +
            [v.constructor.name]
        );
      };
      return tailRec(g)(f(a0));
...
var functorStep = {
  map: function (f) {
    return function (m) {
      ...
      throw new Error(
        "Failed pattern match at Control.Monad.Rec.Class (line 0, column 0 - line 0, column 0): " +
          [m.constructor.name]
      );
    };
  }
...
var forever = function (dictMonadRec) {
  var tailRecM1 = tailRecM(dictMonadRec);
  var voidRight = Data_Functor.voidRight(
    dictMonadRec.Monad0().Bind1().Apply0().Functor0()
  );
  return function (ma) {
  ...
  bimap: function (v) {
    return function (v1) {
      return function (v2) {
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.Rec.Class (line 33, column 1 - line 35, column 34): " +
