    ...
    return function (v1) {
      return function (v2) {
        return function (v3) {
          ...
          throw new Error(
            "Failed pattern match at Data.Bifoldable (line 62, column 1 - line 68, column 32): " +
              [
                v.constructor.name,
                v1.constructor.name,
                v2.constructor.name,
    ...
    return {
      ...
      bifoldMap: function (dictMonoid) {
        ...
        return function (l) {
          return function (r) {
            return function (v) {
              return append(bifoldMap3(l)(r)(v.value0))(
                bifoldMap4(l)(r)(v.value1)
              );
            };
          };
        };
...
var biany = function (dictBifoldable) {
  ...
  return function (dictBooleanAlgebra) {
    var bifoldMap2 = bifoldMap1(
      Data_Monoid_Disj.monoidDisj(dictBooleanAlgebra.HeytingAlgebra0())
    );
    return function (p) {
      return function (q) {
...
var biall = function (dictBifoldable) {
  ...
  return function (dictBooleanAlgebra) {
    var bifoldMap2 = bifoldMap1(
      Data_Monoid_Conj.monoidConj(dictBooleanAlgebra.HeytingAlgebra0())
    );
    return function (p) {
      return function (q) {
