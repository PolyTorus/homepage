...
var foldMap1 = /* #__PURE__ */ Data_Foldable.foldMap(
  Data_Foldable.foldableArray
);
...
var zipWith = /* #__PURE__ */ Data_Function_Uncurried.runFn3(
  $foreign.zipWithImpl
);
...
var updateAt = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn5($foreign["_updateAt"])(
...
var uncons = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn3($foreign.unconsImpl)(
...
var toUnfoldable = function (dictUnfoldable) {
  ...
  return function (xs) {
    ...
    var f = function (i) {
      if (i < len) {
        return new Data_Maybe.Just(
          new Data_Tuple.Tuple(unsafeIndex1(xs)(i), (i + 1) | 0)
        );
      }
      ...
      throw new Error(
        "Failed pattern match at Data.Array (line 163, column 3 - line 165, column 26): " +
          [i.constructor.name]
      );
    };
    return unfoldr(f)(0);
...
var sortBy = function (comp) {
  return Data_Function_Uncurried.runFn3($foreign.sortByImpl)(comp)(
    function (v) {
...
var replicate = /* #__PURE__ */ Data_Function_Uncurried.runFn2(
  $foreign.replicateImpl
);
var range = /* #__PURE__ */ Data_Function_Uncurried.runFn2($foreign.rangeImpl);
var partition = /* #__PURE__ */ Data_Function_Uncurried.runFn2(
  $foreign.partitionImpl
);
...
var mapWithIndex = /* #__PURE__ */ Data_FunctorWithIndex.mapWithIndex(
...
var intersperse = function (a) {
  return function (arr) {
    ...
    throw new Error(
      "Failed pattern match at Data.Array (line 623, column 21 - line 633, column 17): " +
        [v.constructor.name]
    );
  };
};
...
var insertAt = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn5($foreign["_insertAt"])(
    Data_Maybe.Just.create
  )(Data_Maybe.Nothing.value);
})();
var init = function (xs) {
  ...
  throw new Error(
    "Failed pattern match at Data.Array (line 351, column 1 - line 351, column 45): " +
      [xs.constructor.name]
  );
};
var index = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn4($foreign.indexImpl)(
    Data_Maybe.Just.create
  )(Data_Maybe.Nothing.value);
})();
  ...
  return function (arr) {
    var go = function ($copy_i) {
      ...
      function $tco_loop(i) {
        ...
        throw new Error(
          "Failed pattern match at Data.Array (line 1035, column 5 - line 1037, column 25): " +
            [v.constructor.name]
        );
      }
      while (!$tco_done) {
    ...
    throw new Error(
      "Failed pattern match at Data.Array (line 1022, column 3 - line 1028, column 30): " +
...
var nubBy = function (comp) {
  return function (xs) {
    ...
    if (v instanceof Data_Maybe.Just) {
      return map1(Data_Tuple.snd)(
        sortWith1(Data_Tuple.fst)(
          (function __do() {
            ...
            Control_Monad_ST_Internal.foreach(indexedAndSorted)(function (v1) {
              return function __do() {
                ...
                return when(
                  notEq(comp(lst)(v1.value1))(Data_Ordering.EQ.value)
                )($$void(Data_Array_ST.push(v1)(result)))();
              };
            })();
...
var fromFoldable = function (dictFoldable) {
  return Data_Function_Uncurried.runFn2($foreign.fromFoldableImpl)(
    Data_Foldable.foldr(dictFoldable)
  );
};
    ...
    return Data_Function.flip(foldl)(Data_Maybe.Nothing.value)(function (acc) {
      return function (nextArr) {
        return Data_Maybe.maybe(acc)(function (el) {
          return new Data_Maybe.Just(
            Data_Maybe.maybe([el])(Data_Function.flip(snoc)(el))(acc)
          );
        })(index(nextArr)(idx));
      };
    })(xs);
  ...
  var go = function ($copy_idx) {
    return function ($copy_allArrays) {
      ...
      function $tco_loop(idx, allArrays) {
        ...
        throw new Error(
          "Failed pattern match at Data.Array (line 837, column 22 - line 839, column 52): " +
            [v.constructor.name]
        );
      }
      while (!$tco_done) {
      ...
      return function (array) {
        var go = function (res) {
          return function (i) {
            ...
            if (Data_Boolean.otherwise) {
              return bind1(f(res)(unsafeIndex1(array)(i)))(
                function (res$prime) {
                  return pure1(
            ...
            throw new Error(
              "Failed pattern match at Data.Array (line 1349, column 3 - line 1353, column 42): " +
                [res.constructor.name, i.constructor.name]
            );
          };
        };
...
var findMap = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn4($foreign.findMapImpl)(
    Data_Maybe.Nothing.value
  )(Data_Maybe.isJust);
})();
var findLastIndex = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn4($foreign.findLastIndexImpl)(
    Data_Maybe.Just.create
  )(Data_Maybe.Nothing.value);
})();
...
var findIndex = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn4($foreign.findIndexImpl)(
    Data_Maybe.Just.create
  )(Data_Maybe.Nothing.value);
})();
var find = function (f) {
...
var filter = /* #__PURE__ */ Data_Function_Uncurried.runFn2(
  $foreign.filterImpl
);
...
var deleteAt = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn4($foreign["_deleteAt"])(
    Data_Maybe.Just.create
  )(Data_Maybe.Nothing.value);
})();
...
var concatMap = /* #__PURE__ */ Data_Function.flip(
  /* #__PURE__ */ Control_Bind.bind(Control_Bind.bindArray)
);
...
var catMaybes = /* #__PURE__ */ mapMaybe(
  ...
  return function (f) {
    return function (xs) {
      var go = function (x) {
        ...
        throw new Error(
          "Failed pattern match at Data.Array (line 601, column 10 - line 603, column 32): " +
            [v.constructor.name]
        );
      };
      return Data_Maybe.maybe(Data_Maybe.Nothing.value)(go)(index(xs)(i));
...
export { length, reverse, concat } from "./foreign.js";
export {
  fromFoldable,
  toUnfoldable,
  singleton,
