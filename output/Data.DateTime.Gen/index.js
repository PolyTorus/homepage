...
var genDateTime = function (dictMonadGen) {
  ...
  return Control_Apply.apply(Apply0)(
    Data_Functor.map(Apply0.Functor0())(Data_DateTime.DateTime.create)(
      Data_Date_Gen.genDate(dictMonadGen)
    )
  )(Data_Time_Gen.genTime(dictMonadGen));
};
export { genDateTime };
export {
  genDate,
