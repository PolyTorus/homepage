...
var joinWith1 = function (dictFoldable1) {
  var intercalate = Data_Foldable.intercalate(dictFoldable1.Foldable0())(
...
var joinWith = function (dictFoldable) {
  var intercalate = Data_Foldable.intercalate(dictFoldable)(
    Data_Monoid.monoidString
  );
...
var stripPrefix = function (pat) {
  return composeKleisliFlipped(fromString)(
    liftS(Data_String_CodeUnits.stripPrefix(pat))
  );
};
var stripSuffix = function (pat) {
  return composeKleisliFlipped(fromString)(
    liftS(Data_String_CodeUnits.stripSuffix(pat))
  );
};
var trim = function (v) {
