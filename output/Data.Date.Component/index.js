...
var showWeekday = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Date.Component (line 184, column 1 - line 191, column 25): " +
        [v.constructor.name]
    );
  }
};
var showMonth = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Date.Component (line 101, column 1 - line 113, column 29): " +
        [v.constructor.name]
    );
  }
};
...
var boundedEnumYear = {
  ...
  toEnum: function (n) {
    ...
    throw new Error(
      "Failed pattern match at Data.Date.Component (line 35, column 1 - line 40, column 24): " +
        [n.constructor.name]
    );
  },
  fromEnum: function (v) {
...
var $lazy_enumYear = /* #__PURE__ */ $runtime_lazy(
  "enumYear",
  "Data.Date.Component",
  function () {
    return {
...
var boundedEnumWeekday = {
  ...
  fromEnum: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Date.Component (line 175, column 14 - line 182, column 16): " +
        [v.constructor.name]
    );
  },
  Bounded0: function () {
...
var $lazy_enumWeekday = /* #__PURE__ */ $runtime_lazy(
  "enumWeekday",
  "Data.Date.Component",
  function () {
    return {
...
var boundedEnumMonth = {
  ...
  fromEnum: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Date.Component (line 87, column 14 - line 99, column 19): " +
        [v.constructor.name]
    );
  },
  Bounded0: function () {
...
var $lazy_enumMonth = /* #__PURE__ */ $runtime_lazy(
  "enumMonth",
  "Data.Date.Component",
  function () {
    return {
...
var boundedEnumDay = {
  ...
  toEnum: function (n) {
    ...
    throw new Error(
      "Failed pattern match at Data.Date.Component (line 133, column 1 - line 138, column 23): " +
        [n.constructor.name]
    );
  },
  fromEnum: function (v) {
...
var $lazy_enumDay = /* #__PURE__ */ $runtime_lazy(
  "enumDay",
  "Data.Date.Component",
  function () {
    return {
