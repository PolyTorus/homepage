              ...
              (function () {
                if (v2.value0 instanceof Control_Monad_Rec_Class.Loop) {
                  return new Control_Monad_Rec_Class.Loop(
                    new Data_Tuple.Tuple(v2.value0.value0, v2.value1)
                  );
                }
                ...
                throw new Error(
                  "Failed pattern match at Control.Monad.State.Trans (line 88, column 16 - line 90, column 40): " +
        ...
        return bind(listen(m(s)))(function (v) {
          return pure(
            new Data_Tuple.Tuple(
              new Data_Tuple.Tuple(v.value0.value0, v.value1),
              v.value0.value1
            )
          );
        });
...
var monadPlusStateT = function (dictMonadPlus) {
  ...
  var monadStateT1 = monadStateT(Monad0);
  var alternativeStateT1 = alternativeStateT(Monad0)(
    dictMonadPlus.Alternative1()
  );
  return {
    Monad0: function () {
      return monadStateT1;
