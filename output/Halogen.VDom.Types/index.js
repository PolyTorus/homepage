    ...
    return function (v) {
      ...
      if (v instanceof Keyed) {
        return new Keyed(
          ...
          v.value1,
          f(v.value2),
          map(map1(renderWidget(f)(g)))(v.value3)
        );
      }
      ...
      throw new Error(
        "Failed pattern match at Halogen.VDom.Types (line 48, column 20 - line 53, column 48): " +
          [v.constructor.name]
      );
    };
  };
