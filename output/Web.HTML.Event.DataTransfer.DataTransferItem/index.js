...
var showDataTransferItemKind = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Web.HTML.Event.DataTransfer.DataTransferItem (line 25, column 10 - line 27, column 19): " +
        [v.constructor.name]
    );
  }
};
...
var kind = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn5($foreign["_kind"])(
    Data_Maybe.Nothing.value
  )(Data_Maybe.Just.create)(Text.value)(File.value);
})();
...
var ordDataTransferItemKind = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.HTML.Event.DataTransfer.DataTransferItem (line 0, column 0 - line 0, column 0): " +
...
var dataTransferItem = /* #__PURE__ */ map(
  /* #__PURE__ */ map(Data_Nullable.toMaybe)
)($foreign["_dataTransferItem"]);
export { type_ } from "./foreign.js";
export {
  Text,
  File,
  dataTransferItem,
