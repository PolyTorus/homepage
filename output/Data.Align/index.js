...
var mempty = /* #__PURE__ */ Data_Monoid.mempty(
  Data_List_Lazy_Types.monoidList
);
...
var pure1 = /* #__PURE__ */ Control_Applicative.pure(
  Data_List_Lazy_Types.applicativeList
);
  ...
  crosswalk: function (dictAlignable) {
    ...
    return function (f) {
      return function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.Align (line 115, column 17 - line 118, column 31): " +
            [v.constructor.name]
        );
      };
    };
  ...
  crosswalk: function (dictAlignable) {
    ...
    return function (f) {
      return function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.Align (line 143, column 17 - line 145, column 27): " +
            [v.constructor.name]
        );
      };
    };
      ...
      return function (v2) {
        ...
        if (v1 instanceof Data_Maybe.Just && v2 instanceof Data_Maybe.Just) {
          return new Data_Maybe.Just(
            v(new Data_These.Both(v1.value0, v2.value0))
          );
        }
        throw new Error(
          "Failed pattern match at Data.Align (line 52, column 1 - line 55, column 50): " +
  ...
  align: function (v) {
    return function (v1) {
      return function (v2) {
        ...
        return append(Data_Array.zipWith(f$prime)(v1)(v2))(
          align(alignArray)(v)(xs$prime)(ys$prime)
        );
      };
    };
  },
    ...
    return function (xs) {
      return function (ys) {
        var go = function (v) {
          return function (v1) {
            if (
              v instanceof Data_List_Lazy_Types.Nil &&
              v1 instanceof Data_List_Lazy_Types.Nil
            ) {
            ...
            if (
              ...
              return new Data_List_Lazy_Types.Cons(
                f(new Data_These.This(v.value0)),
                align(alignLazyList)(f)(v.value1)(mempty)
              );
            }
            if (
              v instanceof Data_List_Lazy_Types.Nil &&
              ...
              return new Data_List_Lazy_Types.Cons(
                f(new Data_These.That(v1.value0)),
                align(alignLazyList)(f)(mempty)(v1.value1)
              );
            }
            if (
              v instanceof Data_List_Lazy_Types.Cons &&
              ...
              return new Data_List_Lazy_Types.Cons(
                f(new Data_These.Both(v.value0, v1.value0)),
                align(alignLazyList)(f)(v.value1)(v1.value1)
              );
            }
            throw new Error(
              "Failed pattern match at Data.Align (line 47, column 5 - line 47, column 48): " +
      ...
      return function (v2) {
        ...
        if (
          ...
          return new Data_List_Types.Cons(
            v(new Data_These.Both(v1.value0, v2.value0)),
            align(alignList)(v)(v1.value1)(v2.value1)
          );
        }
        throw new Error(
          "Failed pattern match at Data.Align (line 39, column 1 - line 42, column 85): " +
            [v.constructor.name, v1.constructor.name, v2.constructor.name]
        );
      };
    };
  ...
  crosswalk: function (dictAlignable) {
    ...
    return function (f) {
      return function (xs) {
        ...
        if (v instanceof Data_Maybe.Just) {
          return align1(cons)(f(v.value0.head))(
            crosswalk(crosswalkArray)(dictAlignable)(f)(v.value0.tail)
          );
        }
        throw new Error(
          "Failed pattern match at Data.Align (line 121, column 20 - line 123, column 66): " +
            [v.constructor.name]
        );
      };
    };
    ...
    return function (f) {
      return function (l) {
        ...
        if (v instanceof Data_List_Lazy_Types.Cons) {
          return align1(cons)(f(v.value0))(
            crosswalk(crosswalkLazyList)(dictAlignable)(f)(v.value1)
          );
        }
        throw new Error(
          "Failed pattern match at Data.Align (line 136, column 5 - line 138, column 62): " +
            [v.constructor.name]
        );
      };
    };
    ...
    return function (f) {
      ...
      return function (v) {
        ...
        if (v instanceof Data_List_Types.Cons) {
          return align1(cons)(f(v.value0))(
            crosswalk(crosswalkList)(dictAlignable)(f)(v.value1)
          );
        }
        throw new Error(
          "Failed pattern match at Data.Align (line 128, column 17 - line 130, column 56): " +
            [v.constructor.name]
        );
      };
    };
