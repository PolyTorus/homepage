...
var rtraverse = function (dictBitraversable) {
  var bitraverse1 = bitraverse(dictBitraversable);
  return function (dictApplicative) {
    return bitraverse1(dictApplicative)(
...
var bitraversableJoker = function (dictTraversable) {
  ...
  var bifunctorJoker = Data_Functor_Joker.bifunctorJoker(
    dictTraversable.Functor0()
  );
  var bifoldableJoker = Data_Bifoldable.bifoldableJoker(
    ...
    return function (v) {
      return function (v1) {
        return function (v2) {
          ...
          throw new Error(
            "Failed pattern match at Data.Bitraversable (line 57, column 1 - line 61, column 37): " +
...
var bitraversableClown = function (dictTraversable) {
  var traverse = Data_Traversable.traverse(dictTraversable);
  var sequence = Data_Traversable.sequence(dictTraversable);
  var bifunctorClown = Data_Functor_Clown.bifunctorClown(
    dictTraversable.Functor0()
  );
  var bifoldableClown = Data_Bifoldable.bifoldableClown(
    dictTraversable.Foldable1()
  );
  return {
    bitraverse: function (dictApplicative) {
...
var bitraversableFlip = function (dictBitraversable) {
  ...
  var bifunctorFlip = Data_Functor_Flip.bifunctorFlip(
    dictBitraversable.Bifunctor0()
  );
  var bifoldableFlip = Data_Bifoldable.bifoldableFlip(
    dictBitraversable.Bifoldable1()
  );
  return {
    bitraverse: function (dictApplicative) {
      var map = Data_Functor.map(dictApplicative.Apply0().Functor0());
...
var bitraversableProduct2 = function (dictBitraversable) {
  var bitraverse1 = bitraverse(dictBitraversable);
  var bisequence1 = bisequence(dictBitraversable);
  var bifunctorProduct2 = Data_Functor_Product2.bifunctorProduct2(
    dictBitraversable.Bifunctor0()
  );
  var bifoldableProduct2 = Data_Bifoldable.bifoldableProduct2(
    dictBitraversable.Bifoldable1()
  );
  return function (dictBitraversable1) {
    ...
    var bifoldableProduct21 = bifoldableProduct2(
      dictBitraversable1.Bifoldable1()
    );
    return {
      bitraverse: function (dictApplicative) {
        var Apply0 = dictApplicative.Apply0();
        ...
        return function (l) {
          return function (r) {
            return function (v) {
              return apply(
                map(Data_Functor_Product2.Product2.create)(
                  bitraverse3(l)(r)(v.value0)
                )
              )(bitraverse4(l)(r)(v.value1));
            };
          };
        };
      },
      bisequence: function (dictApplicative) {
        ...
        return function (v) {
          return apply(
            map(Data_Functor_Product2.Product2.create)(bisequence3(v.value0))
          )(bisequence4(v.value1));
        };
      },
      Bifunctor0: function () {
