...
var oneOf = function (dictFoldable) {
  ...
  return function (dictPlus) {
    return foldr2(Control_Alt.alt(dictPlus.Alt0()))(
  ...
  return function (cmp) {
    var max$prime = function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Foldable (line 441, column 3 - line 441, column 27): " +
...
var product = function (dictFoldable) {
  var foldl2 = foldl(dictFoldable);
  return function (dictSemiring) {
    return foldl2(Data_Semiring.mul(dictSemiring))(
...
var sum = function (dictFoldable) {
  var foldl2 = foldl(dictFoldable);
  return function (dictSemiring) {
    return foldl2(Data_Semiring.add(dictSemiring))(
      Data_Semiring.zero(dictSemiring)
    );
  };
};
  ...
  foldr: function (v) {
    return function (v1) {
      return function (v2) {
        ...
        throw new Error(
          "Failed pattern match at Data.Foldable (line 181, column 1 - line 187, column 28): " +
            [v.constructor.name, v1.constructor.name, v2.constructor.name]
        );
      };
    };
...
var any = function (dictFoldable) {
  ...
  return function (dictHeytingAlgebra) {
    return alaF(Data_Monoid_Disj.Disj)(
      foldMap2(Data_Monoid_Disj.monoidDisj(dictHeytingAlgebra))
    );
  };
};
...
var all = function (dictFoldable) {
  var foldMap2 = foldMap(dictFoldable);
  return function (dictHeytingAlgebra) {
    return alaF(Data_Monoid_Conj.Conj)(
      foldMap2(Data_Monoid_Conj.monoidConj(dictHeytingAlgebra))
    );
  };
};
