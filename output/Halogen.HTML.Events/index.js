...
var composeKleisliFlipped = /* #__PURE__ */ Control_Bind.composeKleisliFlipped(
  /* #__PURE__ */ Control_Monad_Except_Trans.bindExceptT(
    Data_Identity.monadIdentity
  )
);
var readProp = /* #__PURE__ */ Foreign_Index.readProp(
  Data_Identity.monadIdentity
);
var readString = /* #__PURE__ */ Foreign.readString(
  Data_Identity.monadIdentity
);
...
var onFileUpload = function (dictUnfoldable) {
  ...
  return function (f) {
    return handler(Web_HTML_Event_EventTypes.change)(
      (function () {
        var $19 = Data_Maybe.maybe(none)(items);
        var $20 = composeKleisli(Web_Event_Event.target)(
          composeKleisli(Web_HTML_HTMLInputElement.fromEventTarget)(
            function ($22) {
              return Effect_Unsafe.unsafePerformEffect(
                Web_HTML_HTMLInputElement.files($22)
              );
            }
          )
        );
...
var addForeignPropHandler = function (key) {
  return function (prop) {
    return function (reader) {
      return function (f) {
        var go = function (a) {
          return composeKleisliFlipped(reader)(readProp(prop))(
            Foreign.unsafeToForeign(a)
          );
        };
        return handler$prime(key)(
          composeKleisli(Web_Event_Event.currentTarget)(function (e) {
...
var onChecked = /* #__PURE__ */ addForeignPropHandler(
  Web_HTML_Event_EventTypes.change
)("checked")(/* #__PURE__ */ Foreign.readBoolean(Data_Identity.monadIdentity));
var onSelectedIndexChange = /* #__PURE__ */ addForeignPropHandler(
  Web_HTML_Event_EventTypes.change
)("selectedIndex")(
  /* #__PURE__ */ Foreign.readInt(Data_Identity.monadIdentity)
);
var onValueChange = /* #__PURE__ */ addForeignPropHandler(
  Web_HTML_Event_EventTypes.change
)("value")(readString);
var onValueInput = /* #__PURE__ */ addForeignPropHandler(
  Web_HTML_Event_EventTypes.input
)("value")(readString);
export {
  handler,
  handler$prime,
