...
var valCursor = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.Cursor (line 47, column 1 - line 80, column 40): " +
        [v.constructor.name]
    );
  }
};
...
var ordCursor = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.Cursor (line 0, column 0 - line 0, column 0): " +
...
var cursor = /* #__PURE__ */ CSS_Stylesheet.key(valCursor)(
  /* #__PURE__ */ CSS_String.fromString(CSS_Property.isStringKey)("cursor")
);
var crosshair = /* #__PURE__ */ (function () {
