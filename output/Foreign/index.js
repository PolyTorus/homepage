...
var showForeignError = {
  show: function (v) {
    ...
    if (v instanceof TypeMismatch) {
      return (
        "(TypeMismatch " + (show(v.value0) + (" " + (show(v.value1) + ")")))
      );
    }
    throw new Error(
      "Failed pattern match at Foreign (line 69, column 1 - line 73, column 89): " +
        [v.constructor.name]
    );
  }
};
var renderForeignError = function (v) {
  ...
  if (v instanceof ErrorAtIndex) {
    return (
      ...
      (show1(v.value0) + (": " + renderForeignError(v.value1)))
    );
  }
  if (v instanceof ErrorAtProperty) {
    return (
      "Error at property " +
      (show(v.value0) + (": " + renderForeignError(v.value1)))
    );
  }
  if (v instanceof TypeMismatch) {
  ...
  throw new Error(
    "Failed pattern match at Foreign (line 78, column 1 - line 78, column 45): " +
      [v.constructor.name]
  );
};
var readUndefined = function (dictMonad) {
  var pure1 = Control_Applicative.pure(
  ...
  return function (value) {
    ...
    throw new Error(
      "Failed pattern match at Foreign (line 174, column 1 - line 174, column 103): " +
...
var readNullOrUndefined = function (dictMonad) {
  ...
  return function (value) {
    ...
    throw new Error(
      "Failed pattern match at Foreign (line 179, column 1 - line 179, column 109): " +
        [value.constructor.name]
    );
  };
};
var readNull = function (dictMonad) {
  ...
  return function (value) {
    ...
    throw new Error(
      "Failed pattern match at Foreign (line 169, column 1 - line 169, column 98): " +
        [value.constructor.name]
    );
  };
};
var fail = function (dictMonad) {
  var $153 = Control_Monad_Error_Class.throwError(
...
var readArray = function (dictMonad) {
  ...
  return function (value) {
    ...
    throw new Error(
      "Failed pattern match at Foreign (line 164, column 1 - line 164, column 99): " +
        [value.constructor.name]
    );
  };
};
...
var readInt = function (dictMonad) {
  ...
  return function (value) {
    var error = new Data_Either.Left(
    ...
    return Control_Monad_Except_Trans.mapExceptT(
      map(Data_Either.either(Data_Function["const"](error))(fromNumber))
    )(readNumber1(value));
  };
};
...
var readChar = function (dictMonad) {
  ...
  return function (value) {
    var error = new Data_Either.Left(
      Data_List_NonEmpty.singleton(
        new TypeMismatch("Char", $foreign.tagOf(value))
      )
    );
    ...
    return Control_Monad_Except_Trans.mapExceptT(
      map(Data_Either.either(Data_Function["const"](error))(fromString))
    )(readString1(value));
  };
};
var eqForeignError = {
  eq: function (x) {
    return function (y) {
      ...
      if (x instanceof ErrorAtIndex && y instanceof ErrorAtIndex) {
        return (
          x.value0 === y.value0 &&
          Data_Eq.eq(eqForeignError)(x.value1)(y.value1)
        );
      }
...
var ordForeignError = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Foreign (line 0, column 0 - line 0, column 0): " +
...
export { typeOf, tagOf, isNull, isUndefined, isArray } from "./foreign.js";
export {
  ForeignError,
  TypeMismatch,
  ErrorAtIndex,
