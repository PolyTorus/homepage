...
var compose = /* #__PURE__ */ Control_Semigroupoid.compose(
...
var quickCheck$prime2 = /* #__PURE__ */ Test_QuickCheck["quickCheck$prime"](
  /* #__PURE__ */ Test_QuickCheck.testableGen(testableFunction)
);
          ...
          return function (genab) {
            return function (genbc) {
              ...
              var composition = function (f) {
                return function (g) {
                  return function (x) {
                    return eq2(apply(apply(apply(pure(compose))(f))(g))(x))(
                      apply(f)(apply(g)(x))
                    );
                  };
                };
              ...
              return function __do() {
                ...
                return quickCheck$prime2(1000)(
                  map(Data_Function.flip(interchange))(genab)
                )();
              };
            };
          };
...
export { checkApplicative, checkApplicativeGen };
