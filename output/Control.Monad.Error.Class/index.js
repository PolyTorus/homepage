...
var monadErrorMaybe = {
  catchError: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Control.Monad.Error.Class (line 79, column 1 - line 81, column 33): " +
...
var monadErrorEither = {
  catchError: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Control.Monad.Error.Class (line 72, column 1 - line 74, column 35): " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  },
...
var monadErrorEffect = {
  catchError: /* #__PURE__ */ Data_Function.flip(
    Effect_Exception.catchException
  ),
  MonadThrow0: function () {
...
var liftEither = function (dictMonadThrow) {
  return Data_Either.either(throwError(dictMonadThrow))(
    Control_Applicative.pure(dictMonadThrow.Monad0().Applicative0())
  );
};
    ...
    return function (act) {
      return function (handler) {
        var handle = function (e) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.Error.Class (line 57, column 5 - line 59, column 26): " +
              [v.constructor.name]
          );
        };
