  ...
  return function (v) {
    var go = function (v1) {
      ...
      if (v1 instanceof Par) {
        return new Par(
          over(HalogenAp)(Control_Applicative_Free.hoistFreeAp(mapOutput(f)))(
            v1.value0
          )
        );
      }
      ...
      throw new Error(
        "Failed pattern match at Halogen.Query.HalogenM (line 290, column 8 - line 301, column 29): " +
          [v1.constructor.name]
      );
    };
    ...
    return function (v) {
      var go = function (v1) {
        ...
        if (v1 instanceof Par) {
          return new Par(
            over(HalogenAp)(
              Control_Applicative_Free.hoistFreeAp(mapAction(dictFunctor)(f))
            )(v1.value0)
          );
        }
        if (v1 instanceof Fork) {
        ...
        throw new Error(
          "Failed pattern match at Halogen.Query.HalogenM (line 269, column 8 - line 280, column 29): " +
            [v1.constructor.name]
        );
      };
      return Control_Monad_Free.hoistFree(go)(v);
    ...
    return function (v) {
      var go = function (v1) {
        ...
        if (v1 instanceof Par) {
          return new Par(
            over(HalogenAp)(
              Control_Applicative_Free.hoistFreeAp(imapState(f)(f$prime))
            )(v1.value0)
          );
        }
        if (v1 instanceof Fork) {
        ...
        throw new Error(
          "Failed pattern match at Halogen.Query.HalogenM (line 247, column 8 - line 258, column 29): " +
            [v1.constructor.name]
        );
      };
      return Control_Monad_Free.hoistFree(go)(v);
    ...
    return function (v) {
      var go = function (v1) {
        ...
        if (v1 instanceof Par) {
          return new Par(
            over(HalogenAp)(
              Control_Applicative_Free.hoistFreeAp(hoist(dictFunctor)(nat))
            )(v1.value0)
          );
        }
        if (v1 instanceof Fork) {
        ...
        throw new Error(
          "Failed pattern match at Halogen.Query.HalogenM (line 312, column 8 - line 323, column 29): " +
            [v1.constructor.name]
        );
      };
      return Control_Monad_Free.hoistFree(go)(v);
  ...
  return {
    map: function (f) {
      return function (v) {
        ...
        throw new Error(
          "Failed pattern match at Halogen.Query.HalogenM (line 57, column 11 - line 68, column 37): " +
            [v.constructor.name]
        );
      };
    }
    ...
    return function (a) {
      return bind(k(a))(function (v) {
        if (v instanceof Control_Monad_Rec_Class.Loop) {
          return Control_Monad_Rec_Class.tailRecM(monadRecHalogenM)(k)(
            v.value0
          );
        }
        ...
        throw new Error(
          "Failed pattern match at Halogen.Query.HalogenM (line 105, column 26 - line 107, column 21): " +
            [v.constructor.name]
        );
      });
    };
