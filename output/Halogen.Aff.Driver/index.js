...
var renderStateX = /* #__PURE__ */ Halogen_Aff_Driver_State.renderStateX(
  Effect.functorEffect
);
var $$void = /* #__PURE__ */ Data_Functor["void"](Effect_Aff.functorAff);
var foreachSlot = /* #__PURE__ */ Halogen_Data_Slot.foreachSlot(
  Effect.applicativeEffect
);
var renderStateX_ = /* #__PURE__ */ Halogen_Aff_Driver_State.renderStateX_(
  Effect.applicativeEffect
);
var tailRecM = /* #__PURE__ */ Control_Monad_Rec_Class.tailRecM(
  Control_Monad_Rec_Class.monadRecEffect
);
var voidLeft = /* #__PURE__ */ Data_Functor.voidLeft(Effect.functorEffect);
var bind1 = /* #__PURE__ */ Control_Bind.bind(Effect_Aff.bindAff);
var liftEffect1 = /* #__PURE__ */ Effect_Class.liftEffect(
  Effect_Class.monadEffectEffect
);
...
var cleanupSubscriptionsAndForks = function (v) {
  return function __do() {
    bindFlipped(traverse_2(traverse_3(Halogen_Subscription.unsubscribe)))(
    ...
    return function (i) {
      var squashChildInitializers = function (lchs) {
        return function (preInits) {
          return Halogen_Aff_Driver_State.unDriverStateX(function (st) {
            var parentInitializer = Halogen_Aff_Driver_Eval.evalM(render)(
              st.selfRef
            )(
              st["component"]["eval"](
                new Halogen_Query_HalogenQ.Initialize(Data_Unit.unit)
              )
            );
            return Effect_Ref.modify_(function (handlers) {
              return {
                initializers: new Data_List_Types.Cons(
                  discard2(
                    parSequence_(Data_List.reverse(handlers.initializers))
                  )(function () {
          ...
          return function (j) {
            return Halogen_Component.unComponent(function (c) {
              return function __do() {
                ...
                var $$var =
                  Halogen_Aff_Driver_State.initDriverState(c)(j)(handler)(
                    lchs$prime
                  )();
                ...
                bindFlipped(
                  Halogen_Aff_Driver_State.unDriverStateX(
                    (function () {
                      var $63 = render(lchs);
                      return function ($64) {
                        return $63(
                ...
                bindFlipped(squashChildInitializers(lchs)(pre.initializers))(
                  Effect_Ref.read($$var)
                )();
                return $$var;
              };
          ...
          return function (childrenInRef) {
            return function (childrenOutRef) {
              return Halogen_Component.unComponentSlot(function (slot) {
                return function __do() {
                  var childrenIn = map(slot.pop)(
                    Effect_Ref.read(childrenInRef)
                  )();
                  var $$var = (function () {
                    if (childrenIn instanceof Data_Maybe.Just) {
                      Effect_Ref.write(childrenIn.value0.value1)(
                        childrenInRef
                      )();
                      var dsx = Effect_Ref.read(childrenIn.value0.value0)();
                      Halogen_Aff_Driver_State.unDriverStateX(function (st) {
                        return function __do() {
                          Data_Function.flip(Effect_Ref.write)(st.handlerRef)(
                            (function () {
                              var $65 = Data_Maybe.maybe(pure1(Data_Unit.unit))(
                                handler
                              );
                              return function ($66) {
                          ...
                          return Halogen_Aff_Driver_Eval.handleAff(
                            Halogen_Aff_Driver_Eval.evalM(render)(st.selfRef)(
                              st["component"]["eval"](
                                new Halogen_Query_HalogenQ.Receive(
                                  slot.input,
                                  Data_Unit.unit
                                )
                              )
                    ...
                    if (childrenIn instanceof Data_Maybe.Nothing) {
                      return runComponent(lchs)(
                        (function () {
                          var $67 = Data_Maybe.maybe(pure1(Data_Unit.unit))(
                            handler
                          );
                          return function ($68) {
                  ...
                  return bind(Effect_Ref.read($$var))(
                    renderStateX(function (v) {
                      if (v instanceof Data_Maybe.Nothing) {
                        return Effect_Exception["throw"](
      ...
      var render = function (lchs) {
        return function ($$var) {
          return function __do() {
            ...
            var shouldProcessHandlers = map(Data_Maybe.isNothing)(
              Effect_Ref.read(v.pendingHandlers)
            )();
            when(shouldProcessHandlers)(
              Effect_Ref.write(new Data_Maybe.Just(Data_List_Types.Nil.value))(
                v.pendingHandlers
              )
            )();
            ...
            Data_Function.flip(Effect_Ref.modify_)(v.selfRef)(
              Halogen_Aff_Driver_State.mapDriverState(function (ds$prime) {
                return {
            ...
            return when(shouldProcessHandlers)(
              Data_Function.flip(tailRecM)(Data_Unit.unit)(function (v1) {
                return function __do() {
                  var handlers = Effect_Ref.read(v.pendingHandlers)();
                  Effect_Ref.write(
                    new Data_Maybe.Just(Data_List_Types.Nil.value)
                  )(v.pendingHandlers)();
                  traverse_2(
                    (function () {
                  ...
                  if ($52) {
                    return voidLeft(
                      Effect_Ref.write(Data_Maybe.Nothing.value)(
                        v.pendingHandlers
                      )
      ...
      var finalize = function (lchs) {
        return Halogen_Aff_Driver_State.unDriverStateX(function (st) {
          return function __do() {
            ...
            var f = Halogen_Aff_Driver_Eval.evalM(render)(st.selfRef)(
              st["component"]["eval"](
                new Halogen_Query_HalogenQ.Finalize(Data_Unit.unit)
              )
            );
      ...
      var dispose = function (disposed) {
        return function (lchs) {
          return function (dsx) {
            return Halogen_Aff_Driver_Eval.handleLifecycle(lchs)(
              function __do() {
      ...
      return bind1(liftEffect(newLifecycleHandlers))(function (lchs) {
        return bind1(liftEffect(Effect_Ref["new"](false)))(function (disposed) {
          return Halogen_Aff_Driver_Eval.handleLifecycle(lchs)(function __do() {
            ...
            var dsx = bindFlipped(Effect_Ref.read)(
              runComponent(lchs)(
                (function () {
