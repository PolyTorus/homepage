...
var monadStateStateT =
  /* #__PURE__ */ Control_Monad_State_Trans.monadStateStateT(
...
var bindStateT = /* #__PURE__ */ Control_Monad_State_Trans.bindStateT(
  Data_Identity.monadIdentity
);
var discard = /* #__PURE__ */ Control_Bind.discard(Control_Bind.discardUnit)(
  bindStateT
);
var functorStateT = /* #__PURE__ */ Control_Monad_State_Trans.functorStateT(
...
var toUnfoldable = /* #__PURE__ */ Data_List.toUnfoldable(
...
var foldMap1 = /* #__PURE__ */ Data_Semigroup_Foldable.foldMap1(
  Data_Array_NonEmpty_Internal.foldable1NonEmptyArray
)(
  /* #__PURE__ */ Data_Monoid_Additive.semigroupAdditive(
        ...
        return mapFlipped(v1)(function (x) {
          return new Control_Monad_Rec_Class.Loop(
            new Data_Tuple.Tuple(
              new Data_List_Types.Cons(x, v2.value0),
              (v2.value1 - 1) | 0
            )
          );
        });
    ...
    return discard(
      $$void(
        modify(function (s) {
          ...
          $91.newSeed = Random_LCG.lcgPerturb($foreign.float32ToInt32(n))(
            s.newSeed
          );
          return $91;
        })
...
var monadRecGen = /* #__PURE__ */ Control_Monad_State_Trans.monadRecStateT(
  Control_Monad_Rec_Class.monadRecIdentity
);
var tailRecM = /* #__PURE__ */ Control_Monad_Rec_Class.tailRecM(monadRecGen);
var monadGen = /* #__PURE__ */ Control_Monad_State_Trans.monadStateT(
  Data_Identity.monadIdentity
);
  ...
  var pick = function ($copy_i) {
    return function ($copy_n) {
      ...
      function $tco_loop(i, n) {
        ...
        throw new Error(
          "Failed pattern match at Test.QuickCheck.Gen (line 168, column 16 - line 172, column 44): " +
            [v.constructor.name]
        );
      }
      while (!$tco_done) {
...
var applyGen = /* #__PURE__ */ Control_Monad_State_Trans.applyStateT(
  Data_Identity.monadIdentity
);
...
var chooseInt$prime = function (a) {
  return function (b) {
    ...
    var choose32BitPosNumber = apply(map2(add)(choose31BitPosNumber))(
      map2(mul(2.0))(choose31BitPosNumber)
    );
...
var oneOf = function (xs) {
  return bind1(chooseInt(0)((Data_Array_NonEmpty.length(xs) - 1) | 0))(
    function (n) {
...
var applicativeGen =
  /* #__PURE__ */ Control_Monad_State_Trans.applicativeStateT(
    Data_Identity.monadIdentity
  );
    ...
    return bind1(chooseInt(0)(n))(function (k) {
      return bind1(g)(function (x) {
        return bind1(vectorOf((k - 1) | 0)(g))(function (xs) {
          return pure1(
            fromJust(Data_Array_NonEmpty.fromArray(Data_Array.cons(x)(xs)))
          );
        });
      });
    });
...
var $$enum = function (dictBoundedEnum) {
  ...
  return bind1(
    chooseInt(fromEnum(Data_Bounded.bottom(Bounded0)))(
      fromEnum(Data_Bounded.top(Bounded0))
    )
  )(function (i) {
...
var shuffle = function (xs) {
  return bind1(vectorOf(Data_Array.length(xs))(chooseInt(0)(top)))(
    function (ns) {
      return pure1(
        map1(Data_Tuple.snd)(
          Data_Array.sortBy(comparing(Data_Tuple.fst))(Data_Array.zip(ns)(xs))
        )
      );
    }
  );
...
var altGen = /* #__PURE__ */ Control_Monad_State_Trans.altStateT(
  Data_Identity.monadIdentity
)(Data_Identity.altIdentity);
export {
  unGen,
  repeatable,
  stateful,
