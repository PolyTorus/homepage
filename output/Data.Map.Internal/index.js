    ...
    return function (done) {
      var go = function ($copy_v) {
        ...
        function $tco_loop(v) {
          ...
          throw new Error(
            "Failed pattern match at Data.Map.Internal (line 940, column 8 - line 946, column 20): " +
              [v.constructor.name]
          );
        }
        while (!$tco_done) {
...
var size = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.Map.Internal (line 618, column 8 - line 620, column 24): " +
      [v.constructor.name]
  );
};
...
var $lazy_unsafeDifference = /* #__PURE__ */ $runtime_lazy(
  "unsafeDifference",
  "Data.Map.Internal",
  function () {
    return function (comp, l, r) {
      ...
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 836, column 39 - line 843, column 33): " +
          [l.constructor.name, r.constructor.name]
      );
    };
  }
);
var unsafeDifference = /* #__PURE__ */ $lazy_unsafeDifference(835);
var $lazy_unsafeIntersectionWith = /* #__PURE__ */ $runtime_lazy(
  ...
  function () {
    return function (comp, app, l, r) {
      ...
      if (r instanceof Node) {
        var v = unsafeSplit(comp, r.value2, l);
        var l$prime = $lazy_unsafeIntersectionWith(825)(
          comp,
          app,
          v.value1,
          r.value4
        );
        var r$prime = $lazy_unsafeIntersectionWith(826)(
          comp,
          app,
          v.value2,
          r.value5
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 827, column 5 - line 831, column 37): " +
            [v.value0.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 820, column 49 - line 831, column 37): " +
          [l.constructor.name, r.constructor.name]
      );
    };
  }
...
var $lazy_unsafeUnionWith = /* #__PURE__ */ $runtime_lazy(
  "unsafeUnionWith",
  "Data.Map.Internal",
  function () {
    return function (comp, app, l, r) {
      ...
      if (r instanceof Node) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 811, column 5 - line 815, column 46): " +
            [v.value0.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 804, column 42 - line 815, column 46): " +
          [l.constructor.name, r.constructor.name]
      );
    };
  }
      ...
      var go = function (v) {
        ...
        if (v instanceof Node) {
          ...
          if (v1 instanceof Data_Ordering.EQ) {
            ...
            throw new Error(
              "Failed pattern match at Data.Map.Internal (line 531, column 11 - line 535, column 38): " +
                [v2.constructor.name]
            );
          }
          throw new Error(
            "Failed pattern match at Data.Map.Internal (line 527, column 7 - line 535, column 38): " +
              [v1.constructor.name]
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 524, column 8 - line 535, column 38): " +
            [v.constructor.name]
        );
      };
      return go;
        ...
        if (v instanceof Node) {
          return (
            ...
            ("[" +
              (show(v.value0) +
                ("] " +
                  (show1(v.value2) + (" => " + (show2(v.value3) + "\x0a")))))) +
            (go(ind + "    ")(v.value4) + "\x0a" + go(ind + "    ")(v.value5))
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 233, column 12 - line 238, column 34): " +
            [v.constructor.name]
        );
      };
    };
    ...
    var go = function ($copy_v) {
      ...
      function $tco_loop(v) {
        ...
        if (v instanceof Node) {
          ...
          throw new Error(
            "Failed pattern match at Data.Map.Internal (line 459, column 7 - line 462, column 19): " +
              [v1.constructor.name]
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 456, column 8 - line 462, column 19): " +
            [v.constructor.name]
        );
      }
      while (!$tco_done) {
  ...
  return function (f) {
    var go = function (v) {
      ...
      if (v instanceof Node) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 661, column 7 - line 665, column 47): " +
            [v2.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 658, column 8 - line 665, column 47): " +
          [v.constructor.name]
      );
    };
    return go;
  ...
  return function (k) {
    var go = function (v) {
      ...
      if (v instanceof Node) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 295, column 7 - line 302, column 38): " +
            [v1.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 292, column 8 - line 302, column 38): " +
          [v.constructor.name]
      );
    };
    return go;
  ...
  return function (k) {
    var go = function (v) {
      ...
      if (v instanceof Node) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 327, column 7 - line 333, column 42): " +
            [v1.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 324, column 8 - line 333, column 42): " +
          [v.constructor.name]
      );
    };
    return go;
  ...
  return function (v) {
    ...
    if (v instanceof Node) {
      ...
      return new IterEmit(
        v.value2,
        v.value3,
        new IterNode(v.value4, new IterNode(v.value5, iter))
      );
    }
    throw new Error(
      "Failed pattern match at Data.Map.Internal (line 973, column 17 - line 988, column 56): " +
        [v.constructor.name]
    );
  };
};
...
var stepUnfoldrUnordered = /* #__PURE__ */ (function () {
  var step = function (k, v, next) {
    return new Data_Maybe.Just(
      new Data_Tuple.Tuple(new Data_Tuple.Tuple(k, v), next)
    );
  };
    ...
    return function ($copy_v) {
      ...
      function $tco_loop(iter, v) {
        ...
        if (v instanceof Node) {
          ...
          $tco_var_iter = new IterEmit(
            v.value2,
            v.value3,
            new IterNode(v.value4, iter)
          );
          $copy_v = v.value5;
          return;
        }
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 963, column 13 - line 970, column 48): " +
            [v.constructor.name]
        );
      }
      while (!$tco_done) {
      ...
      function $tco_loop(iter, v) {
        ...
        if (v instanceof Node) {
          ...
          $tco_var_iter = new IterEmit(
            v.value2,
            v.value3,
            new IterNode(v.value5, iter)
          );
          $copy_v = v.value4;
          return;
        }
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 951, column 13 - line 958, column 48): " +
            [v.constructor.name]
        );
      }
      while (!$tco_done) {
          ...
          return function ($copy_b) {
            ...
            function $tco_loop(a, b) {
              ...
              if (v instanceof IterNext) {
                var v2 = stepAsc(b);
                if (
                  v2 instanceof IterNext &&
                  eq1(v.value0)(v2.value0) &&
                  eq2(v.value1)(v2.value1)
                ) {
                  $tco_var_a = v.value2;
                  $copy_b = v2.value2;
                  return;
              ...
              throw new Error(
                "Failed pattern match at Data.Map.Internal (line 859, column 14 - line 868, column 13): " +
                  [v.constructor.name]
              );
            }
            while (!$tco_done) {
        ...
        var go = function ($copy_a) {
          return function ($copy_b) {
            ...
            function $tco_loop(a, b) {
              ...
              throw new Error(
                "Failed pattern match at Data.Map.Internal (line 873, column 14 - line 891, column 11): " +
                  [v1.constructor.name, v.constructor.name]
              );
            }
            while (!$tco_done) {
              $tco_result = $tco_loop($tco_var_a, $copy_b);
...
var toUnfoldable1 = /* #__PURE__ */ toUnfoldable(
      ...
      return function (m2) {
        ...
        if (m1 instanceof Node) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
            return (
              eq1(m1.value3)(v1.value0) &&
              go(m1.value4)(m2) &&
              go(m1.value5)(m2)
            );
          }
          throw new Error(
            "Failed pattern match at Data.Map.Internal (line 611, column 7 - line 614, column 40): " +
              [v1.constructor.name]
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 608, column 14 - line 614, column 40): " +
            [m1.constructor.name]
        );
      };
    };
      ...
      return function (v) {
        var go = function (v1) {
          ...
          if (v1 instanceof Node) {
            ...
            throw new Error(
              "Failed pattern match at Data.Map.Internal (line 486, column 7 - line 489, column 44): " +
                [v2.constructor.name]
            );
          }
          throw new Error(
            "Failed pattern match at Data.Map.Internal (line 483, column 8 - line 489, column 44): " +
              [v1.constructor.name]
          );
        };
        return go;
...
var functorMap = {
  map: function (f) {
    var go = function (v) {
      ...
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 147, column 10 - line 150, column 39): " +
          [v.constructor.name]
      );
    };
    return go;
...
var functorWithIndexMap = {
  mapWithIndex: function (f) {
    var go = function (v) {
      ...
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 155, column 10 - line 158, column 41): " +
          [v.constructor.name]
      );
    };
    return go;
      ...
      var $lazy_go = $runtime_lazy("go", "Data.Map.Internal", function () {
        return function (m$prime, z$prime) {
          ...
          if (m$prime instanceof Node) {
            return $lazy_go(192)(
              m$prime.value4,
              f(m$prime.value2)(m$prime.value3)(
                $lazy_go(192)(m$prime.value5, z$prime)
              )
            );
          }
          throw new Error(
            "Failed pattern match at Data.Map.Internal (line 189, column 26 - line 192, column 45): " +
              [m$prime.constructor.name]
          );
        };
      });
    ...
    return function (z) {
      var $lazy_go = $runtime_lazy("go", "Data.Map.Internal", function () {
        return function (z$prime, m$prime) {
          ...
          if (m$prime instanceof Node) {
            return $lazy_go(198)(
              f(m$prime.value2)($lazy_go(198)(z$prime, m$prime.value4))(
                m$prime.value3
              ),
              m$prime.value5
            );
          ...
          throw new Error(
            "Failed pattern match at Data.Map.Internal (line 195, column 26 - line 198, column 45): " +
              [m$prime.constructor.name]
          );
        };
      });
  ...
  foldMapWithIndex: function (dictMonoid) {
    ...
    return function (f) {
      var go = function (v) {
        ...
        if (v instanceof Node) {
          return append1(go(v.value4))(
            append1(f(v.value2)(v.value3))(go(v.value5))
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 201, column 10 - line 204, column 30): " +
            [v.constructor.name]
        );
      };
      return go;
  ...
  traverse: function (dictApplicative) {
    ...
    return function (f) {
      var go = function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 209, column 10 - line 215, column 19): " +
            [v.constructor.name]
        );
      };
      return go;
  ...
  traverseWithIndex: function (dictApplicative) {
    ...
    return function (f) {
      var go = function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 221, column 10 - line 227, column 19): " +
            [v.constructor.name]
        );
      };
      return go;
...
var values = /* #__PURE__ */ (function () {
  return Data_Foldable.foldr(foldableMap)(Data_List_Types.Cons.create)(
    Data_List_Types.Nil.value
  );
})();
        ...
        return function (kmax) {
          return function (f) {
            var tooSmall = (function () {
              ...
              throw new Error(
                "Failed pattern match at Data.Map.Internal (line 389, column 7 - line 393, column 22): " +
            ...
            var tooLarge = (function () {
              ...
              throw new Error(
                "Failed pattern match at Data.Map.Internal (line 396, column 7 - line 400, column 22): " +
                  [kmax.constructor.name]
              );
            })();
            var inBounds = (function () {
              if (
                kmin instanceof Data_Maybe.Just &&
                kmax instanceof Data_Maybe.Just
              ) {
                return function (k) {
                  return (
                    lessThanOrEq1(kmin.value0)(k) &&
                    lessThanOrEq1(k)(kmax.value0)
                  );
                };
              }
              if (
                kmin instanceof Data_Maybe.Just &&
                kmax instanceof Data_Maybe.Nothing
              ) {
                return function (k) {
              ...
              if (
                kmin instanceof Data_Maybe.Nothing &&
                kmax instanceof Data_Maybe.Just
              ) {
                return function (k) {
              ...
              throw new Error(
                "Failed pattern match at Data.Map.Internal (line 403, column 7 - line 411, column 21): " +
                  [kmin.constructor.name, kmax.constructor.name]
              );
            })();
            var go = function (v) {
              if (v instanceof Leaf) {
              ...
              throw new Error(
                "Failed pattern match at Data.Map.Internal (line 413, column 10 - line 419, column 66): " +
                  [v.constructor.name]
              );
            };
            return go;
...
var foldSubmap = function (dictOrd) {
  ...
  return function (dictMonoid) {
    return foldSubmapBy1(Data_Semigroup.append(dictMonoid.Semigroup0()))(
...
var findMin = function ($copy_v) {
  ...
  function $tco_loop(v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Map.Internal (line 361, column 11 - line 366, column 21): " +
        [v.constructor.name]
    );
  }
  while (!$tco_done) {
  ...
  return function (k) {
    var go = function (v) {
      ...
      if (v instanceof Node) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 342, column 7 - line 348, column 25): " +
            [v1.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 339, column 8 - line 348, column 25): " +
          [v.constructor.name]
      );
    };
    return go;
...
var findMax = function ($copy_v) {
  ...
  function $tco_loop(v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Map.Internal (line 352, column 11 - line 357, column 21): " +
        [v.constructor.name]
    );
  }
  while (!$tco_done) {
  ...
  return function (k) {
    var go = function (v) {
      ...
      if (v instanceof Node) {
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 311, column 7 - line 318, column 21): " +
            [v1.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 308, column 8 - line 318, column 21): " +
          [v.constructor.name]
      );
    };
    return go;
...
var filterWithKey = function (dictOrd) {
  return function (f) {
    var go = function (v) {
      ...
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 627, column 8 - line 633, column 47): " +
          [v.constructor.name]
      );
    };
    return go;
...
var filterKeys = function (dictOrd) {
  return function (f) {
    var go = function (v) {
      ...
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 640, column 8 - line 646, column 47): " +
          [v.constructor.name]
      );
    };
    return go;
    ...
    return {
      eq: function (xs) {
        return function (ys) {
          ...
          throw new Error(
            "Failed pattern match at Data.Map.Internal (line 94, column 14 - line 105, column 16): " +
              [xs.constructor.name]
          );
        };
      }
...
var fromFoldableWithIndex = function (dictOrd) {
  ...
  return function (dictFoldableWithIndex) {
    return Data_FoldableWithIndex.foldlWithIndex(dictFoldableWithIndex)(
      function (k) {
        return function (m) {
          return function (v) {
      ...
      if (v.value4 instanceof Leaf) {
        ...
        if (v.value5 instanceof Node) {
          return (
            v.value0 === 2 &&
            v.value5.value0 === 1 &&
            v.value1 > v.value5.value1 &&
            greaterThan1(v.value5.value2)(v.value2) &&
            go(v.value5)
          );
        }
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 264, column 11 - line 268, column 60): " +
      ...
      if (v.value4 instanceof Node) {
        if (v.value5 instanceof Leaf) {
          return (
            ...
            lessThan1(v.value4.value2)(v.value2) &&
            go(v.value4)
          );
        }
        if (v.value5 instanceof Node) {
          return (
            v.value0 > v.value5.value0 &&
            greaterThan1(v.value5.value2)(v.value2) &&
            v.value0 > v.value4.value0 &&
            lessThan1(v.value4.value2)(v.value2) &&
            abs((v.value5.value0 - v.value4.value0) | 0) < 2 &&
            ((((v.value5.value1 + v.value4.value1) | 0) + 1) | 0) ===
              v.value1 &&
            go(v.value4) &&
            go(v.value5)
          );
        ...
        throw new Error(
          "Failed pattern match at Data.Map.Internal (line 270, column 11 - line 274, column 108): " +
            [v.value5.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.Map.Internal (line 262, column 7 - line 274, column 108): " +
          [v.value4.constructor.name]
      );
    }
    throw new Error(
      "Failed pattern match at Data.Map.Internal (line 259, column 8 - line 274, column 108): " +
        [v.constructor.name]
    );
  };
  return go;
...
var anyWithKey = function (predicate) {
  var go = function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Map.Internal (line 693, column 8 - line 695, column 62): " +
        [v.constructor.name]
    );
  };
  return go;
...
var any = function (predicate) {
  var go = function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Map.Internal (line 683, column 8 - line 685, column 58): " +
        [v.constructor.name]
    );
  };
  return go;
