...
var bimap = /* #__PURE__ */ Data_Bifunctor.bimap(
  Halogen_HTML_Core.bifunctorHTML
);
...
var mkEval = function (args) {
  return function (v) {
    ...
    if (v instanceof Halogen_Query_HalogenQ.Receive) {
      return voidLeft(traverse_(args.handleAction)(args.receive(v.value0)))(
        v.value1
      );
    }
  ...
  return function (nat) {
    return function (v) {
      ...
      if (v instanceof ThunkSlot) {
        return new ThunkSlot(
          Halogen_VDom_Thunk.hoist(lmap(hoistSlot(dictFunctor)(nat)))(v.value0)
        );
      }
      throw new Error(
        "Failed pattern match at Halogen.Component (line 279, column 17 - line 284, column 53): " +
          [v.constructor.name]
      );
    };
  };
...
var functorComponentSlot = {
  map: function (f) {
    return function (v) {
      ...
      if (v instanceof ThunkSlot) {
        return new ThunkSlot(
          Halogen_VDom_Thunk.mapThunk(
            bimap(Data_Functor.map(functorComponentSlot)(f))(f)
          )(v.value0)
        );
      }
      throw new Error(
        "Failed pattern match at Halogen.Component (line 209, column 11 - line 211, column 74): " +
          [v.constructor.name]
      );
    };
  }
