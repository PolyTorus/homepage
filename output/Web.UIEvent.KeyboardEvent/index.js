...
var fromUIEvent =
  /* #__PURE__ */ Web_Internal_FFI.unsafeReadProtoTagged("KeyboardEvent");
var fromEvent =
  /* #__PURE__ */ Web_Internal_FFI.unsafeReadProtoTagged("KeyboardEvent");
var fromEnumKeyLocation = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.UIEvent.KeyboardEvent (line 107, column 3 - line 111, column 16): " +
      [v.constructor.name]
  );
};
var eqKeyLocation = {
...
var ordKeyLocation = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.UIEvent.KeyboardEvent (line 0, column 0 - line 0, column 0): " +
...
var enumKeyLocation = {
  succ: /* #__PURE__ */ Data_Enum.defaultSucc(toEnumKeyLocation)(
    fromEnumKeyLocation
  ),
  pred: /* #__PURE__ */ Data_Enum.defaultPred(toEnumKeyLocation)(
    fromEnumKeyLocation
  ),
  Ord0: function () {
