...
var lmap = /* #__PURE__ */ Data_Bifunctor.lmap(
  Halogen_Query_HalogenQ.bifunctorHalogenQ
);
    ...
    return function (g) {
      return function (spec) {
        return {
          ...
          render: spec.render,
          eval: dimap(lmap(f))(Halogen_Query_HalogenM.mapOutput(g))(
            spec["eval"]
          )
        };
      };
...
var profunctorProComponent = function (dictFunctor) {
  ...
  return {
    dimap: function (f) {
      return function (g) {
        return function (v) {
          return Halogen_Component.unComponent(
            (function () {
...
export { ProComponent, newtypeProComponent, profunctorProComponent };
