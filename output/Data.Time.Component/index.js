...
var boundedEnumSecond = {
  ...
  toEnum: function (n) {
    ...
    throw new Error(
      "Failed pattern match at Data.Time.Component (line 90, column 1 - line 95, column 26): " +
        [n.constructor.name]
    );
  },
  fromEnum: function (v) {
...
var $lazy_enumSecond = /* #__PURE__ */ $runtime_lazy(
  "enumSecond",
  "Data.Time.Component",
  function () {
    return {
...
var boundedEnumMinute = {
  ...
  toEnum: function (n) {
    ...
    throw new Error(
      "Failed pattern match at Data.Time.Component (line 61, column 1 - line 66, column 26): " +
        [n.constructor.name]
    );
  },
  fromEnum: function (v) {
...
var $lazy_enumMinute = /* #__PURE__ */ $runtime_lazy(
  "enumMinute",
  "Data.Time.Component",
  function () {
    return {
...
var boundedEnumMillisecond = {
  ...
  toEnum: function (n) {
    ...
    throw new Error(
      "Failed pattern match at Data.Time.Component (line 120, column 1 - line 125, column 31): " +
        [n.constructor.name]
    );
  },
  fromEnum: function (v) {
...
var $lazy_enumMillisecond = /* #__PURE__ */ $runtime_lazy(
  "enumMillisecond",
  "Data.Time.Component",
  function () {
    return {
...
var boundedEnumHour = {
  ...
  toEnum: function (n) {
    ...
    throw new Error(
      "Failed pattern match at Data.Time.Component (line 32, column 1 - line 37, column 24): " +
        [n.constructor.name]
    );
  },
  fromEnum: function (v) {
...
var $lazy_enumHour = /* #__PURE__ */ $runtime_lazy(
  "enumHour",
  "Data.Time.Component",
  function () {
    return {
