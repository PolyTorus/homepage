...
var showDurationComponent = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Interval.Duration (line 38, column 1 - line 45, column 21): " +
        [v.constructor.name]
    );
  }
};
var show = /* #__PURE__ */ Data_Show.show(
  /* #__PURE__ */ Data_Map_Internal.showMap(showDurationComponent)(
...
var eq = /* #__PURE__ */ Data_Eq.eq(
  /* #__PURE__ */ Data_Map_Internal.eqMap(eqDurationComponent)(Data_Eq.eqNumber)
);
var ordDurationComponent = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Data.Interval.Duration (line 0, column 0 - line 0, column 0): " +
...
var unionWith =
  /* #__PURE__ */ Data_Map_Internal.unionWith(ordDurationComponent);
var compare = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ Data_Map_Internal.ordMap(ordDurationComponent)(
    Data_Ord.ordNumber
  )
);
