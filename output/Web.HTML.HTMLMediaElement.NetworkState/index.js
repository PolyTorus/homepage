...
var showNetworkState = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Web.HTML.HTMLMediaElement.NetworkState (line 30, column 1 - line 34, column 29): " +
        [v.constructor.name]
    );
  }
};
var fromEnumNetworkState = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.HTML.HTMLMediaElement.NetworkState (line 47, column 3 - line 51, column 18): " +
      [v.constructor.name]
  );
};
var eqNetworkState = {
...
var ordNetworkState = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.HTML.HTMLMediaElement.NetworkState (line 0, column 0 - line 0, column 0): " +
...
var enumNetworkState = {
  succ: /* #__PURE__ */ Data_Enum.defaultSucc(toEnumNetworkState)(
    fromEnumNetworkState
  ),
  pred: /* #__PURE__ */ Data_Enum.defaultPred(toEnumNetworkState)(
    fromEnumNetworkState
  ),
  Ord0: function () {
