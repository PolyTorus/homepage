...
var upFromIncluding = function (dictEnum) {
  ...
  return function (dictUnfoldable1) {
    return Data_Unfoldable1.unfoldr1(dictUnfoldable1)(
      apply(Data_Tuple.Tuple.create)(succ1)
    );
  };
};
var showCardinality = {
    ...
    return {
      succ: function (v) {
        return Data_Maybe.maybe(
          map(Data_Function.flip(Data_Tuple.Tuple.create)(bottom2))(
            succ1(v.value0)
          )
        )(
          (function () {
      ...
      pred: function (v) {
        return Data_Maybe.maybe(
          map(Data_Function.flip(Data_Tuple.Tuple.create)(top2))(
            pred1(v.value0)
          )
        )(
          (function () {
...
var enumOrdering = {
  succ: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Enum (line 72, column 1 - line 78, column 20): " +
        [v.constructor.name]
    );
  },
  pred: function (v) {
...
var enumMaybe = function (dictBoundedEnum) {
  ...
  return {
    succ: function (v) {
      ...
      throw new Error(
        "Failed pattern match at Data.Enum (line 80, column 1 - line 84, column 32): " +
          [v.constructor.name]
      );
    },
    pred: function (v) {
  ...
  return function (dictUnfoldable1) {
    ...
    return function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Enum (line 186, column 14 - line 190, column 51): " +
          ...
          return function (e) {
            if (e <= to) {
              return new Data_Maybe.Just(
                new Data_Tuple.Tuple(e, (e + step) | 0)
              );
            }
            if (Data_Boolean.otherwise) {
              return Data_Maybe.Nothing.value;
            ...
            throw new Error(
              "Failed pattern match at Data.Enum (line 217, column 5 - line 219, column 28): " +
                [step.constructor.name, to.constructor.name, e.constructor.name]
            );
          };
        };
      };
    ...
    return {
      succ: function (v) {
        if (v instanceof Data_Either.Left) {
          return Data_Maybe.maybe(
            new Data_Maybe.Just(new Data_Either.Right(bottom2))
          )(function ($188) {
        ...
        throw new Error(
          "Failed pattern match at Data.Enum (line 86, column 1 - line 90, column 69): " +
            [v.constructor.name]
        );
      },
      pred: function (v) {
        ...
        if (v instanceof Data_Either.Right) {
          return Data_Maybe.maybe(
            new Data_Maybe.Just(new Data_Either.Left(top2))
          )(function ($191) {
...
var downFromIncluding = function (dictEnum) {
  ...
  return function (dictUnfoldable1) {
    return Data_Unfoldable1.unfoldr1(dictUnfoldable1)(
      apply(Data_Tuple.Tuple.create)(pred1)
    );
  };
};
var diag = function (a) {
...
var downFrom = function (dictEnum) {
  ...
  return function (dictUnfoldable) {
    return Data_Unfoldable.unfoldr(dictUnfoldable)(
      (function () {
        var $192 = map(diag);
        return function ($193) {
      ...
      var go = function ($copy_i) {
        return function ($copy_x) {
          ...
          function $tco_loop(i, x) {
            ...
            throw new Error(
              "Failed pattern match at Data.Enum (line 296, column 12 - line 298, column 33): " +
                [v.constructor.name]
            );
          }
          while (!$tco_done) {
  ...
  var go = function ($copy_i) {
    return function ($copy_x) {
      ...
      function $tco_loop(i, x) {
        ...
        throw new Error(
          "Failed pattern match at Data.Enum (line 309, column 5 - line 311, column 19): " +
            [v.constructor.name]
        );
      }
      while (!$tco_done) {
    ...
    var go = function ($copy_i) {
      return function ($copy_x) {
        ...
        function $tco_loop(i, x) {
          ...
          throw new Error(
            "Failed pattern match at Data.Enum (line 276, column 5 - line 278, column 19): " +
              [v.constructor.name]
          );
        }
        while (!$tco_done) {
...
var boundedEnumOrdering = {
  ...
  fromEnum: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Enum (line 137, column 1 - line 145, column 18): " +
        [v.constructor.name]
    );
  },
  Bounded0: function () {
...
var boundedEnumBoolean = {
  ...
  fromEnum: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Enum (line 118, column 1 - line 124, column 20): " +
        [v.constructor.name]
    );
  },
  Bounded0: function () {
