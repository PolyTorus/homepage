  ...
  return function ($copy_v1) {
    ...
    function $tco_loop(v, v1) {
      ...
      if (v instanceof Data_List_Types.Cons) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Internal (line 25, column 3 - line 30, column 76): " +
            [v.value0.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.List.Internal (line 22, column 1 - line 22, column 63): " +
          ...
          function $tco_loop(v, v1) {
            ...
            if (v instanceof Data_List_Types.Cons) {
              ...
              if (v.value0 instanceof ThreeLeft) {
                $tco_var_v = v.value1;
                $copy_v1 = new KickUp(
                  new Two(v1.value0, v1.value1, v1.value2),
                  v.value0.value0,
                  new Two(v.value0.value1, v.value0.value2, v.value0.value3)
                );
                return;
              }
              if (v.value0 instanceof ThreeMiddle) {
                $tco_var_v = v.value1;
                $copy_v1 = new KickUp(
                  new Two(v.value0.value0, v.value0.value1, v1.value0),
                  v1.value1,
                  new Two(v1.value2, v.value0.value2, v.value0.value3)
                );
                return;
              }
              if (v.value0 instanceof ThreeRight) {
                $tco_var_v = v.value1;
                $copy_v1 = new KickUp(
                  new Two(v.value0.value0, v.value0.value1, v.value0.value2),
                  v.value0.value3,
                  new Two(v1.value0, v1.value1, v1.value2)
                );
                return;
              ...
              throw new Error(
                "Failed pattern match at Data.List.Internal (line 58, column 5 - line 63, column 90): " +
                  [v.value0.constructor.name, v1.constructor.name]
              );
            }
            throw new Error(
              "Failed pattern match at Data.List.Internal (line 55, column 3 - line 55, column 50): " +
                [v.constructor.name, v1.constructor.name]
            );
          }
          while (!$tco_done) {
          ...
          function $tco_loop(v, v1) {
            ...
            if (v1 instanceof Two) {
              ...
              if (v2 instanceof Data_Ordering.LT) {
                $tco_var_v = new Data_List_Types.Cons(
                  new TwoLeft(v1.value1, v1.value2),
                  v
                );
                $copy_v1 = v1.value0;
                return;
              ...
              $tco_var_v = new Data_List_Types.Cons(
                new TwoRight(v1.value0, v1.value1),
                v
              );
              $copy_v1 = v1.value2;
              return;
            ...
            if (v1 instanceof Three) {
              ...
              if (v2 instanceof Data_Ordering.LT) {
                $tco_var_v = new Data_List_Types.Cons(
                  new ThreeLeft(v1.value1, v1.value2, v1.value3, v1.value4),
                  v
                );
                $copy_v1 = v1.value0;
                return;
              ...
              if (
                v2 instanceof Data_Ordering.GT &&
                v3 instanceof Data_Ordering.LT
              ) {
                $tco_var_v = new Data_List_Types.Cons(
                  new ThreeMiddle(v1.value0, v1.value1, v1.value3, v1.value4),
                  v
                );
                $copy_v1 = v1.value2;
                return;
              ...
              $tco_var_v = new Data_List_Types.Cons(
                new ThreeRight(v1.value0, v1.value1, v1.value2, v1.value3),
                v
              );
              $copy_v1 = v1.value4;
              return;
            ...
            throw new Error(
              "Failed pattern match at Data.List.Internal (line 38, column 3 - line 38, column 81): " +
                [v.constructor.name, v1.constructor.name]
            );
          }
          while (!$tco_done1) {
...
export { emptySet, insertAndLookupBy };
