...
var renderDirValue = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.DirValue (line 14, column 18 - line 17, column 20): " +
      [v.constructor.name]
  );
};
var eqDirValue = {
...
var ordDirValue = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.DirValue (line 0, column 0 - line 0, column 0): " +
...
export { DirLTR, DirRTL, DirAuto, renderDirValue, eqDirValue, ordDirValue };
