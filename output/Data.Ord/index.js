...
var ordOrdering = {
  compare: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.Ord (line 126, column 1 - line 133, column 20): " +
...
var ordBoolean = /* #__PURE__ */ (function () {
  return {
    compare: $foreign.ordBooleanImpl(Data_Ordering.LT.value)(
      Data_Ordering.EQ.value
    )(Data_Ordering.GT.value),
    Eq0: function () {
...
var max = function (dictOrd) {
  ...
  return function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Data.Ord (line 181, column 3 - line 184, column 12): " +
          [v.constructor.name]
      );
    };
  };
...
var min = function (dictOrd) {
  ...
  return function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Data.Ord (line 172, column 3 - line 175, column 12): " +
          [v.constructor.name]
      );
    };
  };
    ...
    compare: (function () {
      var toDelta = function (x) {
        return function (y) {
          ...
          throw new Error(
            "Failed pattern match at Data.Ord (line 79, column 7 - line 82, column 17): " +
              [v.constructor.name]
          );
        };
      };
          ...
          compareRecord: function (v) {
            return function (ra) {
              return function (rb) {
                ...
                var left = compare3(Record_Unsafe.unsafeGet(key)(ra))(
