...
var foldMap1 = /* #__PURE__ */ Data_Semigroup_Foldable.foldMap1(
  Data_List_Types.foldable1NonEmptyList
);
...
var toUnfoldable1 = function (dictUnfoldable1) {
  ...
  return function ($83) {
    return $82(
      stepHead(Data_Map_Internal.toMapIter(Data_Set.toMap(coerce($83))))
    );
  };
};
var toUnfoldable11 = /* #__PURE__ */ toUnfoldable1(
  Data_Array_NonEmpty_Internal.unfoldable1NonEmptyArray
);
var toUnfoldable12 = /* #__PURE__ */ toUnfoldable1(
  Data_List_Types.unfoldable1NonEmptyList
);
...
var showNonEmptySet = function (dictShow) {
  var show = Data_Show.show(
    Data_Array_NonEmpty_Internal.showNonEmptyArray(dictShow)
  );
  return {
    show: function (s) {
