          ...
          return function (count) {
            ...
            if (func instanceof Ap) {
              return goLeft(dictApplicative)(fStack)(
                Data_List_NonEmpty.cons(func.value1)(valStack)
          ...
          if (vals instanceof Data_List_Types.Cons) {
            return new Data_Either.Right(
              new Data_Tuple.Tuple(
                ...
                new Data_NonEmpty.NonEmpty(vals.value0, vals.value1)
              )
            );
          }
          throw new Error(
    ...
    return function (z) {
      var go = function ($copy_v) {
        ...
        function $tco_loop(v) {
          ...
          if (v.value1.value0 instanceof Ap) {
            var nextVals = new Data_NonEmpty.NonEmpty(
              v.value1.value0.value1,
              v.value1.value1
            );
            $copy_v = goLeft1(v.value0)(nextVals)(nat)(v.value1.value0.value0)(
              1
            );
            return;
          }
      ...
      return go(
        new Data_Tuple.Tuple(
          ...
          Data_List_NonEmpty.singleton(z)
        )
      );
    };
  };
