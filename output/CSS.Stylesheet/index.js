...
var second = /* #__PURE__ */ Data_Profunctor_Strong.second(
  Data_Profunctor_Strong.strongFn
);
var map1 = /* #__PURE__ */ Data_Functor.map(
  /* #__PURE__ */ Control_Monad_Writer_Trans.functorWriterT(
...
var eq2 = /* #__PURE__ */ Data_Eq.eq(
  /* #__PURE__ */ Data_Maybe.eqMaybe(CSS_Property.eqValue)
);
...
var compare2 = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ Data_Maybe.ordMaybe(CSS_Property.ordValue)
);
...
var eq6 = /* #__PURE__ */ Data_Eq.eq(
  /* #__PURE__ */ CSS_Property.eqKey(Data_Eq.eqUnit)
);
...
var compare6 = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ CSS_Property.ordKey(Data_Ord.ordUnit)
);
var ordTuple = /* #__PURE__ */ Data_Tuple.ordTuple(Data_Ord.ordNumber);
var apply = /* #__PURE__ */ Control_Apply.apply(
  /* #__PURE__ */ Control_Monad_Writer_Trans.applyWriterT(
    Data_Semigroup.semigroupArray
  )(Data_Identity.applyIdentity)
);
var bind = /* #__PURE__ */ Control_Bind.bind(
  /* #__PURE__ */ Control_Monad_Writer_Trans.bindWriterT(
    Data_Semigroup.semigroupArray
  )(Data_Identity.bindIdentity)
);
...
var rule = /* #__PURE__ */ (function () {
  var $340 = Control_Monad_Writer_Class.tell(
    Control_Monad_Writer_Trans.monadTellWriterT(Data_Monoid.monoidArray)(
...
var keyframesFromTo = function (n) {
  return function (a) {
    return function (b) {
      return keyframes(n)(
        new Data_NonEmpty.NonEmpty(new Data_Tuple.Tuple(0.0, a), [
          new Data_Tuple.Tuple(100.0, b)
        ])
      );
    };
  };
...
var eq7 = /* #__PURE__ */ Data_Eq.eq(
  /* #__PURE__ */ Data_Maybe.eqMaybe(eqNotOrOnly)
);
var ordNotOrOnly = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.Stylesheet (line 0, column 0 - line 0, column 0): " +
...
var compare7 = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ Data_Maybe.ordMaybe(ordNotOrOnly)
);
var eqMediaType = {
  eq: function (x) {
    return function (y) {
...
var eqMediaQuery = {
  eq: function (x) {
    return function (y) {
      return (
        eq7(x.value0)(y.value0) &&
        eq8(x.value1)(y.value1) &&
        eq9(x.value2)(y.value2)
      );
    };
  }
};
...
var compare9 = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ ordNonEmpty(ordFeature)
);
var ordMediaQuery = {
  compare: function (x) {
    return function (y) {
  ...
  eq: function (x) {
    return function (y) {
      ...
      if (x instanceof Nested && y instanceof Nested) {
        return (
          eq11(x.value0)(y.value0) &&
          Data_Eq.eq(Data_Eq.eqArray(eqRule))(x.value1)(y.value1)
        );
      }
      if (x instanceof Query && y instanceof Query) {
        return (
          eq10(x.value0)(y.value0) &&
          Data_Eq.eq(Data_Eq.eqArray(eqRule))(x.value1)(y.value1)
        );
      }
...
var eqKeyframes = {
  eq: function (x) {
    return function (y) {
      return (
        x.value0 === y.value0 &&
        Data_Eq.eq(eqNonEmpty(eqTuple(Data_Eq.eqArray(eqRule))))(x.value1)(
          y.value1
        )
      );
    };
  ...
  compare: function (x) {
    return function (y) {
      ...
      return Data_Ord.compare(
        ordNonEmpty(ordTuple(Data_Ord.ordArray(ordRule)))
      )(x.value1)(y.value1);
    };
  },
  Eq0: function () {
...
var applicativeStyleM = {
  pure: /* #__PURE__ */ (function () {
    var $347 = Control_Applicative.pure(
      Control_Monad_Writer_Trans.applicativeWriterT(Data_Monoid.monoidArray)(
