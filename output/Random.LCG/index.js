...
var randomSeed = /* #__PURE__ */ Data_Functor.map(Effect.functorEffect)(mkSeed)(
  /* #__PURE__ */ Effect_Random.randomInt(seedMin)(seedMax)
);
var lcgC = 0;
var lcgA = 48271;
var lcgPerturb = function (d) {
  return function (v) {
    return fromJust(
      Data_Int.fromNumber(
        Data_Number.remainder(
          Data_Int.toNumber(lcgA) * Data_Int.toNumber(v) + Data_Int.toNumber(d)
