            ...
            return bind(v1)(function (v2) {
              return pure(
                (function () {
                  ...
                  throw new Error(
                    "Failed pattern match at Control.Monad.Writer.Trans (line 84, column 16 - line 86, column 47): " +
  ...
  return function (dictMonad) {
    ...
    return {
      ...
      pass: function (v) {
        return bind(v)(function (v1) {
          return pure(
            new Data_Tuple.Tuple(v1.value0.value0, v1.value0.value1(v1.value1))
          );
        });
      },
      Monoid0: function () {
...
var alternativeWriterT = function (dictMonoid) {
  ...
  return function (dictAlternative) {
    var applicativeWriterT2 = applicativeWriterT1(
      dictAlternative.Applicative0()
    );
