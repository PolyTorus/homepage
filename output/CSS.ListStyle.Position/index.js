...
var valListStylePosition = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.ListStyle.Position (line 29, column 1 - line 34, column 37): " +
        [v.constructor.name]
    );
  }
};
...
var showListStylePosition = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.ListStyle.Position (line 22, column 1 - line 27, column 23): " +
        [v.constructor.name]
    );
  }
};
...
var listStylePosition = /* #__PURE__ */ CSS_Stylesheet.key(
...
var ordListStylePosition = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.ListStyle.Position (line 0, column 0 - line 0, column 0): " +
