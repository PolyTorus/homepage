...
var fromFoldable = /* #__PURE__ */ Data_Array.fromFoldable(
...
var replicated = function (dictMonoid) {
  ...
  var append = Data_Semigroup.append(
    Data_Semigroup.semigroupFn(dictMonoid.Semigroup0())
  );
  return function (i) {
    return function (v) {
      var go = function (v1) {
...
var foldMapOf = /* #__PURE__ */ Data_Newtype.under()()(
  Data_Lens_Internal_Forget.Forget
);
