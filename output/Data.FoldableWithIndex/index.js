...
var foldr = /* #__PURE__ */ Data_Foldable.foldr(
  Data_Foldable.foldableMultiplicative
);
...
var foldMap2 = /* #__PURE__ */ Data_Foldable.foldMap(
  Data_Foldable.foldableLast
);
...
var foldMap3 = /* #__PURE__ */ Data_Foldable.foldMap(
  Data_Foldable.foldableFirst
);
...
var foldMap4 = /* #__PURE__ */ Data_Foldable.foldMap(
  Data_Foldable.foldableDual
);
...
var foldMap5 = /* #__PURE__ */ Data_Foldable.foldMap(
  Data_Foldable.foldableDisj
);
...
var foldMap6 = /* #__PURE__ */ Data_Foldable.foldMap(
  Data_Foldable.foldableConj
);
var foldr7 = /* #__PURE__ */ Data_Foldable.foldr(
  Data_Foldable.foldableAdditive
);
var foldl7 = /* #__PURE__ */ Data_Foldable.foldl(
  Data_Foldable.foldableAdditive
);
var foldMap7 = /* #__PURE__ */ Data_Foldable.foldMap(
  Data_Foldable.foldableAdditive
);
...
var monoidEndo = /* #__PURE__ */ Data_Monoid_Endo.monoidEndo(
  ...
  foldrWithIndex: function (v) {
    return function (v1) {
      return function (v2) {
        ...
        throw new Error(
          "Failed pattern match at Data.FoldableWithIndex (line 164, column 1 - line 170, column 42): " +
...
var foldableWithIndexApp = function (dictFoldableWithIndex) {
  ...
  var foldableApp = Data_Foldable.foldableApp(
    dictFoldableWithIndex.Foldable0()
  );
  return {
    foldrWithIndex: function (f) {
      return function (z) {
...
var foldableWithIndexCompose = function (dictFoldableWithIndex) {
  ...
  var foldlWithIndex1 = foldlWithIndex(dictFoldableWithIndex);
  var foldMapWithIndex1 = foldMapWithIndex(dictFoldableWithIndex);
  var foldableCompose = Data_Foldable.foldableCompose(
    dictFoldableWithIndex.Foldable0()
  );
          ...
          return function (v) {
            return foldrWithIndex1(function (a) {
              return Data_Function.flip(
                foldrWithIndex2(Data_Tuple.curry(f)(a))
              );
            })(i)(v);
          };
        };
...
var foldableWithIndexCoproduct = function (dictFoldableWithIndex) {
  ...
  var foldlWithIndex1 = foldlWithIndex(dictFoldableWithIndex);
  var foldMapWithIndex1 = foldMapWithIndex(dictFoldableWithIndex);
  var foldableCoproduct = Data_Foldable.foldableCoproduct(
    dictFoldableWithIndex.Foldable0()
  );
  return function (dictFoldableWithIndex1) {
    var foldrWithIndex2 = foldrWithIndex(dictFoldableWithIndex1);
    var foldlWithIndex2 = foldlWithIndex(dictFoldableWithIndex1);
    var foldMapWithIndex2 = foldMapWithIndex(dictFoldableWithIndex1);
    var foldableCoproduct1 = foldableCoproduct(
      dictFoldableWithIndex1.Foldable0()
    );
    return {
      foldrWithIndex: function (f) {
        return function (z) {
          return Data_Functor_Coproduct.coproduct(
            foldrWithIndex1(function ($301) {
              return f(Data_Either.Left.create($301));
            })(z)
          )(
            foldrWithIndex2(function ($302) {
      ...
      foldlWithIndex: function (f) {
        return function (z) {
          return Data_Functor_Coproduct.coproduct(
            foldlWithIndex1(function ($303) {
              return f(Data_Either.Left.create($303));
            })(z)
          )(
            foldlWithIndex2(function ($304) {
      ...
      foldMapWithIndex: function (dictMonoid) {
        ...
        return function (f) {
          return Data_Functor_Coproduct.coproduct(
            foldMapWithIndex3(function ($305) {
...
var foldableWithIndexProduct = function (dictFoldableWithIndex) {
  ...
  var foldlWithIndex1 = foldlWithIndex(dictFoldableWithIndex);
  var foldMapWithIndex1 = foldMapWithIndex(dictFoldableWithIndex);
  var foldableProduct = Data_Foldable.foldableProduct(
    dictFoldableWithIndex.Foldable0()
  );
  return function (dictFoldableWithIndex1) {
    var foldrWithIndex2 = foldrWithIndex(dictFoldableWithIndex1);
    ...
    return {
      ...
      foldMapWithIndex: function (dictMonoid) {
        ...
        return function (f) {
          return function (v) {
            return append(
              foldMapWithIndex3(function ($311) {
                return f(Data_Either.Left.create($311));
              })(v.value0)
            )(
              foldMapWithIndex4(function ($312) {
...
var anyWithIndex = function (dictFoldableWithIndex) {
  ...
  return function (dictHeytingAlgebra) {
    var foldMapWithIndex2 = foldMapWithIndex1(
      Data_Monoid_Disj.monoidDisj(dictHeytingAlgebra)
    );
    return function (t) {
...
var allWithIndex = function (dictFoldableWithIndex) {
  ...
  return function (dictHeytingAlgebra) {
    var foldMapWithIndex2 = foldMapWithIndex1(
      Data_Monoid_Conj.monoidConj(dictHeytingAlgebra)
    );
    return function (t) {
