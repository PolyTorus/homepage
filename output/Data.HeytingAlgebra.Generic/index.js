...
var genericHeytingAlgebraProduct = function (dictGenericHeytingAlgebra) {
  ...
  return function (dictGenericHeytingAlgebra1) {
    var genericImplies$prime2 = genericImplies$prime(
    ...
    return {
      "genericFF'": new Data_Generic_Rep.Product(
        genericFF$prime1,
        genericFF$prime(dictGenericHeytingAlgebra1)
      ),
      "genericTT'": new Data_Generic_Rep.Product(
        genericTT$prime1,
        genericTT$prime(dictGenericHeytingAlgebra1)
      ),
      "genericImplies'": function (v) {
        return function (v1) {
          return new Data_Generic_Rep.Product(
            genericImplies$prime1(v.value0)(v1.value0),
            genericImplies$prime2(v.value1)(v1.value1)
          );
        };
      },
      "genericConj'": function (v) {
        return function (v1) {
          return new Data_Generic_Rep.Product(
            genericConj$prime1(v.value0)(v1.value0),
            genericConj$prime2(v.value1)(v1.value1)
          );
        };
      },
      "genericDisj'": function (v) {
        return function (v1) {
          return new Data_Generic_Rep.Product(
            genericDisj$prime1(v.value0)(v1.value0),
            genericDisj$prime2(v.value1)(v1.value1)
          );
        };
      },
      "genericNot'": function (v) {
        return new Data_Generic_Rep.Product(
          genericNot$prime1(v.value0),
          genericNot$prime2(v.value1)
        );
      }
    };
  };
