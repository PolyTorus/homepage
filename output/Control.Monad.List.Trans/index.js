  ...
  return function (f) {
    return function (z) {
      var g = function (v) {
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.List.Trans (line 130, column 3 - line 130, column 60): " +
            [v.constructor.name]
        );
      };
      return map2(g)(f(z));
  ...
  return function (v) {
    var g = function (v1) {
      if (v1 instanceof Yield) {
        return pure1(
          new Data_Maybe.Just(
            new Data_Tuple.Tuple(v1.value0, Data_Lazy.force(v1.value1))
          )
        );
      }
      ...
      throw new Error(
        "Failed pattern match at Control.Monad.List.Trans (line 195, column 3 - line 195, column 50): " +
          [v1.constructor.name]
      );
    };
    return bind(v)(g);
    ...
    var g = function (v) {
      if (v instanceof Yield) {
        ...
        if ($255) {
          return new Yield(
            v.value0,
            map1(takeWhile(dictApplicative)(f))(v.value1)
          );
        }
        return Done.value;
      }
      ...
      throw new Error(
        "Failed pattern match at Control.Monad.List.Trans (line 154, column 3 - line 154, column 68): " +
          [v.constructor.name]
      );
    };
    return stepMap1(g);
        ...
        var g = function (v) {
          var h = function (v1) {
            ...
            if (v1 instanceof Skip) {
              return new Data_Maybe.Just(
                new Data_Tuple.Tuple(
                  new Data_Tuple.Tuple(v.value0, Data_Lazy.force(v1.value0)),
                  v.value0
                )
              );
            }
            ...
            throw new Error(
              "Failed pattern match at Control.Monad.List.Trans (line 248, column 5 - line 248, column 78): " +
                [v1.constructor.name]
            );
          };
    ...
    return function (v1) {
      ...
      var f = function (v2) {
        if (v2 instanceof Yield) {
          return new Yield(
            v2.value0,
            map1(take(dictApplicative)((v - 1) | 0))(v2.value1)
          );
        }
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.List.Trans (line 147, column 3 - line 147, column 47): " +
            [v2.constructor.name]
        );
      };
    ...
    var g = function (v) {
      return function (v1) {
        ...
        if (v instanceof Data_Maybe.Just && v1 instanceof Data_Maybe.Just) {
          return map2(
            Data_Function.flip(prepend$prime1)(
              Data_Lazy.defer(function (v2) {
                return zipWith$prime(dictMonad)(f)(v.value0.value1)(
                  v1.value0.value1
                );
              })
            )
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.List.Trans (line 260, column 3 - line 260, column 25): " +
...
var mapMaybe = function (dictFunctor) {
  ...
  return function (f) {
    var g = function (v) {
      if (v instanceof Yield) {
        return Data_Maybe.fromMaybe(Skip.create)(
          map(Yield.create)(f(v.value0))
        )(map1(mapMaybe(dictFunctor)(f))(v.value1));
      }
      if (v instanceof Skip) {
      ...
      throw new Error(
        "Failed pattern match at Control.Monad.List.Trans (line 183, column 3 - line 183, column 72): " +
          [v.constructor.name]
      );
    };
    return stepMap1(g);
    ...
    map: function (f) {
      var g = function (v) {
        if (v instanceof Yield) {
          return new Yield(
            f(v.value0),
            map1(Data_Functor.map(functorListT(dictFunctor))(f))(v.value1)
          );
        }
        if (v instanceof Skip) {
          return new Skip(
            map1(Data_Functor.map(functorListT(dictFunctor))(f))(v.value0)
          );
        }
        if (v instanceof Done) {
          return Done.value;
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.List.Trans (line 280, column 5 - line 280, column 48): " +
            [v.constructor.name]
        );
      };
      return stepMap1(g);
...
var fromEffect = function (dictApplicative) {
  ...
  return function (fa) {
    return map2(
      Data_Function.flip(Yield.create)(
    ...
    var loop = function (b) {
      return function (l) {
        var g = function (v) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.List.Trans (line 221, column 5 - line 221, column 45): " +
              [v.constructor.name]
          );
        };
    ...
    var loop = function (b) {
      return function (l) {
        var g = function (v) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.List.Trans (line 239, column 7 - line 239, column 47): " +
              [v.constructor.name]
          );
        };
        return bind(uncons1(l))(g);
    ...
    var loop = function (b) {
      return function (l) {
        var g = function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
            return bind(f(b)(v.value0.value0))(
              Data_Function.flip(loop)(v.value0.value1)
            );
          }
          throw new Error(
            "Failed pattern match at Control.Monad.List.Trans (line 212, column 5 - line 212, column 35): " +
              [v.constructor.name]
          );
        };
        return bind(uncons1(l))(g);
    ...
    var loop = function (b) {
      return function (l) {
        var g = function (v) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.List.Trans (line 229, column 5 - line 229, column 35): " +
              [v.constructor.name]
          );
        };
        return bind(uncons1(l))(g);
...
var filter = function (dictFunctor) {
  ...
  return function (f) {
    var g = function (v) {
      ...
      throw new Error(
        "Failed pattern match at Control.Monad.List.Trans (line 176, column 3 - line 176, column 80): " +
          [v.constructor.name]
      );
    };
    return stepMap1(g);
...
var dropWhile = function (dictApplicative) {
  ...
  return function (f) {
    var g = function (v) {
      ...
      throw new Error(
        "Failed pattern match at Control.Monad.List.Trans (line 169, column 3 - line 169, column 70): " +
          [v.constructor.name]
      );
    };
    return stepMap1(g);
  ...
  return function (v) {
    return function (v1) {
      ...
      var f = function (v2) {
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.List.Trans (line 162, column 3 - line 162, column 44): " +
            [v2.constructor.name]
        );
      };
      return stepMap1(f)(v1);
    ...
    unfoldr1: function (f) {
      return function (b) {
        var go = function (v) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.List.Trans (line 294, column 12 - line 296, column 67): " +
              [v.constructor.name]
          );
        };
        return go(f(b));
    ...
    unfoldr: function (f) {
      return function (b) {
        var go = function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
            return cons1(pure(v.value0.value0))(
              Data_Lazy.defer(function (v1) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.List.Trans (line 287, column 12 - line 289, column 67): " +
              [v.constructor.name]
          );
        };
        return go(f(b));
      ...
      var f = function (v) {
        if (v instanceof Yield) {
          return new Yield(
            v.value0,
            map1(function (v1) {
              return Data_Semigroup.append(semigroupListT(dictApplicative))(v1)(
                y
              );
            })(v.value1)
          );
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.List.Trans (line 106, column 3 - line 106, column 43): " +
            [v.constructor.name]
        );
      };
      return stepMap1(f)(x);
        ...
        var g = function (v) {
          if (v instanceof Yield) {
            var h = function (s$prime) {
              return append(f(v.value0))(
                Control_Bind.bind(bindListT(dictMonad))(s$prime)(f)
              );
            };
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.List.Trans (line 306, column 5 - line 308, column 31): " +
              [v.constructor.name]
          );
        };
...
export { lift } from "../Control.Monad.Trans.Class/index.js";
