...
var stripSuffix = function (v) {
  return function (str) {
    var v1 = $foreign.splitAt(($foreign.length(str) - $foreign.length(v)) | 0)(
      str
    );
    var $14 = v1.after === v;
    if ($14) {
...
var lastIndexOf$prime = /* #__PURE__ */ (function () {
  return $foreign["_lastIndexOfStartingAt"](Data_Maybe.Just.create)(
    Data_Maybe.Nothing.value
  );
})();
var lastIndexOf = /* #__PURE__ */ (function () {
  return $foreign["_lastIndexOf"](Data_Maybe.Just.create)(
    Data_Maybe.Nothing.value
  );
})();
var indexOf$prime = /* #__PURE__ */ (function () {
  return $foreign["_indexOfStartingAt"](Data_Maybe.Just.create)(
    Data_Maybe.Nothing.value
  );
})();
