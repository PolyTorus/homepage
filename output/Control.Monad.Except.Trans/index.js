...
var bindExceptT = function (dictMonad) {
  ...
  return {
    bind: function (v) {
      return function (k) {
        return bind(v)(
          Data_Either.either(function ($193) {
            ...
            (function () {
              if (m$prime instanceof Data_Either.Left) {
                return new Control_Monad_Rec_Class.Done(
                  new Data_Either.Left(m$prime.value0)
                );
              }
              if (
                m$prime instanceof Data_Either.Right &&
                m$prime.value0 instanceof Control_Monad_Rec_Class.Loop
              ) {
                return new Control_Monad_Rec_Class.Loop(m$prime.value0.value0);
              }
              if (
                m$prime instanceof Data_Either.Right &&
                m$prime.value0 instanceof Control_Monad_Rec_Class.Done
              ) {
                return new Control_Monad_Rec_Class.Done(
                  new Data_Either.Right(m$prime.value0.value0)
                );
              }
              throw new Error(
                "Failed pattern match at Control.Monad.Except.Trans (line 75, column 14 - line 78, column 43): " +
            ...
            (function () {
              if (a instanceof Data_Either.Left) {
                return new Data_Tuple.Tuple(
                  new Data_Either.Left(a.value0),
                  identity
                );
              }
              if (a instanceof Data_Either.Right) {
                return new Data_Tuple.Tuple(
                  new Data_Either.Right(a.value0.value0),
                  a.value0.value1
                );
              }
              throw new Error(
                "Failed pattern match at Control.Monad.Except.Trans (line 135, column 10 - line 137, column 45): " +
                  [a.constructor.name]
              );
            })()
          );
            ...
            if (rm instanceof Data_Either.Left) {
              return bind(v1)(function (rn) {
                ...
                if (rn instanceof Data_Either.Left) {
                  return pure(
                    new Data_Either.Left(append(rm.value0)(rn.value0))
                  );
                }
                throw new Error(
...
var plusExceptT = function (dictMonoid) {
  ...
  return function (dictMonad) {
    ...
    return {
      empty: Control_Monad_Error_Class.throwError(monadThrowExceptT(dictMonad))(
        mempty
      ),
      Alt0: function () {
        return altExceptT2;
...
export { catchError, throwError } from "../Control.Monad.Error.Class/index.js";
