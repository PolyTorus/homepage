...
var compare = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ Data_Ord.ordArray(
    /* #__PURE__ */ Data_Tuple.ordTuple(Data_Ord.ordString)(Data_Ord.ordString)
  )
);
...
var semigroupPrefixed = {
  append: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at CSS.Property (line 23, column 1 - line 27, column 59): " +
...
var plain = function (v) {
  ...
  throw new Error(
    "Failed pattern match at CSS.Property (line 32, column 1 - line 32, column 28): " +
      [v.constructor.name]
  );
};
...
var valTuple = function (dictVal) {
  ...
  return function (dictVal1) {
    ...
    return {
      value: function (v) {
        return append3(value1(v.value0))(
          append3(fromString1(" "))(value2(v.value1))
        );
      }
    };
  };
...
var ordPrefixed = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.Property (line 0, column 0 - line 0, column 0): " +
