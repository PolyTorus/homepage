  ...
  traverse: function (dictApplicative) {
    ...
    return function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Traversable (line 149, column 1 - line 153, column 36): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    };
...
var traversableCompose = function (dictTraversable) {
  ...
  var functorCompose = Data_Functor_Compose.functorCompose(
    dictTraversable.Functor0()
  );
  var foldableCompose = Data_Foldable.foldableCompose(
    dictTraversable.Foldable1()
  );
        ...
        return function (f) {
          return function (v) {
            return map(Data_Functor_Compose.Compose)(
              traverse4(traverse5(f))(v)
            );
          };
        };
      },
      sequence: function (dictApplicative) {
        return traverse(traversableCompose(dictTraversable)(dictTraversable1))(
          dictApplicative
        )(identity);
      },
      Functor0: function () {
...
var traversableArray = {
  traverse: function (dictApplicative) {
    ...
    return $foreign.traverseArrayImpl(Control_Apply.apply(Apply0))(
      Data_Functor.map(Apply0.Functor0())
...
var traversableCoproduct = function (dictTraversable) {
  var traverse2 = traverse(dictTraversable);
  var sequence2 = sequence(dictTraversable);
  var functorCoproduct = Data_Functor_Coproduct.functorCoproduct(
    dictTraversable.Functor0()
  );
...
var traversableProduct = function (dictTraversable) {
  var traverse2 = traverse(dictTraversable);
  var sequence2 = sequence(dictTraversable);
  var functorProduct = Data_Functor_Product.functorProduct(
    dictTraversable.Functor0()
  );
  ...
  return function (dictTraversable1) {
    ...
    return {
      traverse: function (dictApplicative) {
        ...
        return function (f) {
          return function (v) {
            return lift2(Data_Functor_Product.product)(traverse4(f)(v.value0))(
              traverse5(f)(v.value1)
            );
          };
        };
      },
      sequence: function (dictApplicative) {
        ...
        return function (v) {
          return lift2(Data_Functor_Product.product)(sequence4(v.value0))(
            sequence5(v.value1)
          );
        };
      },
