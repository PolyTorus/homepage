...
var bimap = /* #__PURE__ */ Data_Bifunctor.bimap(
  Halogen_VDom_Types.bifunctorVDom
);
var HTML = function (x) {
  return x;
};
  ...
  return new Halogen_VDom_DOM_Prop.Ref(function ($30) {
    return f(
      (function (v) {
        ...
        throw new Error(
          "Failed pattern match at Halogen.HTML.Core (line 109, column 21 - line 111, column 23): " +
            [v.constructor.name]
        );
      })($30)
    );
...
var renderWidget = function (f) {
  return function (g) {
    return function (v) {
      return Halogen_VDom_Types.renderWidget(map(map1(map2(f))))(
        (function () {
          var $33 = un(HTML);
          return function ($34) {
            return $33(g($34));
...
var isPropWrapValue = {
  toPropValue: function ($35) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_WrapValue.renderWrapValue($35)
    );
  }
};
var isPropString = {
...
var isPropStepValue = {
  toPropValue: function ($36) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_StepValue.renderStepValue($36)
    );
  }
};
var isPropScopeValue = {
  toPropValue: function ($37) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_ScopeValue.renderScopeValue($37)
    );
  }
};
var isPropPreloadValue = {
  toPropValue: function ($38) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_PreloadValue.renderPreloadValue($38)
    );
  }
};
var isPropOrderedListType = {
  toPropValue: function ($39) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_OrderedListType.renderOrderedListType($39)
    );
  }
};
var isPropNumber = {
...
var isPropMenuitemType = {
  toPropValue: function ($40) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_MenuitemType.renderMenuitemType($40)
    );
  }
};
var isPropMenuType = {
  toPropValue: function ($41) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_MenuType.renderMenuType($41)
    );
  }
};
var isPropMediaType = {
...
var isPropKindValue = {
  toPropValue: function ($44) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_KindValue.renderKindValue($44)
    );
  }
};
var isPropInt = {
...
var isPropInputType = {
  toPropValue: function ($45) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_InputType.renderInputType($45)
    );
  }
};
var isPropInputAcceptType = {
  toPropValue: function ($46) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_InputAcceptType.renderInputAcceptType($46)
    );
  }
};
var isPropFormMethod = {
  toPropValue: function ($47) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_FormMethod.renderFormMethod($47)
    );
  }
};
var isPropDirValue = {
  toPropValue: function ($48) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_DirValue.renderDirValue($48)
    );
  }
};
var isPropCrossOriginValue = {
  toPropValue: function ($49) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_CrossOriginValue.renderCrossOriginValue($49)
    );
  }
};
var isPropButtonType = {
  toPropValue: function ($50) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_ButtonType.renderButtonType($50)
    );
  }
};
var isPropBoolean = {
...
var isPropAutocompleteType = {
  toPropValue: function ($51) {
    return Halogen_VDom_DOM_Prop.propFromString(
      DOM_HTML_Indexed_AutocompleteType.renderAutocompleteType($51)
    );
  }
};
...
export { ElemName, Namespace } from "../Halogen.VDom/index.js";
export {
  Attribute,
  Handler,
  Property,
...
export { AttrName, ClassName, PropName } from "../Web.HTML.Common/index.js";
