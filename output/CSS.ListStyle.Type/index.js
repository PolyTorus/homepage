...
var valListStyleType = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.ListStyle.Type (line 46, column 1 - line 59, column 43): " +
        [v.constructor.name]
    );
  }
};
...
var showListStyleType = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.ListStyle.Type (line 31, column 1 - line 44, column 66): " +
        [v.constructor.name]
    );
  }
};
...
var listStyleType = /* #__PURE__ */ CSS_Stylesheet.key(valListStyleType)(
...
var ordListStyleType = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.ListStyle.Type (line 0, column 0 - line 0, column 0): " +
