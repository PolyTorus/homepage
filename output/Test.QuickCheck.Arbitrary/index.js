...
var genMaybe = /* #__PURE__ */ Control_Monad_Gen_Common.genMaybe(
  Test_QuickCheck_Gen.monadGenGen
);
var genEither = /* #__PURE__ */ Control_Monad_Gen_Common.genEither(
  Test_QuickCheck_Gen.monadGenGen
);
  ...
  return function (dictCoarbitrary1) {
    ...
    return {
      coarbitrary: function (v) {
        ...
        throw new Error(
          "Failed pattern match at Test.QuickCheck.Arbitrary (line 249, column 1 - line 251, column 38): " +
            [v.constructor.name]
        );
      }
    };
...
var coarbOrdering = {
  coarbitrary: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Test.QuickCheck.Arbitrary (line 123, column 1 - line 126, column 34): " +
        [v.constructor.name]
    );
  }
};
...
var coarbMaybe = function (dictCoarbitrary) {
  ...
  return {
    coarbitrary: function (v) {
      ...
      throw new Error(
        "Failed pattern match at Test.QuickCheck.Arbitrary (line 187, column 1 - line 189, column 39): " +
          [v.constructor.name]
      );
    }
  };
...
var coarbNonEmptyList = function (dictCoarbitrary) {
  var coarbitrary3 = coarbitrary(
    coarbNonEmpty(coarbList(dictCoarbitrary))(dictCoarbitrary)
  );
  return {
    coarbitrary: function (v) {
      return coarbitrary3(v);
  ...
  return function (dictCoarbitrary1) {
    ...
    return {
      coarbitrary: function (v) {
        ...
        throw new Error(
          "Failed pattern match at Test.QuickCheck.Arbitrary (line 194, column 1 - line 196, column 40): " +
            [v.constructor.name]
        );
      }
    };
...
var coarbBoolean = {
  coarbitrary: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Test.QuickCheck.Arbitrary (line 80, column 1 - line 82, column 37): " +
        [v.constructor.name]
    );
  }
};
...
var coarbitrary2 = /* #__PURE__ */ coarbitrary(
  /* #__PURE__ */ coarbArray(/* #__PURE__ */ coarbMaybe(coarbChar))
);
...
var coarbString = {
  coarbitrary: function (s) {
    return coarbitrary2(
      map(Data_String_CodeUnits.charAt(0))(
        Data_String_Common.split(wrap(""))(s)
      )
    );
  }
};
...
var arbitraryRecordInstance = function () {
  return function (dictArbitraryRowList) {
    return {
      arbitrary: arbitraryRecord(dictArbitraryRowList)(
...
var arbitraryList = function (dictArbitrary) {
  ...
  return {
    arbitrary: Test_QuickCheck_Gen.sized(function (n) {
      return bind(Test_QuickCheck_Gen.chooseInt(0)(n))(
        Data_Function.flip(Test_QuickCheck_Gen.listOf)(arbitrary1)
      );
    })
  };
};
var arbitraryProduct = function (dictArbitrary) {
  ...
  return function (dictArbitrary1) {
    return {
      arbitrary: apply(map1(Data_Generic_Rep.Product.create)(arbitrary1))(
        arbitrary(dictArbitrary1)
      )
    };
  };
};
            ...
            return {
              arbitraryRecord: function (v) {
                return bind(arbitrary1)(function (value) {
                  return bind(arbitraryRecord1(Type_Proxy["Proxy"].value))(
                    function (previous) {
                      return pure(
                        insert(Type_Proxy["Proxy"].value)(value)(previous)
                      );
                    }
                  );
                });
...
var arbitrarySum = function (dictArbitrary) {
  ...
  return function (dictArbitraryGenericSum) {
    return {
      arbitrary: Test_QuickCheck_Gen.oneOf(
        fromJust(
          Data_Array_NonEmpty.fromArray(
            Data_Array.cons(map1(Data_Generic_Rep.Inl.create)(arbitrary1))(
              map(map1(Data_Generic_Rep.Inr.create))(
                arbitraryGenericSum(dictArbitraryGenericSum)
              )
            )
          )
        )
...
var arbTuple = function (dictArbitrary) {
  ...
  return function (dictArbitrary1) {
    return {
      arbitrary: apply(map1(Data_Tuple.Tuple.create)(arbitrary1))(
        arbitrary(dictArbitrary1)
      )
    };
  };
...
var arbOrdering = /* #__PURE__ */ (function () {
  return {
    arbitrary: Test_QuickCheck_Gen.elements(
      fromJust(
        Data_Array_NonEmpty.fromArray([
...
var arbNonEmpty = function (dictArbitrary) {
  ...
  return function (dictArbitrary1) {
    return {
      arbitrary: apply(
        map1(Data_NonEmpty.NonEmpty.create)(arbitrary(dictArbitrary1))
      )(arbitrary1)
    };
  };
};
var arbNonEmptyList = function (dictArbitrary) {
  return {
    arbitrary: map1(Data_List_Types.NonEmptyList)(
      arbitrary(arbNonEmpty(arbitraryList(dictArbitrary))(dictArbitrary))
    )
  };
};
var arbMultiplicative = function (dictArbitrary) {
  return {
    arbitrary: map1(Data_Monoid_Multiplicative.Multiplicative)(
      arbitrary(dictArbitrary)
    )
  };
};
...
var arbGenSumSum = function (dictArbitrary) {
  ...
  return function (dictArbitraryGenericSum) {
    return {
      arbitraryGenericSum: Data_Array.cons(
        map1(Data_Generic_Rep.Inl.create)(arbitrary1)
      )(
        map(map1(Data_Generic_Rep.Inr.create))(
          arbitraryGenericSum(dictArbitraryGenericSum)
        )
...
var arbChar = {
  arbitrary: /* #__PURE__ */ map1(
    /* #__PURE__ */ Data_Enum.toEnumWithDefaults(Data_Enum.boundedEnumChar)(
      /* #__PURE__ */ Data_Bounded.bottom(Data_Bounded.boundedChar)
    )(/* #__PURE__ */ Data_Bounded.top(Data_Bounded.boundedChar))
  )(/* #__PURE__ */ Test_QuickCheck_Gen.chooseInt(0)(65536))
};
var arbBoolean = {
  arbitrary: /* #__PURE__ */ Control_Monad_Gen_Class.chooseBool(
    Test_QuickCheck_Gen.monadGenGen
  )
};
...
var arbString = {
  arbitrary: /* #__PURE__ */ map1(Data_String_CodeUnits.fromCharArray)(
    /* #__PURE__ */ arbitrary(/* #__PURE__ */ arbArray(arbChar))
  )
};
var arbNonEmptyString = {
  arbitrary: /* #__PURE__ */ apply(
    /* #__PURE__ */ map1(Data_String_NonEmpty_CodeUnits.cons)(
      /* #__PURE__ */ arbitrary(arbChar)
    )
  )(/* #__PURE__ */ arbitrary(arbString))
};
