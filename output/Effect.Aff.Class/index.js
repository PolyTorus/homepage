...
var lift = /* #__PURE__ */ Control_Monad_Trans_Class.lift(
  Control_Monad_Cont_Trans.monadTransContT
);
var lift1 = /* #__PURE__ */ Control_Monad_Trans_Class.lift(
  Control_Monad_Except_Trans.monadTransExceptT
);
var lift2 = /* #__PURE__ */ Control_Monad_Trans_Class.lift(
  Control_Monad_List_Trans.monadTransListT
);
var lift3 = /* #__PURE__ */ Control_Monad_Trans_Class.lift(
  Control_Monad_Maybe_Trans.monadTransMaybeT
);
var lift4 = /* #__PURE__ */ Control_Monad_Trans_Class.lift(
  Control_Monad_Reader_Trans.monadTransReaderT
);
var lift5 = /* #__PURE__ */ Control_Monad_Trans_Class.lift(
  Control_Monad_State_Trans.monadTransStateT
);
var monadAffAff = {
  liftAff: /* #__PURE__ */ Control_Category.identity(
...
var monadAffContT = function (dictMonadAff) {
  ...
  var monadEffectContT =
    Control_Monad_Cont_Trans.monadEffectContT(MonadEffect0);
  return {
    liftAff: (function () {
...
var monadAffExceptT = function (dictMonadAff) {
  var MonadEffect0 = dictMonadAff.MonadEffect0();
  var monadEffectExceptT =
    Control_Monad_Except_Trans.monadEffectExceptT(MonadEffect0);
  return {
    liftAff: (function () {
...
var monadAffListT = function (dictMonadAff) {
  var MonadEffect0 = dictMonadAff.MonadEffect0();
  var monadEffectListT =
    Control_Monad_List_Trans.monadEffectListT(MonadEffect0);
  return {
    liftAff: (function () {
...
var monadAffMaybe = function (dictMonadAff) {
  var MonadEffect0 = dictMonadAff.MonadEffect0();
  var monadEffectMaybe =
    Control_Monad_Maybe_Trans.monadEffectMaybe(MonadEffect0);
  return {
    liftAff: (function () {
...
var monadAffRWS = function (dictMonadAff) {
  ...
  return function (dictMonoid) {
    var monadEffectRWS =
      Control_Monad_RWS_Trans.monadEffectRWS(dictMonoid)(MonadEffect0);
    return {
      liftAff: (function () {
        var $77 = Control_Monad_Trans_Class.lift(
          Control_Monad_RWS_Trans.monadTransRWST(dictMonoid)
        )(Monad0);
        return function ($78) {
...
var monadAffReader = function (dictMonadAff) {
  var MonadEffect0 = dictMonadAff.MonadEffect0();
  var monadEffectReader =
    Control_Monad_Reader_Trans.monadEffectReader(MonadEffect0);
  return {
    liftAff: (function () {
...
var monadAffState = function (dictMonadAff) {
  var MonadEffect0 = dictMonadAff.MonadEffect0();
  var monadEffectState =
    Control_Monad_State_Trans.monadEffectState(MonadEffect0);
  return {
    liftAff: (function () {
...
var monadAffWriter = function (dictMonadAff) {
  ...
  var liftAff1 = liftAff(dictMonadAff);
  return function (dictMonoid) {
    var monadEffectWriter =
      Control_Monad_Writer_Trans.monadEffectWriter(dictMonoid)(MonadEffect0);
    return {
      liftAff: (function () {
        var $85 = Control_Monad_Trans_Class.lift(
          Control_Monad_Writer_Trans.monadTransWriterT(dictMonoid)
        )(Monad0);
        return function ($86) {
