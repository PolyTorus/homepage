...
var bimap = /* #__PURE__ */ Data_Bifunctor.bimap(
  Control_Monad_Rec_Class.bifunctorStep
);
var foldl = /* #__PURE__ */ Data_Foldable.foldl(Data_List_Types.foldableList);
var any = /* #__PURE__ */ Data_Foldable.any(Data_List_Types.foldableList)(
  ...
  return foldr(function (v) {
    return function (v1) {
      return new Data_Tuple.Tuple(
        new Data_List_Types.Cons(v.value0, v1.value0),
        new Data_List_Types.Cons(v.value1, v1.value1)
      );
    };
  })(
...
var uncons = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.List (line 259, column 1 - line 259, column 66): " +
      [v.constructor.name]
  );
};
...
var tail = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.List (line 245, column 1 - line 245, column 43): " +
      [v.constructor.name]
  );
};
    ...
    return function (s) {
      var go = function (prefix) {
        return function (input) {
          if (
            prefix instanceof Data_List_Types.Cons &&
            input instanceof Data_List_Types.Cons &&
            eq2(prefix.value0)(input.value0)
          ) {
            return new Data_Maybe.Just(
...
var snoc = function (xs) {
  return function (x) {
    return foldr(Data_List_Types.Cons.create)(
      new Data_List_Types.Cons(x, Data_List_Types.Nil.value)
    )(xs);
  };
};
...
var sortBy = function (cmp) {
  var merge = function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.List (line 466, column 3 - line 466, column 38): " +
    ...
    return function ($copy_v1) {
      return function ($copy_v2) {
        ...
        function $tco_loop(v, v1, v2) {
          if (
            v2 instanceof Data_List_Types.Cons &&
            eq(cmp(v)(v2.value0))(Data_Ordering.GT.value)
          ) {
            $tco_var_v = v2.value0;
    ...
    return function ($copy_v1) {
      return function ($copy_v2) {
        ...
        function $tco_loop(v, v1, v2) {
          if (
            v2 instanceof Data_List_Types.Cons &&
            notEq(cmp(v)(v2.value0))(Data_Ordering.GT.value)
          ) {
            $tco_var_v = v2.value0;
...
var tails = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.List (line 641, column 1 - line 641, column 43): " +
      [v.constructor.name]
  );
};
    ...
    return function ($copy_v1) {
      return function ($copy_v2) {
        ...
        function $tco_loop(v, v1, v2) {
          ...
          throw new Error(
            "Failed pattern match at Data.List (line 513, column 3 - line 513, column 35): " +
  ...
  var go = function ($copy_v) {
    return function ($copy_v1) {
      ...
      function $tco_loop(v, v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.List (line 270, column 3 - line 270, column 21): " +
            [v.constructor.name, v1.constructor.name]
        );
      }
      while (!$tco_done) {
        ...
        return function ($copy_v1) {
          return function ($copy_v2) {
            ...
            function $tco_loop(v, v1, v2) {
              ...
              throw new Error(
                "Failed pattern match at Data.List (line 779, column 3 - line 779, column 21): " +
                  [v.constructor.name, v1.constructor.name, v2.constructor.name]
              );
            }
            while (!$tco_done) {
    ...
    return function ($copy_v1) {
      return function ($copy_v2) {
        ...
        function $tco_loop(v, v1, v2) {
          ...
          throw new Error(
            "Failed pattern match at Data.List (line 673, column 5 - line 673, column 23): " +
              [v.constructor.name, v1.constructor.name, v2.constructor.name]
          );
        }
        while (!$tco_done) {
...
var manyRec = function (dictMonadRec) {
  ...
  return function (dictAlternative) {
    ...
    return function (p) {
      var go = function (acc) {
        return bind1(
          alt(map1(Control_Monad_Rec_Class.Loop.create)(p))(
            pure(new Control_Monad_Rec_Class.Done(Data_Unit.unit))
          )
        )(function (aa) {
          return pure(
            bimap(function (v) {
...
var some = function (dictAlternative) {
  ...
  return function (dictLazy) {
    ...
    return function (v) {
      return apply(map1(Data_List_Types.Cons.create)(v))(
        defer(function (v1) {
  ...
  return function (dictLazy) {
    return function (v) {
      return alt(some(dictAlternative)(dictLazy)(v))(
        pure(Data_List_Types.Nil.value)
      );
    };
  };
};
    ...
    return function (v2) {
      ...
      if (v2 instanceof Data_List_Types.Cons) {
        ...
        if (v3 instanceof Data_Ordering.GT) {
          return new Data_List_Types.Cons(
            v2.value0,
            insertBy(v)(v1)(v2.value1)
          );
        }
        return new Data_List_Types.Cons(v1, v2);
      }
      throw new Error(
        "Failed pattern match at Data.List (line 216, column 1 - line 216, column 68): " +
          [v.constructor.name, v1.constructor.name, v2.constructor.name]
      );
    };
  };
...
var head = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.List (line 230, column 1 - line 230, column 22): " +
      [v.constructor.name]
  );
};
var transpose = function (v) {
  ...
  if (
    v instanceof Data_List_Types.Cons &&
    v.value0 instanceof Data_List_Types.Nil
  ) {
    return transpose(v.value1);
  }
  if (
    v instanceof Data_List_Types.Cons &&
    v.value0 instanceof Data_List_Types.Cons
  ) {
    return new Data_List_Types.Cons(
      new Data_List_Types.Cons(v.value0.value0, mapMaybe(head)(v.value1)),
      transpose(
        new Data_List_Types.Cons(v.value0.value1, mapMaybe(tail)(v.value1))
      )
    );
  }
  throw new Error(
    "Failed pattern match at Data.List (line 813, column 1 - line 813, column 54): " +
      [v.constructor.name]
  );
};
var groupBy = function (v) {
  return function (v1) {
    ...
    if (v1 instanceof Data_List_Types.Cons) {
      ...
      return new Data_List_Types.Cons(
        new Data_NonEmpty.NonEmpty(v1.value0, v2.init),
        groupBy(v)(v2.rest)
      );
    }
    throw new Error(
      "Failed pattern match at Data.List (line 609, column 1 - line 609, column 80): " +
        [v.constructor.name, v1.constructor.name]
    );
  };
};
  ...
  return function (v) {
    return function (v1) {
      return function (v2) {
        ...
        throw new Error(
          "Failed pattern match at Data.List (line 824, column 1 - line 824, column 72): " +
            [v.constructor.name, v1.constructor.name, v2.constructor.name]
        );
      };
    };
...
var filterM = function (dictMonad) {
  ...
  return function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.List (line 403, column 1 - line 403, column 75): " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  };
  ...
  var go = function ($copy_v) {
    return function ($copy_v1) {
      ...
      function $tco_loop(v, v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.List (line 390, column 3 - line 390, column 27): " +
            [v.constructor.name, v1.constructor.name]
        );
      }
      while (!$tco_done) {
...
var nubByEq = function (v) {
  return function (v1) {
    ...
    throw new Error(
      "Failed pattern match at Data.List (line 705, column 1 - line 705, column 61): " +
        [v.constructor.name, v1.constructor.name]
    );
  };
};
...
var drop = function ($copy_v) {
  return function ($copy_v1) {
    ...
    function $tco_loop(v, v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.List (line 536, column 1 - line 536, column 42): " +
          [v.constructor.name, v1.constructor.name]
      );
    }
    while (!$tco_done) {
...
var deleteBy = function (v) {
  return function (v1) {
    return function (v2) {
      ...
      throw new Error(
        "Failed pattern match at Data.List (line 732, column 1 - line 732, column 67): " +
          [v.constructor.name, v1.constructor.name, v2.constructor.name]
      );
    };
  };
...
var unionBy = function (eq2) {
  return function (xs) {
    return function (ys) {
      return append1(xs)(
        foldl(Data_Function.flip(deleteBy(eq2)))(nubByEq(eq2)(ys))(xs)
      );
    };
  };
};
      ...
      if (v === 0 && v2 instanceof Data_List_Types.Cons) {
        return new Data_Maybe.Just(
          (function () {
            ...
            throw new Error(
              "Failed pattern match at Data.List (line 352, column 3 - line 354, column 23): " +
                [v3.constructor.name]
            );
          })()
        );
...
export { Cons, Nil } from "../Data.List.Types/index.js";
