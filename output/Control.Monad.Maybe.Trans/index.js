    ...
    bind: function (v) {
      return function (f) {
        return bind(v)(function (v1) {
          ...
          throw new Error(
            "Failed pattern match at Control.Monad.Maybe.Trans (line 55, column 11 - line 57, column 42): " +
              [v1.constructor.name]
          );
        });
      };
        ...
        return bind(v)(function (m$prime) {
          return pure(
            (function () {
              ...
              if (
                m$prime instanceof Data_Maybe.Just &&
              ...
              if (
                ...
                return new Control_Monad_Rec_Class.Done(
                  new Data_Maybe.Just(m$prime.value0.value0)
                );
              }
              throw new Error(
                "Failed pattern match at Control.Monad.Maybe.Trans (line 83, column 16 - line 86, column 43): " +
            ...
            (function () {
              ...
              if (a instanceof Data_Maybe.Just) {
                return new Data_Tuple.Tuple(
                  new Data_Maybe.Just(a.value0.value0),
                  a.value0.value1
                );
              }
              throw new Error(
                "Failed pattern match at Control.Monad.Maybe.Trans (line 120, column 10 - line 122, column 43): " +
                  [a.constructor.name]
              );
            })()
          );
...
var plusMaybeT = function (dictMonad) {
  ...
  return {
    empty: Control_Applicative.pure(dictMonad.Applicative0())(
      Data_Maybe.Nothing.value
    ),
    Alt0: function () {
      return altMaybeT1;
