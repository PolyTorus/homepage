...
var valObliqueValue = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.FontStyle (line 17, column 1 - line 19, column 54): " +
        [v.constructor.name]
    );
  }
};
...
var valFontStyle = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.FontStyle (line 32, column 1 - line 38, column 30): " +
        [v.constructor.name]
    );
  }
};
...
var fontStyle = /* #__PURE__ */ CSS_Stylesheet.key(valFontStyle)(
  /* #__PURE__ */ CSS_String.fromString(CSS_Property.isStringKey)("font-style")
);
var eqObliqueValue = {
  eq: function (x) {
    return function (y) {
...
var ordObliqueValue = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.FontStyle (line 0, column 0 - line 0, column 0): " +
