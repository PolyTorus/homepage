...
var gcd = function (dictEq) {
  ...
  return function (dictEuclideanRing) {
    var zero = Data_Semiring.zero(
      dictEuclideanRing.CommutativeRing0().Ring0().Semiring0()
    );
...
export { degree, div, mod, gcd, lcm, euclideanRingInt, euclideanRingNumber };
export { sub } from "../Data.Ring/index.js";
