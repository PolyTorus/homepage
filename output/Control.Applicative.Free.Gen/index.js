...
var pure = /* #__PURE__ */ Control_Applicative.pure(
  Control_Applicative_Free.applicativeFreeAp
);
var apply = /* #__PURE__ */ Control_Apply.apply(
  Control_Applicative_Free.applyFreeAp
);
var mapFlipped = /* #__PURE__ */ Data_Functor.mapFlipped(
  Control_Applicative_Free.functorFreeAp
);
    ...
    return function (genF) {
      return function (genA) {
        return function (genA2A) {
          return oneOf(
            new Data_NonEmpty.NonEmpty(mapFlipped1(genA)(pure), [
              bind(genF)(function (fUnit) {
                return bind(genA)(function (a) {
                  return pure1(
                    apply(pure(Data_Function["const"](a)))(
                      Control_Applicative_Free.liftFreeAp(fUnit)
                    )
                  );
                });
              }),
              ...
              bind(genF)(function (fUnit) {
                return bind(genA)(function (a) {
                  return bind(genA2A)(function (a2a) {
                    return pure1(
                      mapFlipped(
                        mapFlipped(Control_Applicative_Free.liftFreeAp(fUnit))(
