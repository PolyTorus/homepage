    ...
    return function (k) {
      var go = function (f) {
        ...
        if (v instanceof Bind) {
          return map2(Control_Monad_Rec_Class.Loop.create)(
            k(map1(v.value1)(v.value0))
          );
        }
        throw new Error(
          "Failed pattern match at Control.Monad.Free (line 194, column 10 - line 196, column 37): " +
            [v.constructor.name]
        );
      };
      return tailRecM(go);
  ...
  return function (k) {
    var go = function ($copy_f) {
      ...
      function $tco_loop(f) {
        ...
        throw new Error(
          "Failed pattern match at Control.Monad.Free (line 178, column 10 - line 180, column 33): " +
            [v.constructor.name]
        );
      }
      while (!$tco_done) {
...
var freeFunctor = {
  map: function (k) {
    return function (f) {
      return Control_Bind.bindFlipped(freeBind)(
        (function () {
...
var $lazy_freeApply = /* #__PURE__ */ $runtime_lazy(
  "freeApply",
  "Control.Monad.Free",
  function () {
    return {
...
var substFree = function (k) {
  var go = function (f) {
    ...
    throw new Error(
      "Failed pattern match at Control.Monad.Free (line 168, column 10 - line 170, column 33): " +
        [v.constructor.name]
    );
  };
  return go;
          ...
          var $lazy_go = $runtime_lazy("go", "Control.Monad.Free", function () {
            return function ($194) {
              return (function (v) {
                ...
                throw new Error(
                  "Failed pattern match at Control.Monad.Free (line 93, column 21 - line 95, column 21): " +
                    [v.constructor.name]
                );
              })(resume1($194));
            };
        ...
        var go = function (r) {
          return function ($195) {
            return (function (v) {
              ...
              throw new Error(
                "Failed pattern match at Control.Monad.Free (line 98, column 23 - line 100, column 23): " +
                  [v.constructor.name]
              );
            })(resume1($195));
          };
        ...
        var go = function (r) {
          return function ($196) {
            return (function (v) {
              ...
              throw new Error(
                "Failed pattern match at Control.Monad.Free (line 103, column 23 - line 105, column 23): " +
                  [v.constructor.name]
              );
            })(resume1($196));
          };
...
var traversableFree = function (dictTraversable) {
  ...
  return {
        ...
        var $lazy_go = $runtime_lazy("go", "Control.Monad.Free", function () {
          return function ($197) {
            return (function (v) {
              ...
              throw new Error(
                "Failed pattern match at Control.Monad.Free (line 110, column 21 - line 112, column 30): " +
                  [v.constructor.name]
              );
            })(resume1($197));
          };
    ...
    sequence: function (dictApplicative) {
      return function (tma) {
        return Data_Traversable.traverse(traversableFree(dictTraversable))(
          dictApplicative
        )(identity)(tma);
      };
    },
        ...
        eq: function (x) {
          return function (y) {
            ...
            if (
              ...
              return eq1(eqFree(dictFunctor)(dictEq1)(dictEq))(v1.value0)(
                v.value0
              );
            }
            if (
              v1 instanceof Data_Either.Right &&
        ...
        compare: function (x) {
          return function (y) {
            ...
            if (
              ...
              return compare1(ordFree(dictFunctor)(dictOrd1)(dictOrd))(
                v1.value0
              )(v.value0);
            }
            ...
            throw new Error(
              "Failed pattern match at Control.Monad.Free (line 56, column 17 - line 60, column 36): " +
