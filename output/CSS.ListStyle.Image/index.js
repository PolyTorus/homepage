...
var valListStyleImage = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.ListStyle.Image (line 30, column 1 - line 35, column 67): " +
        [v.constructor.name]
    );
  }
};
...
var showListStyleImage = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.ListStyle.Image (line 23, column 1 - line 28, column 21): " +
        [v.constructor.name]
    );
  }
};
...
var listStyleImage = /* #__PURE__ */ CSS_Stylesheet.key(valListStyleImage)(
  /* #__PURE__ */ CSS_String.fromString(CSS_Property.isStringKey)(
    "list-style-image"
  )
);
...
var ordListStyleImage = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.ListStyle.Image (line 0, column 0 - line 0, column 0): " +
