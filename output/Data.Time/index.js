...
var toEnum1 = /* #__PURE__ */ Data_Enum.toEnum(
  Data_Time_Component.boundedEnumMinute
);
var toEnum2 = /* #__PURE__ */ Data_Enum.toEnum(
  Data_Time_Component.boundedEnumSecond
);
var toEnum3 = /* #__PURE__ */ Data_Enum.toEnum(
  Data_Time_Component.boundedEnumMillisecond
);
var fromEnum = /* #__PURE__ */ Data_Enum.fromEnum(
  Data_Time_Component.boundedEnumHour
);
var fromEnum1 = /* #__PURE__ */ Data_Enum.fromEnum(
  Data_Time_Component.boundedEnumMinute
);
var fromEnum2 = /* #__PURE__ */ Data_Enum.fromEnum(
  Data_Time_Component.boundedEnumSecond
);
var fromEnum3 = /* #__PURE__ */ Data_Enum.fromEnum(
  Data_Time_Component.boundedEnumMillisecond
);
...
var compare3 = /* #__PURE__ */ Data_Ord.compare(
  Data_Time_Component.ordMillisecond
);
var append1 = /* #__PURE__ */ Data_Semigroup.append(
  Data_Time_Duration.semigroupMilliseconds
);
var negateDuration = /* #__PURE__ */ Data_Time_Duration.negateDuration(
  Data_Time_Duration.durationMilliseconds
);
var unwrap = /* #__PURE__ */ Data_Newtype.unwrap();
var fromDuration = /* #__PURE__ */ Data_Time_Duration.fromDuration(
  Data_Time_Duration.durationDays
);
var greaterThan = /* #__PURE__ */ Data_Ord.greaterThan(
  Data_Time_Duration.ordMilliseconds
);
var lessThan = /* #__PURE__ */ Data_Ord.lessThan(
  Data_Time_Duration.ordMilliseconds
);
var append2 = /* #__PURE__ */ Data_Semigroup.append(
  Data_Time_Duration.semigroupDays
);
...
var millisToTime = function (v) {
  ...
  var seconds = Data_Number.floor(
    (v - (hours * 3600000.0 + minutes * 60000.0)) / 1000.0
  );
  var milliseconds =
    v - (hours * 3600000.0 + minutes * 60000.0 + seconds * 1000.0);
  return fromJust(
    apply(
      apply(
        apply(map(Time.create)(toEnum(Data_Int.floor(hours))))(
          toEnum1(Data_Int.floor(minutes))
        )
      )(toEnum2(Data_Int.floor(seconds)))
    )(toEnum3(Data_Int.floor(milliseconds)))
  );
};
var hour = function (v) {
  return v.value0;
...
var timeToMillis = function (t) {
  return (
    3600000.0 * Data_Int.toNumber(fromEnum(hour(t))) +
    60000.0 * Data_Int.toNumber(fromEnum1(minute(t))) +
    1000.0 * Data_Int.toNumber(fromEnum2(second(t))) +
    Data_Int.toNumber(fromEnum3(millisecond(t)))
  );
};
var eqTime = {
  eq: function (x) {
    return function (y) {
      return (
        eq(x.value0)(y.value0) &&
        eq1(x.value1)(y.value1) &&
        eq2(x.value2)(y.value2) &&
        eq3(x.value3)(y.value3)
      );
    };
  }
};
...
var diff = function (dictDuration) {
  ...
  return function (t1) {
    return function (t2) {
      return toDuration(
        append1(timeToMillis(t1))(negateDuration(timeToMillis(t2)))
      );
    };
  };
};
var boundedTime = /* #__PURE__ */ (function () {
  return {
    bottom: new Time(
      Data_Bounded.bottom(Data_Time_Component.boundedHour),
      Data_Bounded.bottom(Data_Time_Component.boundedMinute),
      Data_Bounded.bottom(Data_Time_Component.boundedSecond),
      Data_Bounded.bottom(Data_Time_Component.boundedMillisecond)
    ),
    top: new Time(
      Data_Bounded.top(Data_Time_Component.boundedHour),
      Data_Bounded.top(Data_Time_Component.boundedMinute),
      Data_Bounded.top(Data_Time_Component.boundedSecond),
      Data_Bounded.top(Data_Time_Component.boundedMillisecond)
    ),
    Ord0: function () {
      return ordTime;
    }
...
var maxTime = /* #__PURE__ */ timeToMillis(
  /* #__PURE__ */ Data_Bounded.top(boundedTime)
);
var minTime = /* #__PURE__ */ timeToMillis(
  /* #__PURE__ */ Data_Bounded.bottom(boundedTime)
);
  ...
  return function (d) {
    return function (t) {
      ...
      return new Data_Tuple.Tuple(
        append2(wholeDays)(wrap),
        millisToTime(append1(msAdjusted)(8.64e7 * -wrap))
      );
    };
  };
};
