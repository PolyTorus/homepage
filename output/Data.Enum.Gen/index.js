...
var genBoundedEnum = function (dictMonadGen) {
  ...
  return function (dictBoundedEnum) {
    ...
    if (v instanceof Data_Maybe.Just) {
      var possibilities = Data_Enum.enumFromTo(Enum1)(
        Data_Unfoldable1.unfoldable1Array
      )(v.value0)(Data_Bounded.top(Bounded0));
    ...
    throw new Error(
      "Failed pattern match at Data.Enum.Gen (line 13, column 3 - line 18, column 18): " +
        [v.constructor.name]
    );
  };
};
export { genBoundedEnum };
