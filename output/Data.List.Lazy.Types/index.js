  ...
  append: function (xs) {
    return function (ys) {
      var go = function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy.Types (line 103, column 5 - line 103, column 21): " +
            [v.constructor.name]
        );
      };
  ...
  map: function (f) {
    return function (xs) {
      var go = function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy.Types (line 112, column 5 - line 112, column 17): " +
            [v.constructor.name]
        );
      };
      return map(go)(unwrap(xs));
...
var map1 = /* #__PURE__ */ Data_Functor.map(
  /* #__PURE__ */ Data_NonEmpty.functorNonEmpty(functorList)
);
        ...
        var go = function ($copy_v) {
          return function ($copy_v1) {
            ...
            function $tco_loop(v, v1) {
              ...
              throw new Error(
                "Failed pattern match at Data.List.Lazy.Types (line 89, column 5 - line 89, column 20): " +
...
var foldableList = {
  foldr: function (op) {
    return function (z) {
      return function (xs) {
        var rev = Data_Foldable.foldl(foldableList)(Data_Function.flip(cons))(
          nil
        );
        return Data_Foldable.foldl(foldableList)(Data_Function.flip(op))(z)(
          rev(xs)
        );
      };
    };
    ...
    var go = function ($copy_b) {
      return function ($copy_xs) {
        ...
        function $tco_loop(b, xs) {
          ...
          throw new Error(
            "Failed pattern match at Data.List.Lazy.Types (line 127, column 7 - line 129, column 40): " +
              [v.constructor.name]
          );
        }
        while (!$tco_done) {
...
var foldableNonEmpty =
  /* #__PURE__ */ Data_NonEmpty.foldableNonEmpty(foldableList);
...
var extendList = {
  extend: function (f) {
    return function (l) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.Lazy.Types (line 197, column 5 - line 200, column 55): " +
          [v.constructor.name]
      );
    };
  },
    ...
    show: function (xs) {
      return (
        ...
        ((function () {
          ...
          throw new Error(
            "Failed pattern match at Data.List.Lazy.Types (line 66, column 13 - line 69, column 78): " +
              [v.constructor.name]
          );
        })() +
          "])")
...
var showNonEmptyList = function (dictShow) {
  var show = Data_Show.show(
    Data_Lazy.showLazy(Data_NonEmpty.showNonEmpty(dictShow)(showList(dictShow)))
  );
  return {
    show: function (v) {
...
var showStep = function (dictShow) {
  ...
  return {
    show: function (v) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.Lazy.Types (line 36, column 1 - line 38, column 62): " +
          [v.constructor.name]
      );
    }
  };
...
var foldableWithIndexNonEmpty =
  /* #__PURE__ */ Data_NonEmpty.foldableWithIndexNonEmpty(
    foldableWithIndexList
  );
var foldMapWithIndex = /* #__PURE__ */ Data_FoldableWithIndex.foldMapWithIndex(
  foldableWithIndexNonEmpty
);
var foldlWithIndex = /* #__PURE__ */ Data_FoldableWithIndex.foldlWithIndex(
  foldableWithIndexNonEmpty
);
var foldrWithIndex = /* #__PURE__ */ Data_FoldableWithIndex.foldrWithIndex(
  foldableWithIndexNonEmpty
);
var foldrWithIndex1 = /* #__PURE__ */ Data_FoldableWithIndex.foldrWithIndex(
  foldableWithIndexList
);
...
var mapWithIndex = /* #__PURE__ */ Data_FunctorWithIndex.mapWithIndex(
  /* #__PURE__ */ Data_NonEmpty.functorWithIndex(functorWithIndexList)
);
  ...
  append: function (v) {
    return function (as$prime) {
      ...
      return Data_Lazy.defer(function (v2) {
        return new Data_NonEmpty.NonEmpty(
          v1.value0,
          append1(v1.value1)(toList(as$prime))
        );
      });
    };
  }
...
var traversableNonEmpty =
  /* #__PURE__ */ Data_NonEmpty.traversableNonEmpty(traversableList);
...
var traverseWithIndex =
  /* #__PURE__ */ Data_TraversableWithIndex.traverseWithIndex(
    /* #__PURE__ */ Data_NonEmpty.traversableWithIndexNonEmpty(
    ...
    var go = function (f) {
      return function (b) {
        return defer(function (v) {
          ...
          throw new Error(
            "Failed pattern match at Data.List.Lazy.Types (line 151, column 28 - line 153, column 33): " +
              [v1.constructor.name]
          );
        });
      };
    ...
    var go = function (f) {
      return function (b) {
        return defer(function (v) {
          ...
          throw new Error(
            "Failed pattern match at Data.List.Lazy.Types (line 157, column 28 - line 159, column 39): " +
              [v1.constructor.name]
          );
        });
      };
...
var unfoldr1 = /* #__PURE__ */ Data_Unfoldable1.unfoldr1(
  /* #__PURE__ */ Data_NonEmpty.unfoldable1NonEmpty(unfoldableList)
);
  ...
  bind: function (xs) {
    return function (f) {
      var go = function (v) {
        ...
        if (v instanceof Cons) {
          return step(
            append1(f(v.value0))(Control_Bind.bind(bindList)(v.value1)(f))
          );
        }
        throw new Error(
          "Failed pattern match at Data.List.Lazy.Types (line 180, column 5 - line 180, column 17): " +
            [v.constructor.name]
        );
      };
      return map(go)(unwrap(xs));
...
var $lazy_applyList = /* #__PURE__ */ $runtime_lazy(
  "applyList",
  ...
  apply: function (v) {
    return function (v1) {
      ...
      return Data_Lazy.defer(function (v4) {
        return new Data_NonEmpty.NonEmpty(
          v3.value0(v2.value0),
          append1(apply(v3.value1)(cons(v2.value0)(nil)))(
            apply(cons(v3.value0)(v3.value1))(v2.value1)
          )
        );
      });
    };
