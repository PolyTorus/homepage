...
var showShadowRootMode = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Web.DOM.ShadowRoot (line 22, column 1 - line 24, column 25): " +
        [v.constructor.name]
    );
  }
};
...
export { host } from "./foreign.js";
export { Open, Closed, toNode, mode, showShadowRootMode };
