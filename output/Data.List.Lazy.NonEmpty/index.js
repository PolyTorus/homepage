...
var singleton = /* #__PURE__ */ Control_Applicative.pure(
  Data_List_Lazy_Types.applicativeNonEmptyList
);
...
var fromList = function (l) {
  ...
  throw new Error(
    "Failed pattern match at Data.List.Lazy.NonEmpty (line 42, column 3 - line 44, column 61): " +
      [v.constructor.name]
  );
};
  ...
  return function (v) {
    return Data_Lazy.defer(function (v1) {
      ...
      return new Data_NonEmpty.NonEmpty(
        y,
        Data_List_Lazy_Types.cons(v2.value0)(v2.value1)
      );
    });
  };
};
var concatMap = /* #__PURE__ */ Data_Function.flip(
  /* #__PURE__ */ Control_Bind.bind(Data_List_Lazy_Types.bindNonEmptyList)
);
  ...
  return function (nel) {
    return function (ys) {
      return Data_Lazy.defer(function (v) {
        return new Data_NonEmpty.NonEmpty(
          head(nel),
          append(tail(nel))(fromFoldable1(ys))
        );
      });
    };
  };
...
export { NonEmptyList } from "../Data.List.Lazy.Types/index.js";
