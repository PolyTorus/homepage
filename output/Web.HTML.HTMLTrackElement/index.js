...
var toEnum = /* #__PURE__ */ Data_Enum.toEnum(
  Web_HTML_HTMLTrackElement_ReadyState.boundedEnumReadyState
);
...
var readyState = function (el) {
  return map(
    (function () {
      var $3 = Data_Maybe.fromMaybe(
        Web_HTML_HTMLTrackElement_ReadyState.None.value
      );
      return function ($4) {
        return $3(toEnum($4));
      };
...
var fromParentNode =
  /* #__PURE__ */ Web_Internal_FFI.unsafeReadProtoTagged("HTMLTrackElement");
