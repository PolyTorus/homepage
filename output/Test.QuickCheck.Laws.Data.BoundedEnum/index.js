  ...
  return function (dictOrd) {
    return function (gen) {
      ...
      var succpredLaw = function (a) {
        return (
          eq3(a)(top) || eq2(bind(succ1(a))(pred1))(new Data_Maybe.Just(a))
        );
      };
      var predsuccLaw = function (a) {
        return (
          eq3(a)(bottom) || eq2(bind(pred1(a))(succ1))(new Data_Maybe.Just(a))
        );
      };
      ...
      var predLaw = eq2(new Data_Maybe.Just(bottom))(
        Data_Array.foldl(bind)(pure(top))(
          Data_Array.replicate((c - 1) | 0)(pred1)
        )
      );
      var succLaw = eq2(new Data_Maybe.Just(top))(
        Data_Array.foldl(bind)(pure(bottom))(
          Data_Array.replicate((c - 1) | 0)(succ1)
        )
      );
...
var checkBoundedEnum = function (dictArbitrary) {
  ...
  return function (dictBoundedEnum) {
    var checkBoundedEnumGen1 = checkBoundedEnumGen(dictBoundedEnum)(
      dictBoundedEnum.Enum1().Ord0()
    );
    return function (dictOrd) {
      return function (v) {
