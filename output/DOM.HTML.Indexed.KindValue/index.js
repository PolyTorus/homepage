...
var renderKindValue = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.KindValue (line 16, column 19 - line 21, column 29): " +
      [v.constructor.name]
  );
};
var eqKindValue = {
...
var ordKindValue = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.KindValue (line 0, column 0 - line 0, column 0): " +
