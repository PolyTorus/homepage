    ...
    at: function (x) {
      return function (dictStrong) {
        var update = function (v) {
          ...
          throw new Error(
            "Failed pattern match at Data.Lens.At (line 50, column 5 - line 50, column 32): " +
              [v.constructor.name]
          );
        };
        var get = function (xs) {
...
var atIdentity = {
  at: function (v) {
    return function (dictStrong) {
      ...
      })(Data_Function.flip(Data_Maybe.maybe)(Data_Identity.Identity))(
        dictStrong
      );
    };
  },
...
var sans = function (dictAt) {
  var at1 = at(dictAt);
  return function (k) {
    return Data_Lens_Setter.set(at1(k)(Data_Profunctor_Strong.strongFn))(
      Data_Maybe.Nothing.value
    );
  };
};
export { at, sans, atIdentity, atMaybe, atSet, atMap, atForeignObject };
