...
var semigroupoidCostar = function (dictExtend) {
  var composeCoKleisliFlipped =
    Control_Extend.composeCoKleisliFlipped(dictExtend);
  return {
    compose: function (v) {
      return function (v1) {
    ...
    first: function (v) {
      return function (x) {
        return new Data_Tuple.Tuple(
          v(map(Data_Tuple.fst)(x)),
          Data_Tuple.snd(extract(x))
        );
      };
    },
    second: function (v) {
      return function (x) {
        return new Data_Tuple.Tuple(
          Data_Tuple.fst(extract(x)),
          v(map(Data_Tuple.snd)(x))
        );
      };
    },
