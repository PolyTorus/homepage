            ...
            return function (genwbc) {
              return function (genwab) {
                ...
                return function __do() {
                  ...
                  return quickCheck$prime(1000)(
                    lift3(associativity)(genwbc)(genwab)(gen)
                  )();
                };
              };
            };
  ...
  return function (dictArbitrary) {
    ...
    return function (dictCoarbitrary) {
      ...
      var arbitrary1 = Test_QuickCheck_Arbitrary.arbitrary(
        Test_QuickCheck_Arbitrary.arbFunction(dictCoarbitrary)(
          Test_QuickCheck_Laws.arbitraryB
        )
      );
      return function (dictCoarbitrary1) {
        var checkExtendGen4 = checkExtendGen3(dictCoarbitrary1);
        var arbitrary2 = Test_QuickCheck_Arbitrary.arbitrary(
          Test_QuickCheck_Arbitrary.arbFunction(dictCoarbitrary1)(
