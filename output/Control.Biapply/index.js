...
var biapplyFirst = function (dictBiapply) {
  ...
  return function (a) {
    return function (b) {
      return biapply1(
        bimap(Data_Function["const"](identity))(
          Data_Function["const"](identity)
        )(a)
      )(b);
    };
  };
...
var biapplySecond = function (dictBiapply) {
  ...
  return function (a) {
    return function (b) {
      return biapply1(bimap(Data_Function["const"])(Data_Function["const"])(a))(
        b
      );
    };
  };
...
export { biapply, biapplyFirst, biapplySecond, bilift2, bilift3, biapplyTuple };
