...
var fromEnumEventPhase = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.Event.EventPhase (line 40, column 3 - line 44, column 18): " +
      [v.constructor.name]
  );
};
var eqEventPhase = {
...
var ordEventPhase = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.Event.EventPhase (line 0, column 0 - line 0, column 0): " +
...
var enumEventPhase = {
  succ: /* #__PURE__ */ Data_Enum.defaultSucc(toEnumEventPhase)(
    fromEnumEventPhase
  ),
  pred: /* #__PURE__ */ Data_Enum.defaultPred(toEnumEventPhase)(
    fromEnumEventPhase
  ),
  Ord0: function () {
