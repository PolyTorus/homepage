...
var compare1 = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ Data_Ord.ordArray(Data_Ord.ordString)
);
...
var eq2 = /* #__PURE__ */ Data_Eq.eq(
  /* #__PURE__ */ Data_Eq.eqArray(eqPredicate)
);
var eqRefinement = {
  eq: function (x) {
    return function (y) {
...
var ordPredicate = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.Selector (line 0, column 0 - line 0, column 0): " +
...
var compare2 = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ Data_Ord.ordArray(ordPredicate)
);
var ordRefinement = {
  compare: function (x) {
    return function (y) {
...
var eqSelector = {
  eq: function (x) {
    return function (y) {
      return (
        eq3(x.value0)(y.value0) &&
        Data_Eq.eq(eqPath(eqSelector))(x.value1)(y.value1)
      );
    };
  }
};
...
var isStringSelector = {
  fromString: function (s) {
    ...
    if (v === ".") {
      return new Selector(
        byClass(Data_String_CodePoints.drop(1)(s)),
        Star.value
      );
    }
