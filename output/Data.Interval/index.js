    ...
    return {
      show: function (v) {
        if (v instanceof StartEnd) {
          return (
            "(StartEnd " + (show2(v.value0) + (" " + (show2(v.value1) + ")")))
          );
        }
        if (v instanceof DurationEnd) {
          return (
            "(DurationEnd " +
            (show1(v.value0) + (" " + (show2(v.value1) + ")")))
          );
        }
        if (v instanceof StartDuration) {
          return (
            "(StartDuration " +
            (show2(v.value0) + (" " + (show1(v.value1) + ")")))
          );
        }
        ...
        throw new Error(
          "Failed pattern match at Data.Interval (line 66, column 1 - line 70, column 60): " +
            [v.constructor.name]
        );
      }
    };
    ...
    return {
      compare: function (x) {
        return function (y) {
          ...
          throw new Error(
            "Failed pattern match at Data.Interval (line 0, column 0 - line 0, column 0): " +
  ...
  bimap: function (v) {
    return function (v1) {
      return function (v2) {
        ...
        throw new Error(
          "Failed pattern match at Data.Interval (line 75, column 1 - line 79, column 50): " +
...
var extendInterval = {
  extend: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.Interval (line 111, column 1 - line 115, column 45): " +
  ...
  extend: function (f) {
    return function (v) {
      return new RecurringInterval(
        v.value0,
        extend(Data_Function["const"](f(v)))(v.value1)
      );
    };
  },
  Functor0: function () {
...
var traversableInterval = {
  traverse: function (dictApplicative) {
    ...
    return function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Interval (line 97, column 1 - line 102, column 29): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    };
  ...
  sequence: function (dictApplicative) {
    return Data_Traversable.sequenceDefault(traversableInterval)(
      dictApplicative
    );
  },
  Functor0: function () {
...
var traversableRecurringInterval = {
  ...
  sequence: function (dictApplicative) {
    return Data_Traversable.sequenceDefault(traversableRecurringInterval)(
      dictApplicative
    );
  },
  Functor0: function () {
    ...
    return function (v1) {
      return function (v2) {
        return function (v3) {
          ...
          throw new Error(
            "Failed pattern match at Data.Interval (line 89, column 1 - line 95, column 32): " +
              [
                v.constructor.name,
                v1.constructor.name,
                v2.constructor.name,
...
var bifoldableRecurringInterval = {
  ...
  bifoldMap: function (dictMonoid) {
    return Data_Bifoldable.bifoldMapDefaultL(bifoldableRecurringInterval)(
      dictMonoid
    );
  }
};
var bitraversableInterval = {
    ...
    return function (v) {
      return function (v1) {
        return function (v2) {
          ...
          if (v2 instanceof StartDuration) {
            return apply(map1(StartDuration.create)(v1(v2.value0)))(
              v(v2.value1)
            );
          }
          if (v2 instanceof DurationOnly) {
          ...
          throw new Error(
            "Failed pattern match at Data.Interval (line 104, column 1 - line 109, column 33): " +
              [v.constructor.name, v1.constructor.name, v2.constructor.name]
          );
        };
      };
  ...
  bisequence: function (dictApplicative) {
    return Data_Bitraversable.bisequenceDefault(bitraversableInterval)(
      dictApplicative
    );
  },
  Bifunctor0: function () {
...
var bitraversableRecurringInterval = {
  ...
  bisequence: function (dictApplicative) {
    return Data_Bitraversable.bisequenceDefault(bitraversableRecurringInterval)(
      dictApplicative
    );
  },
  Bifunctor0: function () {
