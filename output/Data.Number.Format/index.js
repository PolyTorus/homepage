...
var toStringWith = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.Number.Format (line 59, column 1 - line 59, column 43): " +
      [v.constructor.name]
  );
};
var precision = /* #__PURE__ */ (function () {
...
export { toString } from "./foreign.js";
export { precision, fixed, exponential, toStringWith };
