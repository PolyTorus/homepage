...
var setDropEffect = function (de) {
  return $foreign["_setDropEffect"](
    (function () {
      ...
      throw new Error(
        "Failed pattern match at Web.HTML.Event.DataTransfer (line 97, column 35 - line 101, column 17): " +
          [de.constructor.name]
      );
    })()
  );
...
var files = /* #__PURE__ */ Data_Functor.map(Data_Functor.functorFn)(
...
var ordDropEffect = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.HTML.Event.DataTransfer (line 0, column 0 - line 0, column 0): " +
...
export { items, types } from "./foreign.js";
export {
  files,
  getData,
  setData,
