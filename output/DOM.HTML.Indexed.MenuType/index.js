...
var renderMenuType = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.MenuType (line 14, column 18 - line 17, column 27): " +
      [v.constructor.name]
  );
};
var eqMenuType = {
...
var ordMenuType = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.MenuType (line 0, column 0 - line 0, column 0): " +
