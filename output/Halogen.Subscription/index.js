...
var semigroupSubscription = /* #__PURE__ */ Effect.semigroupEffect(
  Data_Semigroup.semigroupUnit
);
...
var monoidSubscription = /* #__PURE__ */ Effect.monoidEffect(
  Data_Monoid.monoidUnit
);
var mempty = /* #__PURE__ */ Data_Monoid.mempty(
  /* #__PURE__ */ Data_Monoid.monoidFn(
    /* #__PURE__ */ Effect.monoidEffect(monoidSubscription)
  )
);
...
var create = function __do() {
  ...
  return {
    ...
    listener: function (a) {
      return bind(Effect_Ref.read(subscribers))(
        ...
        return function __do() {
          ...
          var v2 = v(function (a) {
            return function __do() {
              ...
              return bind(Effect_Ref.read(latestB))(
                traverse_2(function ($79) {
                  return k(a($79));
                })
              )();
            };
          ...
          var v3 = v1(function (b) {
            return function __do() {
              ...
              return bind(Effect_Ref.read(latestA))(
                traverse_2(function ($80) {
                  return k(
                    (function (v3) {
                      return v3(b);
                    })($80)
