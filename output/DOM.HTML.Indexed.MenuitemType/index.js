...
var renderMenuitemType = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.MenuitemType (line 14, column 22 - line 17, column 27): " +
      [v.constructor.name]
  );
};
var eqMenuitemType = {
...
var ordMenuitemType = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.MenuitemType (line 0, column 0 - line 0, column 0): " +
