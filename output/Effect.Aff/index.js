...
var $lazy_applyAff = /* #__PURE__ */ $runtime_lazy(
  "applyAff",
  "Effect.Aff",
  function () {
    return {
...
var $$finally = function (fin) {
  return function (a) {
    return bracket(pure2(Data_Unit.unit))(Data_Function["const"](fin))(
      Data_Function["const"](a)
    );
  };
};
...
var parSequence_ = /* #__PURE__ */ Control_Parallel.parSequence_(parallelAff)(
  applicativeParAff
...
var applyFiber = {
  apply: function (t1) {
    return function (t2) {
      return Effect_Unsafe.unsafePerformEffect(
        makeFiber(apply(joinFiber(t1))(joinFiber(t2)))
      );
    };
  },
  Functor0: function () {
...
var killFiber = function (e) {
  return function (v) {
    return bind1(liftEffect(v.isSuspended))(function (suspended) {
      if (suspended) {
        return liftEffect(
          $$void(v.kill(e, Data_Function["const"](pure(Data_Unit.unit))))
        );
      }
      return $foreign.makeAff(function (k) {
...
var supervise = function (aff) {
  ...
  var killAll = function (err) {
    return function (sup) {
      return $foreign.makeAff(function (k) {
        return $foreign["_killAll"](
          err,
          sup.supervisor,
          k(pure1(Data_Unit.unit))
        );
      });
    };
  };
...
var monadSTAff = {
  liftST: /* #__PURE__ */ (function () {
    var $81 = Control_Monad_ST_Class.liftST(
...
var catchError =
  /* #__PURE__ */ Control_Monad_Error_Class.catchError(monadErrorAff);
var attempt = $$try;
var runAff = function (k) {
  return function (aff) {
    return launchAff(
      bindFlipped(function ($83) {
...
var nonCanceler = /* #__PURE__ */ Data_Function["const"](
  /* #__PURE__ */ pure2(Data_Unit.unit)
);
var monoidCanceler = {
  mempty: nonCanceler,
  Semigroup0: function () {
...
var plusAff = {
  empty: /* #__PURE__ */ Control_Monad_Error_Class.throwError(monadThrowAff)(
    /* #__PURE__ */ Effect_Exception.error("Always fails")
  ),
  Alt0: function () {
    return altAff;
  }
...
export { makeAff, generalBracket } from "./foreign.js";
export {
  Canceler,
  launchAff,
  launchAff_,
...
export { parallel, sequential } from "../Control.Parallel.Class/index.js";
export { Milliseconds } from "../Data.Time.Duration/index.js";
export { error, message } from "../Effect.Exception/index.js";
