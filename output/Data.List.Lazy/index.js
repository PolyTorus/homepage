...
var sequence = /* #__PURE__ */ Data_Traversable.sequence(
  Data_List_Lazy_Types.traversableList
);
var foldr = /* #__PURE__ */ Data_Foldable.foldr(
  Data_List_Lazy_Types.foldableList
);
var map1 = /* #__PURE__ */ Data_Functor.map(Data_Maybe.functorMaybe);
var tailRecM2 = /* #__PURE__ */ Control_Monad_Rec_Class.tailRecM2(
  Control_Monad_Rec_Class.monadRecMaybe
);
...
var unfoldr = /* #__PURE__ */ Data_Unfoldable.unfoldr(
  Data_List_Lazy_Types.unfoldableList
);
...
var any = /* #__PURE__ */ Data_Foldable.any(Data_List_Lazy_Types.foldableList)(
  Data_HeytingAlgebra.heytingAlgebraBoolean
);
var append1 = /* #__PURE__ */ Data_Semigroup.append(
  Data_List_Lazy_Types.semigroupList
);
    ...
    return function (ys) {
      var go = function (v) {
        return function (v1) {
          ...
          if (
            v instanceof Data_List_Lazy_Types.Cons &&
            v1 instanceof Data_List_Lazy_Types.Cons
          ) {
            return new Data_List_Lazy_Types.Cons(
              f(v.value0)(v1.value0),
              zipWith(f)(v.value1)(v1.value1)
            );
          }
          throw new Error(
            "Failed pattern match at Data.List.Lazy (line 705, column 3 - line 705, column 35): " +
      ...
      var go = function (v) {
        return function (v1) {
          ...
          if (v1 instanceof Data_List_Lazy_Types.Cons) {
            return new Data_List_Lazy_Types.Cons(
              v1.value0,
              updateAt((v - 1) | 0)(x)(v1.value1)
            );
          }
          throw new Error(
            "Failed pattern match at Data.List.Lazy (line 361, column 3 - line 361, column 17): " +
              [v.constructor.name, v1.constructor.name]
          );
        };
      };
  ...
  return foldr(function (v) {
    return function (v1) {
      return new Data_Tuple.Tuple(
        Data_List_Lazy_Types.cons(v.value0)(v1.value0),
        Data_List_Lazy_Types.cons(v.value1)(v1.value1)
      );
    };
...
var uncons = function (xs) {
  ...
  throw new Error(
    "Failed pattern match at Data.List.Lazy (line 288, column 13 - line 290, column 44): " +
      [v.constructor.name]
  );
};
  ...
  var go = function (v) {
    return function (v1) {
      ...
      if (v1 instanceof Data_List_Lazy_Types.Cons) {
        return new Data_List_Lazy_Types.Cons(
          v1.value0,
          take((v - 1) | 0)(v1.value1)
        );
      }
      throw new Error(
        "Failed pattern match at Data.List.Lazy (line 505, column 3 - line 505, column 32): " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  };
      ...
      var go = function (prefix) {
        return function (input) {
          ...
          if (v1 instanceof Data_List_Lazy_Types.Cons) {
            ...
            if (
              v2 instanceof Data_List_Lazy_Types.Cons &&
              eq(v1.value0)(v2.value0)
            ) {
              return new Data_Maybe.Just(
          ...
          throw new Error(
            "Failed pattern match at Data.List.Lazy (line 487, column 21 - line 491, column 19): " +
              [v1.constructor.name]
          );
        };
      };
...
var snoc = function (xs) {
  return function (x) {
    return foldr(Data_List_Lazy_Types.cons)(
      Data_List_Lazy_Types.cons(x)(Data_List_Lazy_Types.nil)
    )(xs);
  };
};
    ...
    return function (xs) {
      var go = function (v) {
        ...
        if (v instanceof Data_List_Lazy_Types.Cons) {
          ...
          return new Data_List_Lazy_Types.Cons(
            acc$prime,
            scanlLazy(f)(acc$prime)(v.value1)
          );
        }
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 776, column 5 - line 776, column 27): " +
            [v.constructor.name]
        );
      };
...
var reverse = function (xs) {
  return defer(function (v) {
    return foldl(Data_Function.flip(Data_List_Lazy_Types.cons))(
...
var replicateM = function (dictMonad) {
  ...
  return function (n) {
    return function (m) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.Lazy (line 164, column 1 - line 164, column 62): " +
  ...
  return function (end) {
    if (start > end) {
      var g = function (x) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 151, column 13 - line 152, column 38): " +
            [x.constructor.name]
        );
      };
    ...
    if (Data_Boolean.otherwise) {
      var f = function (x) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 156, column 5 - line 157, column 30): " +
            [x.constructor.name]
        );
      };
    ...
    throw new Error(
      "Failed pattern match at Data.List.Lazy (line 148, column 1 - line 148, column 32): " +
  ...
  var goStep = function (v) {
    return function (v1) {
      ...
      if (v1 instanceof Data_List_Lazy_Types.Cons) {
        ...
        return new Data_List_Lazy_Types.Cons(
          v1.value0,
          go(v2.result)(v1.value1)
        );
      }
      throw new Error(
        "Failed pattern match at Data.List.Lazy (line 613, column 5 - line 613, column 23): " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  };
  ...
  var go = function ($copy_v) {
    ...
    function $tco_loop(v) {
      ...
      if (v instanceof Data_List_Lazy_Types.Cons) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 448, column 5 - line 450, column 39): " +
            [v1.constructor.name]
        );
      }
      throw new Error(
        "Failed pattern match at Data.List.Lazy (line 446, column 3 - line 446, column 15): " +
          [v.constructor.name]
      );
    }
    while (!$tco_done) {
...
var some = function (dictAlternative) {
  ...
  return function (dictLazy) {
    ...
    return function (v) {
      return apply1(map3(Data_List_Lazy_Types.cons)(v))(
        defer1(function (v1) {
...
var many = function (dictAlternative) {
  ...
  return function (dictLazy) {
    return function (v) {
      return alt(some(dictAlternative)(dictLazy)(v))(
        pure1(Data_List_Lazy_Types.nil)
      );
    };
  };
};
    ...
    return function (v2) {
      ...
      var go = function (v3) {
        ...
        if (v3 instanceof Data_List_Lazy_Types.Cons) {
          return new Data_List_Lazy_Types.Cons(
            v3.value0,
            insertAt((v - 1) | 0)(v1)(v3.value1)
          );
        }
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 340, column 3 - line 340, column 22): " +
            [v3.constructor.name]
        );
      };
...
var init = /* #__PURE__ */ (function () {
  var go = function (v) {
    if (v instanceof Data_List_Lazy_Types.Cons) {
      ...
      if (Data_Boolean.otherwise) {
        return map1(Data_List_Lazy_Types.cons(v.value0))(
          go(Data_List_Lazy_Types.step(v.value1))
        );
      }
    }
    return Data_Maybe.Nothing.value;
  ...
  var go = function ($copy_v) {
    return function ($copy_v1) {
      ...
      function $tco_loop(v, v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 302, column 3 - line 302, column 21): " +
            [v.constructor.name, v1.constructor.name]
        );
      }
      while (!$tco_done) {
  ...
  if (v instanceof Data_Maybe.Just) {
    ...
    if (v1 instanceof Data_Maybe.Just) {
      return Data_List_Lazy_Types.cons(
        Data_List_Lazy_Types.cons(v1.value0.head)(mapMaybe(head)(v.value0.tail))
      )(
        transpose(
          Data_List_Lazy_Types.cons(v1.value0.tail)(
            mapMaybe(tail)(v.value0.tail)
          )
        )
      );
    }
    throw new Error(
      "Failed pattern match at Data.List.Lazy (line 746, column 7 - line 750, column 72): " +
        [v1.constructor.name]
    );
  }
  throw new Error(
    "Failed pattern match at Data.List.Lazy (line 742, column 3 - line 750, column 72): " +
      [v.constructor.name]
  );
};
var groupBy = function (eq) {
  var go = function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.List.Lazy (line 576, column 3 - line 576, column 15): " +
        [v.constructor.name]
    );
  };
  var $340 = map(go);
      ...
      var go = function (v) {
        ...
        if (v instanceof Data_List_Lazy_Types.Cons) {
          ...
          if (v1 instanceof Data_Ordering.GT) {
            return new Data_List_Lazy_Types.Cons(
              v.value0,
              insertBy(cmp)(x)(v.value1)
            );
          }
          return new Data_List_Lazy_Types.Cons(x, fromStep(v));
        }
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 238, column 3 - line 238, column 22): " +
            [v.constructor.name]
        );
      };
      return map(go)(unwrap(xs));
...
var fromFoldable = function (dictFoldable) {
  return Data_Foldable.foldr(dictFoldable)(Data_List_Lazy_Types.cons)(
    Data_List_Lazy_Types.nil
  );
};
  ...
  return function (op) {
    return function (z) {
      var go = function (xs) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 768, column 13 - line 770, column 15): " +
            [v.constructor.name]
        );
      };
      return go;
  ...
  return function (f) {
    return function (b) {
      return function (xs) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 759, column 5 - line 762, column 54): " +
            [v.constructor.name]
        );
      };
    };
    ...
    return function (list) {
      ...
      if (v instanceof Data_Maybe.Just) {
        return bind2(p(v.value0.head))(function (b) {
          return bind2(filterM(dictMonad)(p)(v.value0.tail))(
            function (xs$prime) {
              return pure1(
                (function () {
                  if (b) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.Lazy (line 431, column 5 - line 436, column 48): " +
          [v.constructor.name]
      );
    };
  };
...
var filter = function (p) {
  var go = function ($copy_v) {
    ...
    function $tco_loop(v) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.Lazy (line 416, column 3 - line 416, column 15): " +
          [v.constructor.name]
      );
    }
    while (!$tco_done) {
  ...
  var go = function ($copy_v) {
    return function ($copy_v1) {
      ...
      function $tco_loop(v, v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 524, column 3 - line 524, column 15): " +
            [v.constructor.name, v1.constructor.name]
        );
      }
      while (!$tco_done) {
      ...
      var go = function (v) {
        ...
        if (v instanceof Data_List_Lazy_Types.Cons) {
          ...
          if (Data_Boolean.otherwise) {
            return new Data_List_Lazy_Types.Cons(
              v.value0,
              deleteBy(eq)(x)(v.value1)
            );
          }
        }
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 662, column 3 - line 662, column 15): " +
            [v.constructor.name]
        );
      };
      return map(go)(unwrap(xs));
...
var unionBy = function (eq) {
  return function (xs) {
    return function (ys) {
      return append1(xs)(
        foldl(Data_Function.flip(deleteBy(eq)))(nubByEq(eq)(ys))(xs)
      );
    };
  };
};
  ...
  return function (xs) {
    var go = function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.List.Lazy (line 350, column 3 - line 350, column 17): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    };
      ...
      var go = function (v) {
        return function (v1) {
          ...
          if (v === 0 && v1 instanceof Data_List_Lazy_Types.Cons) {
            ...
            throw new Error(
              "Failed pattern match at Data.List.Lazy (line 382, column 22 - line 384, column 26): " +
                [v2.constructor.name]
            );
          }
          if (v1 instanceof Data_List_Lazy_Types.Cons) {
            return new Data_List_Lazy_Types.Cons(
              v1.value0,
              alterAt((v - 1) | 0)(f)(v1.value1)
            );
          }
          throw new Error(
            "Failed pattern match at Data.List.Lazy (line 381, column 3 - line 381, column 17): " +
              [v.constructor.name, v1.constructor.name]
          );
        };
      };
...
export { scanl, scanr } from "../Data.Traversable/index.js";
