...
var showCodePoint = {
  show: function (v) {
    return (
      "(CodePoint 0x" +
      (Data_String_Common.toUpper(
        Data_Int.toStringAs(Data_Int.hexadecimal)(v)
      ) +
        ")")
    );
  }
...
var unsafeCodePointAt0 = /* #__PURE__ */ $foreign["_unsafeCodePointAt0"](
  unsafeCodePointAt0Fallback
);
var toCodePointArray = /* #__PURE__ */ $foreign["_toCodePointArray"](
...
var fromCharCode = /* #__PURE__ */ (function () {
  var $75 = Data_Enum.toEnumWithDefaults(Data_Enum.boundedEnumChar)(
...
var fromCodePointArray =
  /* #__PURE__ */ $foreign["_fromCodePointArray"](singletonFallback);
...
var takeFallback = function (v) {
  return function (v1) {
    ...
    if (v2 instanceof Data_Maybe.Just) {
      return (
        singleton(v2.value0.head) + takeFallback((v - 1) | 0)(v2.value0.tail)
      );
    }
    return v1;
  };
...
var drop = function (n) {
  return function (s) {
    return Data_String_CodeUnits.drop(Data_String_CodeUnits.length(take(n)(s)))(
      s
    );
  };
};
...
var countPrefix =
  /* #__PURE__ */ $foreign["_countPrefix"](countFallback)(unsafeCodePointAt0);
...
var codePointAt = function (v) {
  return function (v1) {
    ...
    return $foreign["_codePointAt"](codePointAtFallback)(
      Data_Maybe.Just.create
    )(Data_Maybe.Nothing.value)(unsafeCodePointAt0)(v)(v1);
  };
};
...
var $lazy_enumCodePoint = /* #__PURE__ */ $runtime_lazy(
  "enumCodePoint",
  "Data.String.CodePoints",
  function () {
    return {
      succ: Data_Enum.defaultSucc(Data_Enum.toEnum(boundedEnumCodePoint))(
        Data_Enum.fromEnum(boundedEnumCodePoint)
      ),
      pred: Data_Enum.defaultPred(Data_Enum.toEnum(boundedEnumCodePoint))(
        Data_Enum.fromEnum(boundedEnumCodePoint)
      ),
      Ord0: function () {
        return ordCodePoint;
