...
var renderInputAcceptTypeAtom = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.InputAcceptType (line 34, column 29 - line 36, column 33): " +
      [v.constructor.name]
  );
};
...
var eqInputAcceptTypeAtom = {
  eq: function (x) {
    return function (y) {
      ...
      if (
        x instanceof AcceptFileExtension &&
        y instanceof AcceptFileExtension
      ) {
...
var eq2 = /* #__PURE__ */ Data_Eq.eq(
  /* #__PURE__ */ Data_Eq.eqArray(eqInputAcceptTypeAtom)
);
var ordInputAcceptTypeAtom = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.InputAcceptType (line 0, column 0 - line 0, column 0): " +
...
var compare2 = /* #__PURE__ */ Data_Ord.compare(
  /* #__PURE__ */ Data_Ord.ordArray(ordInputAcceptTypeAtom)
);
