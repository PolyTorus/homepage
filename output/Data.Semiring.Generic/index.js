      ...
      "genericAdd'": function (v) {
        return function (v1) {
          return new Data_Generic_Rep.Product(
            genericAdd$prime1(v.value0)(v1.value0),
            genericAdd$prime2(v.value1)(v1.value1)
          );
        };
      },
      "genericZero'": new Data_Generic_Rep.Product(
        genericZero$prime1,
        genericZero$prime(dictGenericSemiring1)
      ),
      "genericMul'": function (v) {
        return function (v1) {
          return new Data_Generic_Rep.Product(
            genericMul$prime1(v.value0)(v1.value0),
            genericMul$prime2(v.value1)(v1.value1)
          );
        };
      },
      "genericOne'": new Data_Generic_Rep.Product(
        genericOne$prime1,
        genericOne$prime(dictGenericSemiring1)
      )
    };
  };
};
