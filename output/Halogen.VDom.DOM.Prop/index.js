...
var functorElemRef = {
  map: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Halogen.VDom.DOM.Prop (line 49, column 1 - line 51, column 36): " +
...
var buildProp = function (emit) {
  return function (el) {
    var removeProp = function (prevEvents) {
      return function (v, v1) {
        if (v1 instanceof Attribute) {
          return Halogen_VDom_Util.removeAttribute(
            Data_Nullable.toNullable(v1.value0),
            v1.value1,
            el
          );
        }
        ...
        if (v1 instanceof Handler) {
          ...
          return Halogen_VDom_Util.removeEventListener(
            v1.value0,
            Data_Tuple.fst(handler),
            el
          );
        }
        if (v1 instanceof Ref) {
    ...
    var diffProp = function (prevEvents, events) {
      return function (v, v1, v11, v2) {
        if (v11 instanceof Attribute && v2 instanceof Attribute) {
          ...
          Halogen_VDom_Util.setAttribute(
            Data_Nullable.toNullable(v2.value0),
            v2.value1,
            v2.value2,
            el
          );
    ...
    var applyProp = function (events) {
      return function (v, v1, v2) {
        ...
        if (v2 instanceof Handler) {
          ...
          Halogen_VDom_Util.pokeMutMap(
            v2.value0,
            new Data_Tuple.Tuple(listener, ref),
            events
          );
    ...
    var $lazy_patchProp = $runtime_lazy(
      "patchProp",
      ...
      function () {
        return function (state, ps2) {
          ...
          var props = Halogen_VDom_Util.diffWithKeyAndIxE(
            state.props,
            ps2,
            propToStrKey,
            onThese,
    ...
    var renderProp = function (ps1) {
      var events = Halogen_VDom_Util.newMutMap();
      var ps1$prime = Halogen_VDom_Util.strMapWithIxE(
        ps1,
        propToStrKey,
        applyProp(events)
      );
