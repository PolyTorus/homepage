...
var monadParWriterT = function (dictMonoid) {
  var applyWriterT = Control_Monad_Writer_Trans.applyWriterT(
  ...
  return function (dictParallel) {
    ...
    return {
      ...
      sequential: Control_Monad_Writer_Trans.mapWriterT(
        sequential(dictParallel)
      ),
      Apply0: function () {
...
var monadParReaderT = function (dictParallel) {
  var applyReaderT = Control_Monad_Reader_Trans.applyReaderT(
    dictParallel.Apply0()
  );
  var applyReaderT1 = Control_Monad_Reader_Trans.applyReaderT(
    dictParallel.Apply1()
  );
  return {
...
var monadParMaybeT = function (dictParallel) {
  var parallel1 = parallel(dictParallel);
  var sequential1 = sequential(dictParallel);
  var applyCompose = Data_Functor_Compose.applyCompose(dictParallel.Apply1())(
...
var monadParParCont = function (dictMonadEffect) {
  var applyContT = Control_Monad_Cont_Trans.applyContT(
    dictMonadEffect.Monad0().Bind1().Apply0()
  );
  return {
    parallel: ParCont,
    sequential: function (v) {
...
var functorParCont = function (dictMonadEffect) {
  var map = Data_Functor.map(
    Control_Monad_Cont_Trans.functorContT(
...
var applyParCont = function (dictMonadEffect) {
  ...
  return {
    apply: function (v) {
      return function (v1) {
        return function (k) {
          return bind(liftEffect(Effect_Ref["new"](Data_Maybe.Nothing.value)))(
            function (ra) {
              return bind(
                liftEffect(Effect_Ref["new"](Data_Maybe.Nothing.value))
              )(function (rb) {
                return discard1(
                  Control_Monad_Cont_Trans.runContT(v)(function (a) {
                    return bind(liftEffect(Effect_Ref.read(rb)))(function (mb) {
                      if (mb instanceof Data_Maybe.Nothing) {
                        return liftEffect(
                          Effect_Ref.write(new Data_Maybe.Just(a))(ra)
                        );
                      }
                      ...
                      throw new Error(
                        "Failed pattern match at Control.Parallel.Class (line 83, column 7 - line 85, column 26): " +
                          [mb.constructor.name]
                      );
                    });
                  })
                  ...
                  return Control_Monad_Cont_Trans.runContT(v1)(function (b) {
                    return bind(liftEffect(Effect_Ref.read(ra)))(function (ma) {
                      if (ma instanceof Data_Maybe.Nothing) {
                        return liftEffect(
                          Effect_Ref.write(new Data_Maybe.Just(b))(rb)
                        );
                      }
                      ...
                      throw new Error(
                        "Failed pattern match at Control.Parallel.Class (line 89, column 7 - line 91, column 26): " +
                          [ma.constructor.name]
                      );
                    });
                  });
...
var applicativeParCont = function (dictMonadEffect) {
  ...
  return {
    pure: (function () {
      ...
      var $133 = Control_Applicative.pure(
        Control_Monad_Cont_Trans.applicativeContT(
          dictMonadEffect.Monad0().Applicative0()
        )
      );
      return function ($134) {
        return $132($133($134));
            ...
            return discard1(
              Control_Monad_Cont_Trans.runContT(v)(function (a) {
                return bind(liftEffect(Effect_Ref.read(done)))(function (b) {
                  ...
                  return discard1(liftEffect(Effect_Ref.write(true)(done)))(
                    function () {
                      return k(a);
                    }
                  );
