...
var renderWrapValue = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.WrapValue (line 13, column 19 - line 15, column 17): " +
      [v.constructor.name]
  );
};
var eqWrapValue = {
...
var ordWrapValue = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.WrapValue (line 0, column 0 - line 0, column 0): " +
...
export { Hard, Soft, renderWrapValue, eqWrapValue, ordWrapValue };
