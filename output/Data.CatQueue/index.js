  ...
  function $tco_loop(v) {
    if (v.value1 instanceof Data_List_Types.Cons) {
      ...
      return new Data_Maybe.Just(
        new Data_Tuple.Tuple(
          v.value1.value0,
          new CatQueue(v.value0, v.value1.value1)
        )
      );
    }
    if (
    ...
    if (v.value1 instanceof Data_List_Types.Nil) {
      $copy_v = new CatQueue(
        ...
        Data_List.reverse(v.value0)
      );
      return;
    }
    throw new Error(
      "Failed pattern match at Data.CatQueue (line 92, column 1 - line 92, column 63): " +
        [v.constructor.name]
    );
  }
  while (!$tco_done) {
  ...
  function $tco_loop(v) {
    ...
    if (v.value0 instanceof Data_List_Types.Cons) {
      ...
      return new Data_Maybe.Just(
        new Data_Tuple.Tuple(
          v.value0.value0,
          new CatQueue(v.value0.value1, v.value1)
        )
      );
    }
    throw new Error(
    ...
    var go = function ($copy_acc) {
      return function ($copy_q) {
        ...
        function $tco_loop(acc, q) {
          ...
          throw new Error(
            "Failed pattern match at Data.CatQueue (line 147, column 16 - line 149, column 22): " +
              [v.constructor.name]
          );
        }
        while (!$tco_done) {
...
var traversableCatQueue = {
  ...
  sequence: function (dictApplicative) {
    return Data_Traversable.sequenceDefault(traversableCatQueue)(
      dictApplicative
    );
  },
  Functor0: function () {
      ...
      var go = function ($copy_source) {
        return function ($copy_memo) {
          ...
          function $tco_loop(source, memo) {
            ...
            throw new Error(
              "Failed pattern match at Data.CatQueue (line 154, column 24 - line 156, column 57): " +
                [v.constructor.name]
            );
          }
          while (!$tco_done) {
      ...
      var go = function ($copy_source) {
        return function ($copy_memo) {
          ...
          function $tco_loop(source, memo) {
            ...
            throw new Error(
              "Failed pattern match at Data.CatQueue (line 161, column 24 - line 163, column 57): " +
                [v.constructor.name]
            );
          }
          while (!$tco_done) {
    ...
    return function ($copy_ys) {
      ...
      function $tco_loop(xs, ys) {
        ...
        if (
          ...
          elemEq(v1.value0.value0)(v.value0.value0)
        ) {
  ...
  var go = function ($copy_xs) {
    return function ($copy_ys) {
      ...
      function $tco_loop(xs, ys) {
        ...
        throw new Error(
          "Failed pattern match at Data.CatQueue (line 117, column 16 - line 124, column 30): " +
...
var bindCatQueue = {
  bind: /* #__PURE__ */ Data_Function.flip(
    /* #__PURE__ */ Data_Foldable.foldMap(foldableCatQueue)(monoidCatQueue)
  ),
  Apply0: function () {
...
var $lazy_applyCatQueue = /* #__PURE__ */ $runtime_lazy(
  "applyCatQueue",
  "Data.CatQueue",
  function () {
    return {
