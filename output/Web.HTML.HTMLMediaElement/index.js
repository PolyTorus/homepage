...
var toEnum = /* #__PURE__ */ Data_Enum.toEnum(
  Web_HTML_HTMLMediaElement_ReadyState.boundedEnumReadyState
);
var toEnum1 = /* #__PURE__ */ Data_Enum.toEnum(
  Web_HTML_HTMLMediaElement_NetworkState.boundedEnumNetworkState
);
  ...
  return map(
    (function () {
      var $4 = Data_Maybe.fromMaybe(
        Web_HTML_HTMLMediaElement_ReadyState.HaveNothing.value
      );
      return function ($5) {
        return $4(toEnum($5));
      };
  ...
  return map(
    (function () {
      var $6 = Data_Maybe.fromMaybe(
        Web_HTML_HTMLMediaElement_NetworkState.Empty.value
      );
      return function ($7) {
        return $6(toEnum1($7));
      };
...
var fromParentNode =
  /* #__PURE__ */ Web_Internal_FFI.unsafeReadProtoTagged("HTMLMediaElement");
...
var canPlayType = function (ty) {
  return function (el) {
    return map(
      (function () {
        var $8 = Data_Maybe.fromMaybe(
          Web_HTML_HTMLMediaElement_CanPlayType.Unspecified.value
        );
        return function ($9) {
