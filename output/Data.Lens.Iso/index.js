  ...
  return function (def) {
    return function (dictProfunctor) {
      var g = function (a) {
        ...
        throw new Error(
          "Failed pattern match at Data.Lens.Iso (line 60, column 3 - line 62, column 25): " +
            [a.constructor.name]
        );
      };
            ...
            return function (bt) {
              return withIso(g)(function (ssaa) {
                return function (bbtt) {
                  return iso(dimap(sa)(ssaa))(dimap1(bt)(bbtt))(
                    dictProfunctor2
                  );
                };
              });
...
export { Exchange, Re } from "../Data.Lens.Types/index.js";
