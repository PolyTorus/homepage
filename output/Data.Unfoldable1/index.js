...
var unfoldable1Array = {
  unfoldr1: /* #__PURE__ */ $foreign.unfoldr1ArrayImpl(Data_Maybe.isNothing)(
    fromJust
  ...
  return function (n) {
    return function (v) {
      var step = function (i) {
        ...
        throw new Error(
          "Failed pattern match at Data.Unfoldable1 (line 68, column 5 - line 68, column 39): " +
            [i.constructor.name]
        );
      };
...
var replicate1A = function (dictApply) {
  return function (dictUnfoldable1) {
    ...
    return function (dictTraversable1) {
      var sequence1 =
        Data_Semigroup_Traversable.sequence1(dictTraversable1)(dictApply);
      return function (n) {
        return function (m) {
            ...
            (function () {
              ...
              if ($28) {
                return new Data_Maybe.Just(
                  new Data_Tuple.Tuple(f(v.value0), (v.value1 - 1) | 0)
                );
              }
              return Data_Maybe.Nothing.value;
            })()
