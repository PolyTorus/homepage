...
var sequence1 = /* #__PURE__ */ Data_Semigroup_Traversable.sequence1(
  Data_List_Types.traversable1NonEmptyList
);
  ...
  return function (v) {
    return function (v1) {
      return new Data_NonEmpty.NonEmpty(
        ...
        Data_List.zipWith(f)(v.value1)(v1.value1)
      );
    };
  };
};
...
var wrappedOperation2 = function (name) {
  return function (f) {
    return function (v) {
      return function (v1) {
        var v2 = f(new Data_List_Types.Cons(v.value0, v.value1))(
        ...
        throw new Error(
          "Failed pattern match at Data.List.NonEmpty (line 105, column 3 - line 107, column 81): " +
            [v2.constructor.name]
        );
      };
    };
...
var wrappedOperation = function (name) {
  return function (f) {
    return function (v) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.NonEmpty (line 92, column 3 - line 94, column 81): " +
          [v1.constructor.name]
      );
    };
  };
...
var updateAt = function (i) {
  return function (a) {
    return function (v) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.NonEmpty (line 198, column 1 - line 198, column 75): " +
          [i.constructor.name, a.constructor.name, v.constructor.name]
      );
    };
  };
};
var unzip = function (ts) {
  return new Data_Tuple.Tuple(
    map1(Data_Tuple.fst)(ts),
    map1(Data_Tuple.snd)(ts)
  );
};
var unsnoc = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.List.NonEmpty (line 160, column 35 - line 162, column 50): " +
      [v1.constructor.name]
  );
};
...
var snoc$prime = function (v) {
  return function (v1) {
    ...
    throw new Error(
      "Failed pattern match at Data.List.NonEmpty (line 140, column 1 - line 140, column 51): " +
    ...
    return function (v) {
      if (i === 0) {
        return new Data_Maybe.Just(
          new Data_NonEmpty.NonEmpty(f(v.value0), v.value1)
        );
      }
      if (Data_Boolean.otherwise) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.NonEmpty (line 203, column 1 - line 203, column 82): " +
          [i.constructor.name, f.constructor.name, v.constructor.name]
      );
    };
  };
};
...
var insertAt = function (i) {
  return function (a) {
    return function (v) {
      if (i === 0) {
        return new Data_Maybe.Just(
          new Data_NonEmpty.NonEmpty(
            a,
            new Data_List_Types.Cons(v.value0, v.value1)
          )
        );
      }
      if (Data_Boolean.otherwise) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.NonEmpty (line 193, column 1 - line 193, column 75): " +
          [i.constructor.name, a.constructor.name, v.constructor.name]
      );
    };
  };
...
var index = function (v) {
  return function (i) {
    ...
    throw new Error(
      "Failed pattern match at Data.List.NonEmpty (line 167, column 1 - line 167, column 52): " +
...
var fromList = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.List.NonEmpty (line 121, column 1 - line 121, column 57): " +
      [v.constructor.name]
  );
};
...
var findLastIndex = function (f) {
  return function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.List.NonEmpty (line 187, column 3 - line 191, column 29): " +
        [v1.constructor.name]
    );
  };
};
var findIndex = function (f) {
  return function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.List.NonEmpty (line 180, column 1 - line 180, column 69): " +
...
var appendFoldable = function (dictFoldable) {
  ...
  return function (v) {
    return function (ys) {
      return new Data_NonEmpty.NonEmpty(
        v.value0,
        append1(v.value1)(fromFoldable1(ys))
      );
    };
  };
};
...
export { NonEmptyList } from "../Data.List.Types/index.js";
export {
  fold1,
  foldMap1,
  for1_,
