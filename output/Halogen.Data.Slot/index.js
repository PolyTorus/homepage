...
var slots = function () {
  return function (dictIsSymbol) {
    ...
    return function (dictOrd) {
      var foldSubmap1 = foldSubmap(
        Data_Monoid_Alternate.monoidAlternate(
          Data_Map_Internal.plusMap(dictOrd)
        )
      );
      return function (sym) {
        return function (v) {
          ...
          var go = function (v1) {
            return function (val) {
              if (key === v1.value0) {
                return Data_Map_Internal.singleton(
                  Halogen_Data_OrdBox.unOrdBox(v1.value1)
                )(val);
              }
              ...
              throw new Error(
                "Failed pattern match at Halogen.Data.Slot (line 121, column 3 - line 123, column 38): " +
                  [v1.constructor.name, val.constructor.name]
              );
            };
          };
          return un(Data_Monoid_Alternate.Alternate)(
            foldSubmap1(Data_Maybe.Nothing.value)(Data_Maybe.Nothing.value)(go)(
              v
            )
          );
        };
    ...
    return function (dictOrd) {
      ...
      return function (sym) {
        return function (key) {
          return function (v) {
            return pop1(
              new Data_Tuple.Tuple(reflectSymbol(sym), mkOrdBox(key))
            )(v);
          };
        };
      };
...
export { empty, lookup, insert, pop, slots, foreachSlot };
