...
var renderPreloadValue = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.PreloadValue (line 14, column 22 - line 17, column 32): " +
      [v.constructor.name]
  );
};
var eqPreloadValue = {
...
var ordPreloadValue = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.PreloadValue (line 0, column 0 - line 0, column 0): " +
