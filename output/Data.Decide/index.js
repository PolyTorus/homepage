        ...
        return function (a) {
          return function (b) {
            ...
            if (v2 instanceof Data_Either.Left) {
              ...
              throw new Error(
                "Failed pattern match at Data.Decide (line 27, column 15 - line 29, column 23): " +
                  [v3.constructor.name]
              );
            }
            if (v2 instanceof Data_Either.Right) {
              ...
              throw new Error(
                "Failed pattern match at Data.Decide (line 30, column 16 - line 32, column 23): " +
                  [v3.constructor.name]
              );
            }
            throw new Error(
              "Failed pattern match at Data.Decide (line 26, column 66 - line 32, column 23): " +
                [v2.constructor.name]
            );
          };
        };
        ...
        return function (a) {
          return function (b) {
            ...
            if (v2 instanceof Data_Either.Left) {
              ...
              throw new Error(
                "Failed pattern match at Data.Decide (line 18, column 15 - line 20, column 20): " +
                  [v3.constructor.name]
              );
            }
            if (v2 instanceof Data_Either.Right) {
              ...
              throw new Error(
                "Failed pattern match at Data.Decide (line 21, column 16 - line 23, column 23): " +
                  [v3.constructor.name]
              );
            }
            throw new Error(
              "Failed pattern match at Data.Decide (line 17, column 63 - line 23, column 23): " +
                [v2.constructor.name]
            );
          };
        };
