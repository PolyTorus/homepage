...
var call = function (dictIsString) {
  ...
  return function (dictMonoid) {
    ...
    return function (fn) {
      return function (arg) {
        return append1(fn)(
          append1(fromString1("("))(append1(arg)(fromString1(")")))
        );
      };
    };
  };
...
var browsers = /* #__PURE__ */ (function () {
  return new CSS_Property.Prefixed([
    new Data_Tuple.Tuple("-webkit-", ""),
    new Data_Tuple.Tuple("-moz-", ""),
    new Data_Tuple.Tuple("-ms-", ""),
    new Data_Tuple.Tuple("-o-", ""),
