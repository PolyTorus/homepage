...
var state = /* #__PURE__ */ Control_Monad_State_Class.state(
  /* #__PURE__ */ Control_Monad_State_Trans.monadStateStateT(
    Data_Identity.monadIdentity
  )
);
var monadRecStateT = /* #__PURE__ */ Control_Monad_State_Trans.monadRecStateT(
  ...
  return {
    foldrWithIndex: function (f) {
      var go = function (ix) {
        return function (b) {
          return function (fa) {
            return f(ix)(head(fa))(
              foldr(Data_Function.flip(go((ix + 1) | 0)))(b)(tail(fa))
            );
          };
        };
      };
    ...
    foldMapWithIndex: function (dictMonoid) {
      ...
      return function (f) {
        var go = function (ix) {
          return function (fa) {
            return append(f(ix)(head(fa)))(
              foldMap1(go((ix + 1) | 0))(tail(fa))
            );
          };
        };
        return go(0);
...
var traversableCofree = function (dictTraversable) {
  ...
  return {
    sequence: function (dictApplicative) {
      return Data_Traversable.traverse(traversableCofree(dictTraversable))(
        dictApplicative
      )(identity);
    },
...
var traversableWithIndexCofree = function (dictTraversable) {
  var traverse = Data_Traversable.traverse(dictTraversable);
  var functorWithIndexCofree1 = functorWithIndexCofree(
    dictTraversable.Functor0()
  );
  var foldableWithIndexCofree1 = foldableWithIndexCofree(
    ...
    traverseWithIndex: function (dictApplicative) {
      ...
      return function (f) {
        var loop = function (ix) {
          return function (ta) {
            return apply(map2(mkCofree)(f(ix)(head(ta))))(
              traverse1(loop((ix + 1) | 0))(tail(ta))
            );
          };
        };
        return loop(0);
    ...
    return {
      eq: function (x) {
        return function (y) {
          return (
            eq(head(x))(head(y)) &&
            eq1(eqCofree(dictEq1)(dictEq))(tail(x))(tail(y))
          );
        };
      }
    };
      ...
      append: function (x) {
        return function (y) {
          return deferCofree(function (v) {
            return new Data_Tuple.Tuple(
              append(head(x))(head(y)),
              apply(
                map2(
                  Data_Semigroup.append(
                    semigroupCofree(dictApply)(dictSemigroup)
                  )
                )(tail(x))
              )(tail(y))
            );
  ...
  return function (dictMonoid) {
    ...
    return {
      mempty: deferCofree(function (v) {
        return new Data_Tuple.Tuple(
          mempty,
          pure(Data_Monoid.mempty(monoidCofree(dictApplicative)(dictMonoid)))
        );
      }),
      Semigroup0: function () {
...
var exploreM = function (dictFunctor) {
  ...
  return function (dictFunctor1) {
    ...
    return function (dictMonadRec) {
      var map3 = Data_Functor.map(
        dictMonadRec.Monad0().Bind1().Apply0().Functor0()
      );
      var runFreeM1 = runFreeM(
        Control_Monad_State_Trans.monadRecStateT(dictMonadRec)
      );
      return function (pair) {
        return function (m) {
          return function (w) {
            ...
            return map3($$eval)(
              Control_Monad_State_Trans.runStateT(runFreeM1(step)(m))(w)
            );
          };
        };
      };
