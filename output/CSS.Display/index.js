...
var visibility = /* #__PURE__ */ CSS_Stylesheet.key(valVisibility)(
  /* #__PURE__ */ fromString("visibility")
);
var valPosition = {
  value: function (v) {
    return v;
...
var valFloat = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.Display (line 116, column 1 - line 119, column 40): " +
        [v.constructor.name]
    );
  }
};
...
var valClearFloat = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.Display (line 153, column 1 - line 160, column 56): " +
        [v.constructor.name]
    );
  }
};
...
var showFloat = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.Display (line 111, column 1 - line 114, column 31): " +
        [v.constructor.name]
    );
  }
};
var showClearFloat = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.Display (line 144, column 1 - line 151, column 51): " +
        [v.constructor.name]
    );
  }
};
...
var position = /* #__PURE__ */ CSS_Stylesheet.key(valPosition)(
  /* #__PURE__ */ fromString("position")
);
var opacity = /* #__PURE__ */ CSS_Stylesheet.key(CSS_Property.valNumber)(
  /* #__PURE__ */ fromString("opacity")
);
...
var $$float = /* #__PURE__ */ CSS_Stylesheet.key(valFloat)(
  /* #__PURE__ */ fromString("float")
);
...
var eqClearFloat = {
  eq: function (x) {
    return function (y) {
      ...
      if (
        x instanceof ClearFloatInlineStart &&
        y instanceof ClearFloatInlineStart
      ) {
        return true;
      }
      if (
        x instanceof ClearFloatInlineEnd &&
        y instanceof ClearFloatInlineEnd
      ) {
        return true;
      }
      return false;
...
var display = /* #__PURE__ */ CSS_Stylesheet.key(valDisplay)(
  /* #__PURE__ */ fromString("display")
);
...
var clear = /* #__PURE__ */ CSS_Stylesheet.key(valClearFloat)(
  /* #__PURE__ */ fromString("clear")
);
