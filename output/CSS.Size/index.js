...
var sizeToString = function (v) {
  ...
  if (v instanceof SumSize) {
    return Data_Exists.runExists(function (a$prime) {
      return Data_Exists.runExists(function (b$prime) {
        return (
          "(" +
          (sizeToString(a$prime) + (" + " + (sizeToString(b$prime) + ")")))
        );
      })(v.value1);
    })(v.value0);
  }
  ...
  throw new Error(
    "Failed pattern match at CSS.Size (line 29, column 1 - line 29, column 43): " +
      [v.constructor.name]
  );
};
var valSize = {
  value: function (v) {
    ...
    return append2(CSS_Common.browsers)(
      new CSS_Property.Plain("calc" + sizeToString(v))
    );
  }
};
var rem = function (i) {
