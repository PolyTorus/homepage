...
var pure = /* #__PURE__ */ Control_Applicative.pure(
  Routing_Duplex.applicativeRouteDuplex
);
var product = /* #__PURE__ */ Routing_Duplex_Generic.product(
  Routing_Duplex_Generic.gRouteAll
);
var gsepStringString = {
  gsep: function (a) {
    return function (b) {
      return Routing_Duplex.prefix(a)(
        Routing_Duplex.prefix(b)(pure(Data_Unit.unit))
      );
    };
  }
};
var gsepStringRoute = function (dictGRouteDuplexCtr) {
  var gRouteDuplexCtr =
    Routing_Duplex_Generic.gRouteDuplexCtr(dictGRouteDuplexCtr);
  return {
    gsep: function (a) {
