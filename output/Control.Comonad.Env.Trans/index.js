...
var traversableEnvT = function (dictTraversable) {
  ...
  return {
    sequence: function (dictApplicative) {
      ...
      return function (v) {
        return map1(map(EnvT)(Data_Tuple.Tuple.create(v.value0)))(
          sequence1(v.value1)
        );
      };
    },
...
var traversableWithIndexEnvT = function (dictTraversableWithIndex) {
  ...
  var functorWithIndexEnvT1 = functorWithIndexEnvT(
    dictTraversableWithIndex.FunctorWithIndex0()
  );
  var foldableWithIndexEnvT1 = foldableWithIndexEnvT(
    dictTraversableWithIndex.FoldableWithIndex1()
  );
  var traversableEnvT1 = traversableEnvT(
