...
var showRegexFlags = {
  show: function (v) {
    var usedFlags = append([])(
      append(voidLeft(guard(v.global))("global"))(
        append(voidLeft(guard(v.ignoreCase))("ignoreCase"))(
          append(voidLeft(guard(v.multiline))("multiline"))(
            append(voidLeft(guard(v.dotAll))("dotAll"))(
              append(voidLeft(guard(v.sticky))("sticky"))(
                voidLeft(guard(v.unicode))("unicode")
              )
            )
          )
        )
...
var eqRegexFlags = /* #__PURE__ */ Data_Eq.eqRec()(
