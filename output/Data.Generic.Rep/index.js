  ...
  return function (dictShow1) {
    ...
    return {
      show: function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.Generic.Rep (line 32, column 1 - line 34, column 42): " +
            [v.constructor.name]
        );
      }
    };
...
var showProduct = function (dictShow) {
  ...
  return function (dictShow1) {
    ...
    return {
      show: function (v) {
        return (
          "(Product " + (show1(v.value0) + (" " + (show2(v.value1) + ")")))
        );
      }
    };
  };
  ...
  return function (dictShow) {
    ...
    return {
      show: function (v) {
        return (
          "(Constructor @" +
          (show(reflectSymbol(Type_Proxy["Proxy"].value)) +
            (" " + (show1(v) + ")")))
        );
      }
    };
