...
var div = /* #__PURE__ */ Data_EuclideanRing.div(
  Data_EuclideanRing.euclideanRingInt
);
var mod = /* #__PURE__ */ Data_EuclideanRing.mod(
  Data_EuclideanRing.euclideanRingInt
);
...
var genericEnumSum = function (dictGenericEnum) {
  ...
  return function (dictGenericTop) {
    var genericTop$prime =
      Data_Bounded_Generic["genericTop$prime"](dictGenericTop);
    return function (dictGenericEnum1) {
      ...
      return function (dictGenericBottom) {
        var genericBottom$prime =
          Data_Bounded_Generic["genericBottom$prime"](dictGenericBottom);
        return {
          "genericPred'": function (v) {
            if (v instanceof Data_Generic_Rep.Inl) {
              return map(Data_Generic_Rep.Inl.create)(
                genericPred$prime1(v.value0)
              );
            }
            if (v instanceof Data_Generic_Rep.Inr) {
              ...
              if (v1 instanceof Data_Maybe.Nothing) {
                return new Data_Maybe.Just(
                  new Data_Generic_Rep.Inl(genericTop$prime)
                );
              }
              ...
              throw new Error(
                "Failed pattern match at Data.Enum.Generic (line 30, column 14 - line 32, column 31): " +
                  [v1.constructor.name]
              );
            }
            throw new Error(
              "Failed pattern match at Data.Enum.Generic (line 28, column 18 - line 32, column 31): " +
                [v.constructor.name]
            );
          },
          "genericSucc'": function (v) {
            if (v instanceof Data_Generic_Rep.Inl) {
              ...
              if (v1 instanceof Data_Maybe.Nothing) {
                return new Data_Maybe.Just(
                  new Data_Generic_Rep.Inr(genericBottom$prime)
                );
              }
              if (v1 instanceof Data_Maybe.Just) {
              ...
              throw new Error(
                "Failed pattern match at Data.Enum.Generic (line 34, column 14 - line 36, column 31): " +
                  [v1.constructor.name]
              );
            }
            if (v instanceof Data_Generic_Rep.Inr) {
              return map(Data_Generic_Rep.Inr.create)(
                genericSucc$prime2(v.value0)
              );
            }
            throw new Error(
              "Failed pattern match at Data.Enum.Generic (line 33, column 18 - line 37, column 36): " +
                [v.constructor.name]
            );
          }
        };
    ...
    return function (dictGenericBottom) {
      return function (dictGenericEnum1) {
        ...
        return function (dictGenericTop1) {
          var genericTop$prime =
            Data_Bounded_Generic["genericTop$prime"](dictGenericTop1);
          return function (dictGenericBottom1) {
            var genericBottom$prime =
              Data_Bounded_Generic["genericBottom$prime"](dictGenericBottom1);
            return {
              "genericPred'": function (v) {
                var v1 = genericPred$prime2(v.value1);
                if (v1 instanceof Data_Maybe.Just) {
                  return new Data_Maybe.Just(
                    new Data_Generic_Rep.Product(v.value0, v1.value0)
                  );
                }
                if (v1 instanceof Data_Maybe.Nothing) {
                  return map(
                    Data_Function.flip(Data_Generic_Rep.Product.create)(
                      genericTop$prime
                    )
                  )(genericPred$prime1(v.value0));
                }
                throw new Error(
                  "Failed pattern match at Data.Enum.Generic (line 40, column 32 - line 42, column 59): " +
                    [v1.constructor.name]
                );
              },
              "genericSucc'": function (v) {
                ...
                if (v1 instanceof Data_Maybe.Nothing) {
                  ...
                  )(genericSucc$prime1(v.value0));
                }
                throw new Error(
                  "Failed pattern match at Data.Enum.Generic (line 43, column 32 - line 45, column 62): " +
                    [v1.constructor.name]
                );
              }
            };
...
var genericBoundedEnumSum = function (dictGenericBoundedEnum) {
  var genericCardinality$prime1 = genericCardinality$prime(
  ...
  return function (dictGenericBoundedEnum1) {
    ...
    return {
      "genericCardinality'":
        (unwrap(genericCardinality$prime1) +
          unwrap(genericCardinality$prime(dictGenericBoundedEnum1))) |
        0,
      "genericToEnum'": function (n) {
        var to = function (v) {
          ...
          if (Data_Boolean.otherwise) {
            return map(Data_Generic_Rep.Inr.create)(
              genericToEnum$prime2((n - v) | 0)
            );
          }
          throw new Error(
            "Failed pattern match at Data.Enum.Generic (line 83, column 5 - line 83, column 43): " +
              [v.constructor.name]
          );
        };
      ...
      "genericFromEnum'": function (v) {
        ...
        if (v instanceof Data_Generic_Rep.Inr) {
          return (
            (genericFromEnum$prime2(v.value0) +
              unwrap(genericCardinality$prime1)) |
            0
          );
        }
        throw new Error(
          "Failed pattern match at Data.Enum.Generic (line 87, column 22 - line 89, column 80): " +
            [v.constructor.name]
        );
      }
    };
...
var genericBoundedEnumProduct = function (dictGenericBoundedEnum) {
  ...
  var genericFromEnum$prime1 = genericFromEnum$prime(dictGenericBoundedEnum);
  return function (dictGenericBoundedEnum1) {
    var genericCardinality$prime2 = genericCardinality$prime(
    ...
    return {
      "genericCardinality'":
        (unwrap(genericCardinality$prime1) *
          unwrap(genericCardinality$prime2)) |
        0,
      "genericToEnum'": function (n) {
        var to = function (v) {
          return apply(
            map(Data_Generic_Rep.Product.create)(
              genericToEnum$prime1(div(n)(v))
            )
          )(genericToEnum$prime2(mod(n)(v)));
        };
      ...
      "genericFromEnum'": (function () {
        var from = function (v) {
          return function (v1) {
            return (
              (((genericFromEnum$prime1(v1.value0) * v) | 0) +
                genericFromEnum$prime2(v1.value1)) |
              0
            );
          };
        };
...
var genericBoundedEnumConstructor = function (dictGenericBoundedEnum) {
  ...
  var genericFromEnum$prime1 = genericFromEnum$prime(dictGenericBoundedEnum);
  return {
    "genericCardinality'": unwrap(
      genericCardinality$prime(dictGenericBoundedEnum)
    ),
    "genericToEnum'": function (i) {
