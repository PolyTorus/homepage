...
var toEnum = /* #__PURE__ */ Data_Enum.toEnum(
  Data_Date_Component.boundedEnumWeekday
);
...
var fromEnum1 = /* #__PURE__ */ Data_Enum.fromEnum(
  Data_Date_Component.boundedEnumYear
);
...
var greaterThan = /* #__PURE__ */ Data_Ord.greaterThan(
  /* #__PURE__ */ Data_Maybe.ordMaybe(Data_Date_Component.ordDay)
);
...
var isLeapYear = function (y) {
  ...
  return (
    mod(y$prime)(4) === 0 &&
    (mod(y$prime)(400) === 0 || !(mod(y$prime)(100) === 0))
  );
};
var lastDayOfMonth = function (y) {
  return function (m) {
    ...
    throw new Error(
      "Failed pattern match at Data.Date (line 127, column 22 - line 141, column 27): " +
        [m.constructor.name]
    );
  };
};
var eqDate = {
  eq: function (x) {
    return function (y) {
      return (
        eq1(x.value0)(y.value0) &&
        eq2(x.value1)(y.value1) &&
        eq3(x.value2)(y.value2)
      );
    };
  }
};
...
var boundedDate = /* #__PURE__ */ (function () {
  return {
    bottom: new $$Date(
      Data_Bounded.bottom(Data_Date_Component.boundedYear),
      Data_Bounded.bottom(Data_Date_Component.boundedMonth),
      Data_Bounded.bottom(Data_Date_Component.boundedDay)
    ),
    top: new $$Date(
      Data_Bounded.top(Data_Date_Component.boundedYear),
      Data_Bounded.top(Data_Date_Component.boundedMonth),
      Data_Bounded.top(Data_Date_Component.boundedDay)
    ),
    Ord0: function () {
      return ordDate;
    }
  ...
  return function (date) {
    var adj = function (v1) {
      return function (v2) {
        ...
        var low = j < 1;
        var l = lastDayOfMonth(v2.value0)(
          (function () {
            if (low) {
              return Data_Maybe.fromMaybe(Data_Date_Component.December.value)(
                pred(v2.value1)
              );
            }
            return v2.value1;
        ...
        var i$prime = (function () {
          ...
          throw new Error(
            "Failed pattern match at Data.Date (line 101, column 9 - line 103, column 28): " +
              []
          );
        })();
        var dt$prime = (function () {
          if (low) {
            return bindFlipped(pred3)(
              map($$Date.create(v2.value0)(v2.value1))(toEnum1(1))
            );
          }
          if (hi) {
          ...
          throw new Error(
            "Failed pattern match at Data.Date (line 104, column 9 - line 106, column 48): " +
              []
          );
        })();
