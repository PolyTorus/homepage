...
var showReadyState = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Web.File.FileReader.ReadyState (line 28, column 1 - line 31, column 21): " +
        [v.constructor.name]
    );
  }
};
var fromEnumReadyState = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.File.FileReader.ReadyState (line 43, column 3 - line 46, column 14): " +
      [v.constructor.name]
  );
};
var eqReadyState = {
...
var ordReadyState = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.File.FileReader.ReadyState (line 0, column 0 - line 0, column 0): " +
