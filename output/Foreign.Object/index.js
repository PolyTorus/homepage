...
var forWithIndex_ = /* #__PURE__ */ Data_FoldableWithIndex.forWithIndex_(
  Control_Monad_ST_Internal.applicativeST
);
var for_ = /* #__PURE__ */ Data_Foldable.for_(
  Control_Monad_ST_Internal.applicativeST
);
...
var toAscArray = /* #__PURE__ */ toAscUnfoldable(
...
var singleton = function (k) {
  return function (v) {
    return $foreign.runST(
      bindFlipped(Foreign_Object_ST.poke(k)(v))(Foreign_Object_ST["new"])
    );
  };
};
...
var member = /* #__PURE__ */ Data_Function_Uncurried.runFn4(
  $foreign["_lookup"]
)(false)(/* #__PURE__ */ Data_Function["const"](true));
...
var lookup = /* #__PURE__ */ (function () {
  return Data_Function_Uncurried.runFn4($foreign["_lookup"])(
    ...
    return function (m2) {
      return mutate(function (s1) {
        return foldM1(function (s2) {
          return function (k) {
            return function (v1) {
              return Foreign_Object_ST.poke(k)(
                $foreign["_lookup"](
                  v1,
                  function (v2) {
                    return f(v1)(v2);
...
var foldableWithIndexObject = {
  ...
  foldrWithIndex: function (f) {
    return function (z) {
      return function (m) {
        return foldr(Data_Tuple.uncurry(f))(z)(
          $foreign.toArrayWithKey(Data_Tuple.Tuple.create)(m)
        );
      };
    };
  },
...
var traversableObject = {
  traverse: function (dictApplicative) {
    var $96 = Data_TraversableWithIndex.traverseWithIndex(
  ...
  sequence: function (dictApplicative) {
    return Data_Traversable.traverse(traversableObject)(dictApplicative)(
      identity
    );
  },
  Functor0: function () {
...
var alter = function (f) {
  return function (k) {
    return function (m) {
      ...
      throw new Error(
        "Failed pattern match at Foreign.Object (line 210, column 15 - line 212, column 25): " +
          [v.constructor.name]
      );
    };
  };
...
export { empty, size, keys, all, runST, toArrayWithKey } from "./foreign.js";
export {
  isEmpty,
  singleton,
  insert,
