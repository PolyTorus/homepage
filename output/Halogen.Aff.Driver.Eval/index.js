...
var lookup = /* #__PURE__ */ Data_Map_Internal.lookup(
  Halogen_Query_HalogenM.ordSubscriptionId
);
var bind1 = /* #__PURE__ */ Control_Bind.bind(Effect_Aff.bindAff);
var liftEffect = /* #__PURE__ */ Effect_Class.liftEffect(
  Effect_Aff.monadEffectAff
);
var discard = /* #__PURE__ */ Control_Bind.discard(Control_Bind.discardUnit);
var discard1 = /* #__PURE__ */ discard(Effect_Aff.bindAff);
var traverse_1 = /* #__PURE__ */ Data_Foldable.traverse_(
  Effect_Aff.applicativeAff
);
var traverse_2 = /* #__PURE__ */ traverse_1(Data_List_Types.foldableList);
var fork = /* #__PURE__ */ Control_Monad_Fork_Class.fork(
  Control_Monad_Fork_Class.monadForkAff
);
var parSequence_ = /* #__PURE__ */ Control_Parallel.parSequence_(
  Effect_Aff.parallelAff
)(Effect_Aff.applicativeParAff)(Data_List_Types.foldableList);
var pure = /* #__PURE__ */ Control_Applicative.pure(Effect_Aff.applicativeAff);
var map = /* #__PURE__ */ Data_Functor.map(Data_Coyoneda.functorCoyoneda);
var parallel = /* #__PURE__ */ Control_Parallel_Class.parallel(
  Effect_Aff.parallelAff
);
var map1 = /* #__PURE__ */ Data_Functor.map(Effect_Aff.functorAff);
var sequential = /* #__PURE__ */ Control_Parallel_Class.sequential(
  Effect_Aff.parallelAff
);
var map2 = /* #__PURE__ */ Data_Functor.map(Data_Maybe.functorMaybe);
var insert = /* #__PURE__ */ Data_Map_Internal.insert(
  Halogen_Query_HalogenM.ordSubscriptionId
);
var retractFreeAp = /* #__PURE__ */ Control_Applicative_Free.retractFreeAp(
  Effect_Aff.applicativeParAff
);
var $$delete = /* #__PURE__ */ Data_Map_Internal["delete"](
  Halogen_Query_HalogenM.ordForkId
);
var unlessM = /* #__PURE__ */ Control_Monad.unlessM(Effect.monadEffect);
var insert1 = /* #__PURE__ */ Data_Map_Internal.insert(
  Halogen_Query_HalogenM.ordForkId
);
var traverse_3 = /* #__PURE__ */ traverse_1(Data_Foldable.foldableMaybe);
var lookup1 = /* #__PURE__ */ Data_Map_Internal.lookup(
  Halogen_Query_HalogenM.ordForkId
);
var lookup2 = /* #__PURE__ */ Data_Map_Internal.lookup(Data_Ord.ordString);
var foldFree = /* #__PURE__ */ Control_Monad_Free.foldFree(
  Effect_Aff.monadRecAff
);
...
var unsubscribe = function (sid) {
  return function (ref) {
    return function __do() {
      ...
      return traverse_(Halogen_Subscription.unsubscribe)(
        bindFlipped(lookup(sid))(subs)
      )();
    };
  };
};
  ...
  return function (au) {
    return bind1(liftEffect(Effect_Ref.read(ref)))(function (v) {
      ...
      if (v instanceof Data_Maybe.Just) {
        return liftEffect(
          Effect_Ref.write(
            new Data_Maybe.Just(new Data_List_Types.Cons(au, v.value0))
          )(ref)
        );
      }
      throw new Error(
...
var handleAff = /* #__PURE__ */ Effect_Aff.runAff_(
  /* #__PURE__ */ Data_Either.either(Effect_Exception.throwException)(
    /* #__PURE__ */ Data_Function["const"](
      /* #__PURE__ */ Control_Applicative.pure(Effect.applicativeEffect)(
        Data_Unit.unit
      )
    )
  )
...
var fresh = function (f) {
  return function (ref) {
    return bind1(liftEffect(Effect_Ref.read(ref)))(function (v) {
      return liftEffect(
        Effect_Ref["modify$prime"](function (i) {
          return {
            state: (i + 1) | 0,
            value: f(i)
          };
...
var evalQ = function (render) {
  return function (ref) {
    return function (q) {
      return bind1(liftEffect(Effect_Ref.read(ref)))(function (v) {
        return evalM(render)(ref)(
          v["component"]["eval"](
            new Halogen_Query_HalogenQ.Query(
              map(Data_Maybe.Just.create)(Data_Coyoneda.liftCoyoneda(q)),
          ...
          return bind1(liftEffect(Effect_Ref.read(ref)))(function (v1) {
            return Halogen_Query_ChildQuery.unChildQueryBox(function (v2) {
              var evalChild = function (v3) {
                return parallel(
                  bind1(liftEffect(Effect_Ref.read(v3)))(function (dsx) {
                    return Halogen_Aff_Driver_State.unDriverStateX(
                      function (ds) {
              ...
              return map1(v2.value2)(
                sequential(
                  v2.value0(Effect_Aff.applicativeParAff)(evalChild)(
                    v1.children
                  )
                )
              );
      ...
      var go = function (ref) {
        return function (v1) {
                ...
                return discard1(
                  ...
                  return discard1(
                    handleLifecycle(v2.lifecycleHandlers)(
                      render(v2.lifecycleHandlers)(ref)
                    )
                  )(function () {
                    return pure(v3.value0);
                  });
          ...
          if (v1 instanceof Halogen_Query_HalogenM.Subscribe) {
            return bind1(fresh(Halogen_Query_HalogenM.SubscriptionId)(ref))(
              function (sid) {
                return bind1(
                  liftEffect(
                    Halogen_Subscription.subscribe(v1.value0(sid))(
                      function (act) {
                        return handleAff(
                          evalF(render)(ref)(
                            new Halogen_Query_Input.Action(act)
                          )
                        );
                      }
                    )
                  ...
                  return bind1(liftEffect(Effect_Ref.read(ref)))(function (v2) {
                    return discard1(
                      liftEffect(
                        Effect_Ref.modify_(map2(insert(sid)(finalize)))(
                          v2.subscriptions
                        )
                      )
                    )(function () {
          ...
          if (v1 instanceof Halogen_Query_HalogenM.Unsubscribe) {
            return discard1(liftEffect(unsubscribe(v1.value0)(ref)))(
              function () {
          ...
          if (v1 instanceof Halogen_Query_HalogenM.Raise) {
            return bind1(liftEffect(Effect_Ref.read(ref)))(function (v2) {
              return bind1(liftEffect(Effect_Ref.read(v2.handlerRef)))(
                function (handler) {
                  return discard1(
                    queueOrRun(v2.pendingOuts)(handler(v1.value0))
                  )(function () {
                    return pure(v1.value1);
                  });
                }
          ...
          if (v1 instanceof Halogen_Query_HalogenM.Fork) {
            return bind1(fresh(Halogen_Query_HalogenM.ForkId)(ref))(
              function (fid) {
                return bind1(liftEffect(Effect_Ref.read(ref)))(function (v2) {
                  return bind1(liftEffect(Effect_Ref["new"](false)))(
                    function (doneRef) {
                      return bind1(
                        fork(
                          Effect_Aff["finally"](
                            liftEffect(function __do() {
                              Effect_Ref.modify_($$delete(fid))(v2.forks)();
                              return Effect_Ref.write(true)(doneRef)();
                            })
                          )(evalM(render)(ref)(v1.value0))
                        )
                      )(function (fiber) {
                        return discard1(
                          liftEffect(
                            unlessM(Effect_Ref.read(doneRef))(
                              Effect_Ref.modify_(insert1(fid)(fiber))(v2.forks)
                            )
                          )
                        )(function () {
          ...
          if (v1 instanceof Halogen_Query_HalogenM.Join) {
            return bind1(liftEffect(Effect_Ref.read(ref)))(function (v2) {
              return bind1(liftEffect(Effect_Ref.read(v2.forks)))(
                function (forkMap) {
                  return discard1(
                    traverse_3(Effect_Aff.joinFiber)(
            ...
            return bind1(liftEffect(Effect_Ref.read(ref)))(function (v2) {
              return bind1(liftEffect(Effect_Ref.read(v2.forks)))(
                function (forkMap) {
                  return discard1(
                    traverse_3(
                      Effect_Aff.killFiber(Effect_Exception.error("Cancelled"))
                    )(lookup1(v1.value0)(forkMap))
                  )(function () {
                    return pure(v1.value1);
                  });
  ...
  return function (ref) {
    return function (v) {
      if (v instanceof Halogen_Query_Input.RefUpdate) {
        return liftEffect(
          Data_Function.flip(Effect_Ref.modify_)(ref)(
            Halogen_Aff_Driver_State.mapDriverState(function (st) {
              return {
      ...
      if (v instanceof Halogen_Query_Input.Action) {
        return bind1(liftEffect(Effect_Ref.read(ref)))(function (v1) {
          return evalM(render)(ref)(
            v1["component"]["eval"](
              new Halogen_Query_HalogenQ.Action(v.value0, Data_Unit.unit)
            )
          );
        });
      }
...
export { evalF, evalQ, evalM, handleLifecycle, queueOrRun, handleAff };
