...
var boundedRecord = function () {
  return function (dictBoundedRecord) {
    ...
    return {
      top: topRecord(dictBoundedRecord)(Type_Proxy["Proxy"].value)(
        Type_Proxy["Proxy"].value
      ),
      bottom: bottomRecord(dictBoundedRecord)(Type_Proxy["Proxy"].value)(
        Type_Proxy["Proxy"].value
      ),
      Ord0: function () {
        return ordRecord1;
    ...
    return function () {
      return function () {
        return function (dictBoundedRecord) {
          ...
          var ordRecordCons = Data_Ord.ordRecordCons(
            dictBoundedRecord.OrdRecord0()
          )()(dictIsSymbol)(Ord0);
          return {
            topRecord: function (v) {
...
export { EQ, GT, LT, compare } from "../Data.Ord/index.js";
