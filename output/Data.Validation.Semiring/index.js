...
var validation = function (v) {
  return function (v1) {
    return function (v2) {
      ...
      throw new Error(
        "Failed pattern match at Data.Validation.Semiring (line 49, column 1 - line 49, column 84): " +
  ...
  return function (dictShow1) {
    ...
    return {
      show: function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.Validation.Semiring (line 82, column 10 - line 84, column 55): " +
            [v.constructor.name]
        );
      }
    };
  ...
  return {
    apply: function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Validation.Semiring (line 90, column 1 - line 94, column 54): " +
  ...
  return {
    alt: function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Validation.Semiring (line 105, column 1 - line 108, column 36): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    },
