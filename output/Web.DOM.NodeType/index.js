...
var showNodeType = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Web.DOM.NodeType (line 39, column 1 - line 51, column 37): " +
        [v.constructor.name]
    );
  }
};
var fromEnumNodeType = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.DOM.NodeType (line 68, column 1 - line 68, column 36): " +
      [v.constructor.name]
  );
};
var eqNodeType = {
  eq: function (x) {
    return function (y) {
      ...
      if (
        x instanceof EntityReferenceNode &&
        y instanceof EntityReferenceNode
      ) {
        return true;
      }
      ...
      if (
        x instanceof ProcessingInstructionNode &&
        y instanceof ProcessingInstructionNode
      ) {
        return true;
      }
      ...
      if (
        x instanceof DocumentFragmentNode &&
        y instanceof DocumentFragmentNode
      ) {
        return true;
      }
