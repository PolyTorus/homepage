      ...
      if (v instanceof CatCons) {
        return (
          ...
          (show(v.value0) +
            (" " +
              (Data_Show.show(
                Data_CatQueue.showCatQueue(showCatList(dictShow))
              )(v.value1) +
                ")")))
        );
      }
      throw new Error(
        "Failed pattern match at Data.CatList (line 147, column 1 - line 149, column 71): " +
          [v.constructor.name]
      );
    }
  };
    ...
    var go = function ($copy_acc) {
      return function ($copy_q) {
        ...
        function $tco_loop(acc, q) {
          ...
          throw new Error(
            "Failed pattern match at Data.CatList (line 156, column 16 - line 158, column 22): " +
              [v.constructor.name]
          );
        }
        while (!$tco_done) {
...
var length = /* #__PURE__ */ Data_Foldable.length(foldableCatList)(
...
var foldMap = function (dictMonoid) {
  ...
  return function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.CatList (line 134, column 1 - line 134, column 62): " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  };
...
var functorCatList = {
  map: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.CatList (line 184, column 1 - line 188, column 26): " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  }
    ...
    return function (v) {
      return function (v1) {
        ...
        if (v1 instanceof CatCons) {
          ...
          return apply(map(cons)(v(v1.value0)))(
            Data_Traversable.traverse(traversableCatList)(dictApplicative)(v)(d)
          );
        }
        throw new Error(
          "Failed pattern match at Data.CatList (line 174, column 1 - line 182, column 33): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    };
  ...
  sequence: function (dictApplicative) {
    ...
    return function (v) {
      ...
      if (v instanceof CatCons) {
        ...
        return apply(map(cons)(v.value0))(
          Data_Traversable.sequence(traversableCatList)(dictApplicative)(d)
        );
      }
      throw new Error(
        "Failed pattern match at Data.CatList (line 174, column 1 - line 182, column 33): " +
...
var bindCatList = {
  bind: /* #__PURE__ */ Data_Function.flip(
    /* #__PURE__ */ foldMap(monoidCatList)
  ),
  Apply0: function () {
...
var $lazy_applyCatList = /* #__PURE__ */ $runtime_lazy(
  "applyCatList",
  "Data.CatList",
  function () {
    return {
      ...
      var go = function ($copy_source) {
        return function ($copy_memo) {
          ...
          function $tco_loop(source, memo) {
            ...
            throw new Error(
              "Failed pattern match at Data.CatList (line 170, column 24 - line 172, column 57): " +
                [v.constructor.name]
            );
          }
          while (!$tco_done) {
      ...
      var go = function ($copy_source) {
        return function ($copy_memo) {
          ...
          function $tco_loop(source, memo) {
            ...
            throw new Error(
              "Failed pattern match at Data.CatList (line 163, column 24 - line 165, column 57): " +
                [v.constructor.name]
            );
          }
          while (!$tco_done) {
