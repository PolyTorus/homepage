    ...
    return function (userMessage) {
      return function (v) {
        ...
        var message =
          ...
          ("Expected: " +
            (show(v.expected) + ("\x0aActual:   " + show(v.actual))));
...
var assertEqual$prime1 = /* #__PURE__ */ assertEqual$prime(Data_Eq.eqBoolean)(
...
var assertEqual1 = /* #__PURE__ */ assertEqual(Data_Eq.eqBoolean)(
  Data_Show.showBoolean
);
...
var assertThrows = /* #__PURE__ */ assertThrows$prime(
