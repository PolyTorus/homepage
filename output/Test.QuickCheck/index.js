...
var append1 = /* #__PURE__ */ Data_Semigroup.append(
  Data_Maybe_First.semigroupFirst
);
...
var withHelp = function (v) {
  return function (v1) {
    ...
    throw new Error(
      "Failed pattern match at Test.QuickCheck (line 248, column 1 - line 248, column 40): " +
...
var testableBoolean = {
  test: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Test.QuickCheck (line 224, column 1 - line 226, column 51): " +
        [v.constructor.name]
    );
  }
};
...
var showResult = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Test.QuickCheck (line 237, column 1 - line 239, column 40): " +
        [v.constructor.name]
    );
  }
};
    ...
    return function (n) {
      return function (prop) {
          ...
          if (Data_Boolean.otherwise) {
            ...
            if (v1.value0 instanceof Failed) {
              return new Control_Monad_Rec_Class.Loop({
                ...
                firstFailure: append1(v.firstFailure)(
                  new Data_Maybe.Just({
                    index: v.index,
            ...
            throw new Error(
              "Failed pattern match at Test.QuickCheck (line 118, column 9 - line 133, column 16): " +
                [v1.constructor.name]
            );
          }
          throw new Error(
            "Failed pattern match at Test.QuickCheck (line 114, column 3 - line 114, column 48): " +
              [v.constructor.name]
          );
        };
        ...
        return function __do() {
          Effect_Console.log(
            show(result.successes) + ("/" + (show(n) + " test(s) passed."))
          )();
          return for_(result.firstFailure)(function (v) {
            return Effect_Exception.throwException(
              Effect_Exception.error(
                "Test " +
                  (show((v.index + 1) | 0) +
                    (" (seed " +
                      (show(Random_LCG.unSeed(v.seed)) +
                        (") failed: \x0a" + v.message))))
              )
            );
          })();
        };
        ...
        var loop = function (v) {
          ...
          if (Data_Boolean.otherwise) {
            ...
            return new Control_Monad_Rec_Class.Loop({
              seed: v1.value1.newSeed,
              index: (v.index + 1) | 0,
              results: new Data_List_Types.Cons(
                new Data_Tuple.Tuple(v.seed, v1.value0),
                v.results
              )
            });
          }
          throw new Error(
            "Failed pattern match at Test.QuickCheck (line 161, column 5 - line 161, column 75): " +
              [v.constructor.name]
          );
        };
  ...
  var go = function (index) {
    return function (st) {
      return function (v) {
        ...
        throw new Error(
          "Failed pattern match at Test.QuickCheck (line 200, column 7 - line 204, column 97): " +
            [v.value1.constructor.name]
        );
      };
    };
  };
  return Data_FoldableWithIndex.foldlWithIndex(
    Data_List_Types.foldableWithIndexList
  )(go)({
    total: 0,
    successes: 0,
...
export { mkSeed, randomSeed, unSeed } from "../Random.LCG/index.js";
export { arbitrary, coarbitrary } from "../Test.QuickCheck.Arbitrary/index.js";
