...
var toPromise = function () {
  return function (v) {
    return bindFlipped(
      Effect_Uncurried.runEffectFn2(Promise_Internal.then_)(function (v1) {
...
var fromPromise = function (p) {
  return bindFlipped(
    Effect_Uncurried.runEffectFn2(Promise_Internal.then_)(function ($43) {
...
var $lazy_functorLazyPromise = /* #__PURE__ */ $runtime_lazy(
  "functorLazyPromise",
  "Promise.Lazy",
  function () {
    return {
...
var $lazy_applyLazyPromise = /* #__PURE__ */ $runtime_lazy(
  "applyLazyPromise",
  "Promise.Lazy",
  function () {
    return {
