...
var unsafeEqThunk = function (v, v1) {
  return (
    Halogen_VDom_Util.refEq(v.value0, v1.value0) &&
    Halogen_VDom_Util.refEq(v.value1, v1.value1) &&
...
var thunk2 = /* #__PURE__ */ (function () {
  var eqFn = function (a, b) {
    return (
      Halogen_VDom_Util.refEq(a["_1"], b["_1"]) &&
      Halogen_VDom_Util.refEq(a["_2"], b["_2"])
    );
  };
...
var thunk3 = /* #__PURE__ */ (function () {
  var eqFn = function (a, b) {
    return (
      Halogen_VDom_Util.refEq(a["_1"], b["_1"]) &&
      Halogen_VDom_Util.refEq(a["_2"], b["_2"]) &&
      Halogen_VDom_Util.refEq(a["_3"], b["_3"])
    );
  };
...
var buildThunk = function (toVDom) {
  ...
  var $lazy_patchThunk = $runtime_lazy(
    "patchThunk",
    "Halogen.VDom.Thunk",
    function () {
      return function (state, t2) {
        ...
        if ($48) {
          return Halogen_VDom_Machine.mkStep(
            new Halogen_VDom_Machine.Step(
              Halogen_VDom_Machine.extract(state.vdom),
              state,
              $lazy_patchThunk(112),
              haltThunk
            )
        ...
        return Halogen_VDom_Machine.mkStep(
          new Halogen_VDom_Machine.Step(
            Halogen_VDom_Machine.extract(vdom),
            {
              vdom: vdom,
              thunk: t2
            },
