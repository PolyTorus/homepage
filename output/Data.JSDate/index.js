...
var toInstant = /* #__PURE__ */ (function () {
  return Control_Bind.composeKleisliFlipped(Data_Maybe.bindMaybe)(
    function ($21) {
      return Data_DateTime_Instant.instant(
        Data_Time_Duration.Milliseconds($21)
      );
    }
...
var toDateTime = /* #__PURE__ */ map(
  /* #__PURE__ */ map1(Data_DateTime_Instant.toDateTime)
)(toInstant);
var toDateString = function (dt) {
  return $foreign.dateMethod("toDateString", dt);
};
var toDate = /* #__PURE__ */ map(/* #__PURE__ */ map1(Data_DateTime.date))(
  toDateTime
);
var readDate = /* #__PURE__ */ Foreign.unsafeReadTagged(
