...
var quickCheck$prime = /* #__PURE__ */ Test_QuickCheck["quickCheck$prime"](
  /* #__PURE__ */ Test_QuickCheck.testableGen(Test_QuickCheck.testableBoolean)
);
var map = /* #__PURE__ */ Data_Functor.map(Test_QuickCheck_Gen.functorGen);
var arbFunction = /* #__PURE__ */ Test_QuickCheck_Arbitrary.arbFunction(
  Test_QuickCheck_Laws.coarbitraryB
)(Test_QuickCheck_Laws.arbitraryA);
var arbFunction1 = /* #__PURE__ */ Test_QuickCheck_Arbitrary.arbFunction(
  Test_QuickCheck_Laws.coarbitraryA
)(Test_QuickCheck_Laws.arbitraryB);
var checkFunctorWithIndexGen = function (dictFunctorWithIndex) {
  ...
  return function (dictCoarbitrary) {
    ...
    var quickCheck$prime1 = Test_QuickCheck["quickCheck$prime"](
      Test_QuickCheck.testableGen(
        Test_QuickCheck.testableFunction(arbFunction2(arbFunction))(
          Test_QuickCheck.testableFunction(arbFunction2(arbFunction1))(
    ...
    return function (dictEq) {
      ...
      return function (gen) {
        ...
        var composition = function (fa) {
          return function (f) {
            return function (g) {
              return eq(mapWithIndex(f)(mapWithIndex(g)(fa)))(
        ...
        return function __do() {
          ...
          Effect_Console.log(
            "Checking 'Composition' law for FunctorWithIndex"
          )();
...
var checkFunctorWithIndex = function (dictFunctorWithIndex) {
  var checkFunctorWithIndexGen1 =
    checkFunctorWithIndexGen(dictFunctorWithIndex);
  return function (dictArbitrary) {
    var arbitrary = Test_QuickCheck_Arbitrary.arbitrary(dictArbitrary);
    return function (dictCoarbitrary) {
      var checkFunctorWithIndexGen2 =
        checkFunctorWithIndexGen1(dictCoarbitrary);
      return function (dictEq) {
...
export { checkFunctorWithIndex, checkFunctorWithIndexGen };
