...
var show = /* #__PURE__ */ Data_Show.show(
  Data_String_NonEmpty_Internal.showNonEmptyString
);
var eq = /* #__PURE__ */ Data_Eq.eq(
  Data_String_NonEmpty_Internal.eqNonEmptyString
);
var compare = /* #__PURE__ */ Data_Ord.compare(
  Data_String_NonEmpty_Internal.ordNonEmptyString
);
...
var eqCaseInsensitiveNonEmptyString = {
  eq: function (v) {
    return function (v1) {
      return eq(Data_String_NonEmpty_Internal.toLower(v))(
        Data_String_NonEmpty_Internal.toLower(v1)
      );
    };
  }
};
var ordCaseInsensitiveNonEmptyString = {
  compare: function (v) {
    return function (v1) {
      return compare(Data_String_NonEmpty_Internal.toLower(v))(
        Data_String_NonEmpty_Internal.toLower(v1)
      );
    };
  },
