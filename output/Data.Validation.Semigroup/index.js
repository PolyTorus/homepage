...
var validation = function (v) {
  return function (v1) {
    return function (v2) {
      ...
      throw new Error(
        "Failed pattern match at Data.Validation.Semigroup (line 48, column 1 - line 48, column 84): " +
  ...
  return function (dictShow1) {
    ...
    return {
      show: function (v) {
        ...
        throw new Error(
          "Failed pattern match at Data.Validation.Semigroup (line 81, column 10 - line 83, column 55): " +
            [v.constructor.name]
        );
      }
    };
  ...
  return {
    apply: function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Validation.Semigroup (line 89, column 1 - line 93, column 54): " +
