...
var showVisibilityState = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Web.HTML.HTMLDocument.VisibilityState (line 15, column 10 - line 17, column 23): " +
        [v.constructor.name]
    );
  }
};
var print = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.HTML.HTMLDocument.VisibilityState (line 20, column 9 - line 22, column 21): " +
      [v.constructor.name]
  );
};
...
var ordVisibilityState = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.HTML.HTMLDocument.VisibilityState (line 0, column 0 - line 0, column 0): " +
