...
var semiringRecord = function () {
  return function (dictSemiringRecord) {
    return {
      ...
      one: oneRecord(dictSemiringRecord)(Type_Proxy["Proxy"].value)(
        Type_Proxy["Proxy"].value
      ),
      zero: zeroRecord(dictSemiringRecord)(Type_Proxy["Proxy"].value)(
        Type_Proxy["Proxy"].value
      )
    };
  };
    ...
    return function (dictSemiringRecord) {
      ...
      return function (dictSemiring) {
        ...
        return {
          ...
          oneRecord: function (v) {
            return function (v1) {
              var tail = oneRecord1(Type_Proxy["Proxy"].value)(
                Type_Proxy["Proxy"].value
              );
              var key = reflectSymbol(Type_Proxy["Proxy"].value);
              var insert = Record_Unsafe.unsafeSet(key);
          ...
          zeroRecord: function (v) {
            return function (v1) {
              var tail = zeroRecord1(Type_Proxy["Proxy"].value)(
                Type_Proxy["Proxy"].value
              );
              var key = reflectSymbol(Type_Proxy["Proxy"].value);
              var insert = Record_Unsafe.unsafeSet(key);
