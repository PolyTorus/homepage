...
var showParity = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Int (line 117, column 1 - line 119, column 19): " +
        [v.constructor.name]
    );
  }
};
var radix = function (n) {
  ...
  throw new Error(
    "Failed pattern match at Data.Int (line 198, column 1 - line 198, column 28): " +
      [n.constructor.name]
  );
};
var odd = function (x) {
...
var fromStringAs = /* #__PURE__ */ (function () {
  return $foreign.fromStringAsImpl(Data_Maybe.Just.create)(
    Data_Maybe.Nothing.value
  );
})();
var fromString = /* #__PURE__ */ fromStringAs(10);
var fromNumber = /* #__PURE__ */ (function () {
  return $foreign.fromNumberImpl(Data_Maybe.Just.create)(
    Data_Maybe.Nothing.value
  );
})();
var unsafeClamp = function (x) {
  ...
  throw new Error(
    "Failed pattern match at Data.Int (line 72, column 1 - line 72, column 29): " +
      [x.constructor.name]
  );
};
...
var ordParity = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Data.Int (line 0, column 0 - line 0, column 0): " +
...
var euclideanRingParity = {
  degree: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Int (line 137, column 1 - line 141, column 17): " +
        [v.constructor.name]
    );
  },
  div: function (x) {
...
var binary = 2;
var base36 = 36;
export { toNumber, toStringAs, quot, rem, pow } from "./foreign.js";
export {
  fromNumber,
  ceil,
  floor,
