...
var mapFlipped = /* #__PURE__ */ Data_Functor.mapFlipped(
  Data_List_Types.functorList
);
...
var cssColorStopsRGB = function (v) {
  if (v.value1 instanceof Data_List_Types.Nil) {
    return (
      Color.cssStringHSLA(v.value0) + (", " + Color.cssStringHSLA(v.value2))
    );
  }
  ...
  return (
    Color.cssStringHSLA(v.value0) +
    (", " +
      (intercalate(", ")(map(toString)(v.value1)) +
        (", " + Color.cssStringHSLA(v.value2))))
  );
};
  ...
  return function (at) {
    return function (v) {
      return function (v1) {
        ...
        var midStops = new Data_List_Types.Cons(
          colorStop(v.value2)(at - epsilon),
          new Data_List_Types.Cons(
            colorStop(v1.value0)(at),
            Data_List_Types.Nil.value
          )
        );
        var endStops = mapFlipped(v1.value1)(function (stop) {
          return colorStop(stopColor(stop))(
            at + stopRatio(stop) / (1.0 / (1.0 - at))
          );
        });
        return new ColorStops(
          v.value0,
          append1(startStops)(append1(midStops)(endStops)),
          v1.value2
        );
      };
    };
  ...
  return function (v) {
    return function (x) {
      ...
      if (Data_Boolean.otherwise) {
              ...
              function $tco_loop(v1, v2, v3) {
                ...
                if (v3 instanceof Data_List_Types.Cons) {
                  ...
                  if ($100) {
                    ...
                    $tco_done = true;
                    return interpolate(v1)(v3.value0.value0)(
                      (x - v2) / (v3.value0.value1 - v2)
                    );
                  }
                ...
                throw new Error(
                  "Failed pattern match at Color.Scale (line 170, column 7 - line 170, column 25): " +
                    [
                      v1.constructor.name,
                      v2.constructor.name,
                      v3.constructor.name
        ...
        return go(v.value0)(0.0)(
          Data_List.snoc(v.value1)(colorStop(v.value2)(1.0))
        );
      }
      throw new Error(
        "Failed pattern match at Color.Scale (line 164, column 1 - line 164, column 65): " +
          [interpolate.constructor.name, v.constructor.name, x.constructor.name]
      );
    };
  };
};
var cubehelixSample = /* #__PURE__ */ mkSimpleSampler(
  /* #__PURE__ */ Color.mixCubehelix(1.0)
);
...
var yellowToRed = /* #__PURE__ */ (function () {
  ...
  return uniformScale1(Color.Lab.value)(yellow)(
    new Data_List_Types.Cons(orange, Data_List_Types.Nil.value)
  )(red);
})();
...
var cool = /* #__PURE__ */ (function () {
  return colorScale(Color.RGB.value)(Color.hsl(180.0)(1.0)(0.6))(
    Data_List_Types.Nil.value
  )(Color.hsl(300.0)(1.0)(0.5));
})();
var grayscale = /* #__PURE__ */ (function () {
  return colorScale(Color.RGB.value)(Color.black)(Data_List_Types.Nil.value)(
    Color.white
  );
})();
var hot = /* #__PURE__ */ (function () {
  return colorScale(Color.RGB.value)(Color.black)(
    new Data_List_Types.Cons(
      colorStop(Color.fromInt(16711680))(0.5),
      new Data_List_Types.Cons(
        colorStop(Color.fromInt(16776960))(0.75),
        Data_List_Types.Nil.value
      )
    )
  )(Color.white);
...
var blueToRed = /* #__PURE__ */ (function () {
  ...
  return uniformScale1(Color.Lab.value)(blue)(
    new Data_List_Types.Cons(gray, Data_List_Types.Nil.value)
  )(red);
})();
var addStop$prime = function (v) {
  return function (c) {
    return function (r) {
      ...
      return new ColorStops(
        v.value0,
        Data_List.insertBy(comparing(stopRatio))(stop)(v.value1),
        v.value2
      );
    };
  };
...
var cssColorStops = function (v) {
  ...
  return cssColorStopsRGB(
    minColorStops(10)(mkSimpleSampler(Color.mix(v.value0)))(v.value1)
  );
};
var cubehelix = /* #__PURE__ */ (function () {
  ...
  return new ColorScale(
    Color.HSL.value,
    minColorStops(100)(gen)(new ColorStops(b, Data_List_Types.Nil.value, e))
  );
})();
