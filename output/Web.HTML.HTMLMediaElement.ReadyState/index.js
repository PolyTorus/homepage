...
var showReadyState = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Web.HTML.HTMLMediaElement.ReadyState (line 31, column 1 - line 36, column 41): " +
        [v.constructor.name]
    );
  }
};
var fromEnumReadyState = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.HTML.HTMLMediaElement.ReadyState (line 50, column 3 - line 55, column 24): " +
      [v.constructor.name]
  );
};
var eqReadyState = {
...
var ordReadyState = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.HTML.HTMLMediaElement.ReadyState (line 0, column 0 - line 0, column 0): " +
