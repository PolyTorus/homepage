...
var value = /* #__PURE__ */ CSS_Property.value(
  /* #__PURE__ */ CSS_Property.valList(CSS_Property.valValue)
);
var show = /* #__PURE__ */ Data_Show.show(Data_Show.showInt);
var value1 = /* #__PURE__ */ CSS_Property.value(
  /* #__PURE__ */ CSS_Property.valList(CSS_Property.valNumber)
);
...
var key2 = /* #__PURE__ */ CSS_Stylesheet.key(
  /* #__PURE__ */ CSS_Property.valList(CSS_Property.valString)
);
var append1 = /* #__PURE__ */ Data_Semigroup.append(
  CSS_Property.semigroupPrefixed
);
var fromString2 = /* #__PURE__ */ CSS_String.fromString(
  CSS_Property.isStringPrefixed
);
...
var valTimingStepsValue = {
  value: function (v) {
    ...
    throw new Error(
      "Failed pattern match at CSS.Transition (line 16, column 1 - line 18, column 31): " +
        [v.constructor.name]
    );
  }
};
...
var valTimingFunction = {
  value: function (v) {
    ...
    if (v instanceof Steps) {
      return append(fromString("steps("))(
        append(value([fromString(show(v.value0)), value2(v.value1)]))(
          fromString(")")
        )
      );
    }
    if (v instanceof CubicBezier) {
      return append(fromString("cubic-bezier("))(
        append(value1([v.value0, v.value1, v.value2, v.value3]))(
          fromString(")")
        )
      );
    }
    throw new Error(
      "Failed pattern match at CSS.Transition (line 34, column 1 - line 43, column 101): " +
        [v.constructor.name]
    );
  }
};
var key3 = /* #__PURE__ */ CSS_Stylesheet.key(
  /* #__PURE__ */ CSS_Property.valList(valTimingFunction)
);
var prefixed = /* #__PURE__ */ CSS_Stylesheet.prefixed(
  /* #__PURE__ */ CSS_Property.valTuple(CSS_Property.valString)(
    /* #__PURE__ */ CSS_Property.valTuple(CSS_Time.valTime)(
      /* #__PURE__ */ CSS_Property.valTuple(valTimingFunction)(CSS_Time.valTime)
    )
  )
);
...
var transitionTimingFunction = /* #__PURE__ */ CSS_Stylesheet.key(
  valTimingFunction
)(/* #__PURE__ */ fromString1("transition-timing-function"));
var transitionProperty = /* #__PURE__ */ key1(
  /* #__PURE__ */ fromString1("transition-property")
);
...
var transitionDuration = /* #__PURE__ */ key1(
  /* #__PURE__ */ fromString1("transition-duration")
);
var transitionDelays = /* #__PURE__ */ CSS_Stylesheet.key(
  /* #__PURE__ */ CSS_Property.valList(CSS_Time.valTime)
)(/* #__PURE__ */ fromString1("transition-delay"));
var transitionDelay = /* #__PURE__ */ CSS_Stylesheet.key(CSS_Time.valTime)(
  /* #__PURE__ */ fromString1("transition-delay")
);
var transition = function (p) {
  return function (d) {
    return function (f) {
      return function (e) {
        return prefixed(
          append1(CSS_Common.browsers)(fromString2("transition"))
        )(
          new Data_Tuple.Tuple(
            p,
            new Data_Tuple.Tuple(d, new Data_Tuple.Tuple(f, e))
          )
        );
      };
    };
...
var ordTimingStepsValue = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at CSS.Transition (line 0, column 0 - line 0, column 0): " +
