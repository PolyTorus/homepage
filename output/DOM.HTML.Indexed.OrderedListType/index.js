...
var renderOrderedListType = function (v) {
  ...
  if (
    v instanceof OrderedListNumeric &&
    v.value0 instanceof NumeralRoman &&
    v.value0.value0 instanceof Lowercase
  ) {
    return "i";
  }
  if (
    v instanceof OrderedListNumeric &&
    v.value0 instanceof NumeralRoman &&
    v.value0.value0 instanceof Uppercase
  ) {
    return "I";
  }
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.OrderedListType (line 27, column 25 - line 32, column 41): " +
      [v.constructor.name]
  );
};
var eqCaseType = {
...
var eqOrderedListType = {
  eq: function (x) {
    return function (y) {
      ...
      if (
        x instanceof OrderedListAlphabetic &&
        y instanceof OrderedListAlphabetic
      ) {
        return eq(x.value0)(y.value0);
      }
      return false;
...
var ordCaseType = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.OrderedListType (line 0, column 0 - line 0, column 0): " +
