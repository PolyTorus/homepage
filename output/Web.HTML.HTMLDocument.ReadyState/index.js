...
var showReadyState = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Web.HTML.HTMLDocument.ReadyState (line 16, column 10 - line 19, column 27): " +
        [v.constructor.name]
    );
  }
};
var print = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Web.HTML.HTMLDocument.ReadyState (line 22, column 9 - line 25, column 25): " +
      [v.constructor.name]
  );
};
...
var ordReadyState = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Web.HTML.HTMLDocument.ReadyState (line 0, column 0 - line 0, column 0): " +
