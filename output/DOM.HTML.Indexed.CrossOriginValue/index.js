...
var renderCrossOriginValue = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.CrossOriginValue (line 13, column 26 - line 15, column 38): " +
      [v.constructor.name]
  );
};
...
var ordCrossOriginValue = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.CrossOriginValue (line 0, column 0 - line 0, column 0): " +
