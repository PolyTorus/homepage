  ...
  return function (dictGenericOrd1) {
    ...
    return {
      "genericCompare'": function (v) {
        return function (v1) {
          if (
            v instanceof Data_Generic_Rep.Inl &&
            v1 instanceof Data_Generic_Rep.Inl
          ) {
            return genericCompare$prime1(v.value0)(v1.value0);
          }
          if (
            v instanceof Data_Generic_Rep.Inr &&
            v1 instanceof Data_Generic_Rep.Inr
          ) {
          ...
          throw new Error(
            "Failed pattern match at Data.Ord.Generic (line 19, column 1 - line 23, column 39): " +
