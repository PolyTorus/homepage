...
var quickCheck$prime = /* #__PURE__ */ Test_QuickCheck["quickCheck$prime"](
  /* #__PURE__ */ Test_QuickCheck.testableFunction(
    Test_QuickCheck_Arbitrary.arbUnit
  )(Test_QuickCheck.testableBoolean)
);
var quickCheck$prime1 = /* #__PURE__ */ Test_QuickCheck["quickCheck$prime"](
    ...
    return function (gen) {
      var submultiplicative = function (a) {
        return function (b) {
          ...
          throw new Error(
            "Failed pattern match at Test.QuickCheck.Laws.Data.EuclideanRing (line 76, column 3 - line 76, column 38): " +
      ...
      var quotRem = function (a) {
        return function (b) {
          ...
          throw new Error(
            "Failed pattern match at Test.QuickCheck.Laws.Data.EuclideanRing (line 65, column 3 - line 65, column 28): " +
              [a.constructor.name, b.constructor.name]
          );
        };
      };
      var nonnegativeEuclideanFunc = function (a) {
        ...
        throw new Error(
          "Failed pattern match at Test.QuickCheck.Laws.Data.EuclideanRing (line 60, column 3 - line 60, column 41): " +
            [a.constructor.name]
        );
      };
      var integralDomain = function (a) {
        return function (b) {
          ...
          throw new Error(
            "Failed pattern match at Test.QuickCheck.Laws.Data.EuclideanRing (line 55, column 3 - line 55, column 35): " +
              [a.constructor.name, b.constructor.name]
          );
        };
      };
      return function __do() {
        Effect_Console.log(
          "Checking 'Integral domain' law for EuclideanRing"
        )();
        ...
        Effect_Console.log(
          "Checking 'Nonnegative euclidean function' law for EuclideanRing"
        )();
        quickCheck$prime1(1000)(map(nonnegativeEuclideanFunc)(gen))();
        Effect_Console.log(
          "Checking 'Quotient/remainder' law for EuclideanRing"
        )();
