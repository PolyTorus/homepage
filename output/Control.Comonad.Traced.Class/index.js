...
var lowerTrack1 = /* #__PURE__ */ lowerTrack(
  Control_Comonad_Store_Trans.comonadTransStoreT
);
var lowerTrack2 = /* #__PURE__ */ lowerTrack(
  Control_Comonad_Trans_Class.comonadTransIdentityT
);
var lowerTrack3 = /* #__PURE__ */ lowerTrack(
  Control_Comonad_Env_Trans.comonadTransEnvT
);
...
var comonadTracedStoreT = function (dictComonadTraced) {
  var comonadStoreT = Control_Comonad_Store_Trans.comonadStoreT(
    dictComonadTraced.Comonad0()
  );
  return {
...
var comonadTracedIdentityT = function (dictComonadTraced) {
  var comonadIdentityT = Control_Monad_Identity_Trans.comonadIdentityT(
    dictComonadTraced.Comonad0()
  );
  return {
...
var comonadTracedEnvT = function (dictComonadTraced) {
  var comonadEnvT = Control_Comonad_Env_Trans.comonadEnvT(
    dictComonadTraced.Comonad0()
  );
  return {
