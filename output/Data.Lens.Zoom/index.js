...
var zoom = function (p) {
  var $7 = underF(Data_Lens_Internal_Focusing.Focusing)(
    under(Data_Profunctor_Star.Star)(p)
  );
  return function ($8) {
    return Control_Monad_State_Trans.StateT(
      $7(Control_Monad_State_Trans.runStateT($8))
    );
  };
};
export { zoom };
