...
var intercalate = /* #__PURE__ */ Data_Foldable.intercalate(foldableList)(
...
var foldlWithIndex1 = /* #__PURE__ */ Data_FoldableWithIndex.foldlWithIndex(
  foldableWithIndexList
);
  ...
  append: function (v) {
    return function (as$prime) {
      return new Data_NonEmpty.NonEmpty(
        v.value0,
        append1(v.value1)(toList(as$prime))
      );
    };
  }
};
        ...
        return function ($copy_memo) {
          ...
          function $tco_loop(source, memo) {
            ...
            if (v.value1 instanceof Data_Maybe.Nothing) {
              $tco_done = true;
              return foldl(Data_Function.flip(Cons.create))(Nil.value)(
                new Cons(v.value0, memo)
              );
            }
            throw new Error(
              "Failed pattern match at Data.List.Types (line 135, column 22 - line 137, column 61): " +
                [v.constructor.name]
            );
          }
          while (!$tco_done) {
      ...
      var go = function ($copy_source) {
        return function ($copy_memo) {
          ...
          function $tco_loop(source, memo) {
            ...
            throw new Error(
              "Failed pattern match at Data.List.Types (line 142, column 22 - line 144, column 52): " +
                [v.constructor.name]
            );
          }
          while (!$tco_done) {
...
var foldable1NonEmptyList =
  /* #__PURE__ */ Data_NonEmpty.foldable1NonEmpty(foldableList);
...
var extendList = {
  extend: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.Types (line 180, column 1 - line 187, column 42): " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  },
        ...
        var go = function ($copy_v) {
          return function ($copy_v1) {
            ...
            function $tco_loop(v, v1) {
              ...
              throw new Error(
                "Failed pattern match at Data.List.Types (line 60, column 5 - line 60, column 20): " +
                  [v.constructor.name, v1.constructor.name]
              );
            }
            while (!$tco_done) {
...
var applyList = {
  apply: function (v) {
    return function (v1) {
      ...
      if (v instanceof Cons) {
        return append1(map(v.value0)(v1))(
...
var applyNonEmptyList = {
  apply: function (v) {
    return function (v1) {
      return new Data_NonEmpty.NonEmpty(
        v.value0(v1.value0),
        append1(apply(v.value1)(new Cons(v1.value0, Nil.value)))(
          apply(new Cons(v.value0, v.value1))(v1.value1)
        )
      );
    };
  },
...
var bindList = {
  bind: function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.List.Types (line 164, column 1 - line 166, column 37): " +
          [v.constructor.name, v1.constructor.name]
      );
    };
  },
...
var traversable1NonEmptyList = {
  ...
  sequence1: function (dictApply) {
    return Data_Semigroup_Traversable.traverse1(traversable1NonEmptyList)(
      dictApply
    )(identity);
  },
  Foldable10: function () {
