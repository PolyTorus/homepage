...
var renderScopeValue = function (v) {
  ...
  throw new Error(
    "Failed pattern match at DOM.HTML.Indexed.ScopeValue (line 16, column 20 - line 21, column 22): " +
      [v.constructor.name]
  );
};
var eqScopeValue = {
...
var ordScopeValue = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at DOM.HTML.Indexed.ScopeValue (line 0, column 0 - line 0, column 0): " +
