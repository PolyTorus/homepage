...
var fromEvent =
  /* #__PURE__ */ Web_Internal_FFI.unsafeReadProtoTagged("CustomEvent");
export { new, newOptionsImpl, detail } from "./foreign.js";
export { fromEvent, toEvent, new$prime, newWithOptions };
