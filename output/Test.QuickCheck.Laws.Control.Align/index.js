...
var testableFunction = /* #__PURE__ */ Test_QuickCheck.testableFunction(
  /* #__PURE__ */ Test_QuickCheck_Arbitrary.arbFunction(
    Test_QuickCheck_Laws.coarbitraryA
  )(Test_QuickCheck_Laws.arbitraryC)
)(
  /* #__PURE__ */ Test_QuickCheck.testableFunction(
    /* #__PURE__ */ Test_QuickCheck_Arbitrary.arbFunction(
      Test_QuickCheck_Laws.coarbitraryB
    )(Test_QuickCheck_Laws.arbitraryD)
  )(Test_QuickCheck.testableBoolean)
);
var checkAlign = function (dictAlign) {
  ...
  return function (dictArbitrary) {
    ...
    var quickCheck$prime = Test_QuickCheck["quickCheck$prime"](
      testableFunction1(Test_QuickCheck.testableBoolean)
    );
    return function (dictArbitrary1) {
      var testableFunction2 = Test_QuickCheck.testableFunction(dictArbitrary1);
      var quickCheck$prime1 = Test_QuickCheck["quickCheck$prime"](
        testableFunction1(testableFunction2(Test_QuickCheck.testableBoolean))
      );
      var quickCheck$prime2 = Test_QuickCheck["quickCheck$prime"](
        testableFunction1(testableFunction2(testableFunction))
      );
      return function (dictArbitrary2) {
        var quickCheck$prime3 = Test_QuickCheck["quickCheck$prime"](
          testableFunction1(
            testableFunction2(
              Test_QuickCheck.testableFunction(dictArbitrary2)(
                Test_QuickCheck.testableBoolean
              )
            )
          )
              ...
              return function (dictEq3) {
                ...
                return function (v) {
                  var idempotency = function (fa) {
                    return eq(join(align(identity))(fa))(
                      map(join(Data_These.Both.create))(fa)
                    );
                  };
                  var functoriality = function (a) {
                    return function (b) {
                      return function (f) {
                        return function (g) {
                          return eq2(align(identity)(map(f)(a))(map(g)(b)))(
                            map(bimap(f)(g))(align(identity)(a)(b))
                          );
                        };
                      };
                    };
                  ...
                  var commutativity = function (fa) {
                    return function (fb) {
                      return eq1(align(identity)(fa)(fb))(
                        map(Data_These.swap)(align(identity)(fb)(fa))
                      );
                    };
                  };
                    ...
                    return function (fb) {
                      return function (fc) {
                        return eq3(
                          ...
                          map(Data_These.assoc)(
                            align(identity)(align(identity)(fa)(fb))(fc)
                          )
                        );
                      };
                    };
                  ...
                  return function __do() {
                    Effect_Console.log(
                      "Checking 'Idempotency' law for Align"
                    )();
                    quickCheck$prime(1000)(idempotency)();
                    Effect_Console.log(
                      "Checking 'Commutativity' law for Align"
                    )();
                    quickCheck$prime1(1000)(commutativity)();
                    Effect_Console.log(
                      "Checking 'Associativity' law for Align"
                    )();
                    quickCheck$prime3(1000)(associativity)();
                    Effect_Console.log(
                      "Checking 'Functoriality' law for Align"
                    )();
