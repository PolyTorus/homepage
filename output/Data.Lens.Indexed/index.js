...
var _Newtype = /* #__PURE__ */ Data_Lens_Iso_Newtype["_Newtype"]()()(
  Data_Profunctor.profunctorFn
);
var first = /* #__PURE__ */ Data_Profunctor_Strong.first(
  Data_Profunctor_Strong.strongFn
);
var unwrap = /* #__PURE__ */ Data_Newtype.unwrap();
var applicativeStateT =
  /* #__PURE__ */ Control_Monad_State_Trans.applicativeStateT(
    Data_Identity.monadIdentity
  );
var applicativeCompose =
  /* #__PURE__ */ Data_Functor_Compose.applicativeCompose(applicativeStateT);
var applyStateT = /* #__PURE__ */ Control_Monad_State_Trans.applyStateT(
  Data_Identity.monadIdentity
);
...
var map = /* #__PURE__ */ Data_Functor.map(
  /* #__PURE__ */ Control_Monad_State_Trans.functorStateT(
...
var iwander = function (itr) {
  return function (dictWander) {
    var $45 = Data_Lens_Internal_Wander.wander(dictWander)(
...
var positions = function (tr) {
  return function (dictWander) {
    return iwander(function (dictApplicative) {
      var tr1 = tr(
        Data_Lens_Internal_Wander.wanderStar(
          applicativeCompose(dictApplicative)
        )
      );
      return function (f) {
        return function (s) {
          return Data_Function.flip(Control_Monad_State.evalState)(0)(
            unwrap(
              Data_Function.flip(unwrap)(s)(
                tr1(function (a) {
                  return applyFirst(apply(map(f)(get))(pure(a)))(
                    modify(function (v) {
                      return (v + 1) | 0;
                    })
                  );
...
export { unIndex, asIndex, reindexed, iwander, itraversed, positions };
