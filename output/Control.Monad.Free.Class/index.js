...
var monadFreeWriterT = function (dictFunctor) {
  ...
  return function (dictMonadFree) {
    ...
    return function (dictMonoid) {
      var monadWriterT =
        Control_Monad_Writer_Trans.monadWriterT(dictMonoid)(Monad0);
      return {
        wrapFree: function (f) {
...
var monadFreeStateT = function (dictFunctor) {
  ...
  return function (dictMonadFree) {
    var wrapFree1 = wrapFree(dictMonadFree);
    var monadStateT = Control_Monad_State_Trans.monadStateT(
      dictMonadFree.Monad0()
    );
    return {
      wrapFree: function (f) {
        return function (s) {
...
var monadFreeReaderT = function (dictFunctor) {
  ...
  return function (dictMonadFree) {
    var wrapFree1 = wrapFree(dictMonadFree);
    var monadReaderT = Control_Monad_Reader_Trans.monadReaderT(
      dictMonadFree.Monad0()
    );
    return {
      wrapFree: function (f) {
...
var monadFreeMaybeT = function (dictFunctor) {
  ...
  return function (dictMonadFree) {
    var wrapFree1 = wrapFree(dictMonadFree);
    var monadMaybeT = Control_Monad_Maybe_Trans.monadMaybeT(
      dictMonadFree.Monad0()
    );
    return {
      wrapFree: function (f) {
...
var monadFreeExceptT = function (dictFunctor) {
  ...
  return function (dictMonadFree) {
    var wrapFree1 = wrapFree(dictMonadFree);
    var monadExceptT = Control_Monad_Except_Trans.monadExceptT(
      dictMonadFree.Monad0()
    );
    return {
      wrapFree: function (f) {
