...
var withPrism = function (l) {
  return function (f) {
    var v = l(
      new Data_Lens_Internal_Market.Market(identity, Data_Either.Right.create)
    );
    return f(v.value0)(v.value1);
  };
};
var review = /* #__PURE__ */ Data_Newtype.under()()(
  Data_Lens_Internal_Tagged.Tagged
);
var prism = function (to) {
  return function (fro) {
    return function (dictChoice) {
      ...
      return function (pab) {
        return dimap(fro)(Data_Either.either(identity)(identity))(
          right(rmap(to)(pab))
        );
      };
    };
  ...
  return function (fro) {
    return function (dictChoice) {
      return prism(to)(function (s) {
        return Data_Maybe.maybe(new Data_Either.Left(s))(
...
var is = function (dictHeytingAlgebra) {
  ...
  return function (l) {
    var $39 = Data_Either.either(Data_Function["const"](ff))(
      Data_Function["const"](tt)
    );
    var $40 = matching(l);
    return function ($41) {
      return $39($40($41));
      ...
      return withPrism(k)(function (bt) {
        return function (seta) {
          return prism(map(bt))(function (s) {
            ...
            throw new Error(
              "Failed pattern match at Data.Lens.Prism (line 199, column 7 - line 201, column 27): " +
                [v.constructor.name]
            );
          })(dictChoice);
        };
