...
var monadKillReaderT = function (dictMonadKill) {
  ...
  var monadThrowReaderT =
    Control_Monad_Reader_Trans.monadThrowReaderT(MonadThrow1);
  return {
    kill: function (e) {
      var $52 = kill1(e);
      return function ($53) {
...
var monadBracketReaderT = function (dictMonadBracket) {
  ...
  var monadErrorReaderT =
    Control_Monad_Reader_Trans.monadErrorReaderT(MonadError1);
  return {
    bracket: function (v) {
      return function (release) {
        return function (run) {
