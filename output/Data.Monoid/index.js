  ...
  return function (dictMonoid) {
    ...
    return function () {
      return function (dictMonoidRecord) {
        ...
        var semigroupRecordCons1 = semigroupRecordCons(
...
var power = function (dictMonoid) {
  ...
  return function (x) {
    var go = function (p) {
      ...
      throw new Error(
        "Failed pattern match at Data.Monoid (line 88, column 3 - line 88, column 17): " +
          [p.constructor.name]
      );
    };
    return go;
...
var guard = function (dictMonoid) {
  ...
  return function (v) {
    return function (v1) {
      ...
      throw new Error(
        "Failed pattern match at Data.Monoid (line 96, column 1 - line 96, column 49): " +
