...
var heytingAlgebraRecord =
  /* #__PURE__ */ Data_HeytingAlgebra.heytingAlgebraRecord();
...
var booleanAlgebraRecordCons = function (dictIsSymbol) {
  var heytingAlgebraRecordCons =
    Data_HeytingAlgebra.heytingAlgebraRecordCons(dictIsSymbol)();
  return function () {
    return function (dictBooleanAlgebraRecord) {
      var heytingAlgebraRecordCons1 = heytingAlgebraRecordCons(
        dictBooleanAlgebraRecord.HeytingAlgebraRecord0()
      );
      return function (dictBooleanAlgebra) {
        var heytingAlgebraRecordCons2 = heytingAlgebraRecordCons1(
          dictBooleanAlgebra.HeytingAlgebra0()
        );
        return {
          HeytingAlgebraRecord0: function () {
...
var booleanAlgebraRecord = function () {
  return function (dictBooleanAlgebraRecord) {
    var heytingAlgebraRecord1 = heytingAlgebraRecord(
      dictBooleanAlgebraRecord.HeytingAlgebraRecord0()
    );
    return {
      HeytingAlgebra0: function () {
...
var booleanAlgebraFn = function (dictBooleanAlgebra) {
  var heytingAlgebraFunction = Data_HeytingAlgebra.heytingAlgebraFunction(
    dictBooleanAlgebra.HeytingAlgebra0()
  );
  return {
    HeytingAlgebra0: function () {
