...
var traversed = function (dictTraversable) {
  ...
  return function (dictWander) {
    return Data_Lens_Internal_Wander.wander(dictWander)(
  ...
  return function (t) {
    return function (f) {
      return function (s) {
        ...
        throw new Error(
          "Failed pattern match at Data.Lens.Traversal (line 98, column 18 - line 100, column 32): " +
            [v.constructor.name]
        );
      };
    };
...
var element = function (dictWander) {
  ...
  return function (n) {
    return function (tr) {
      return unIndex(
        elementsOf1(function (dictWander1) {
...
var cloneTraversal = function (l) {
  return function (dictWander) {
    return Data_Lens_Internal_Wander.wander(dictWander)(
      function (dictApplicative) {
        return Data_Lens_Internal_Bazaar.runBazaar(
          l(function (dictApplicative1) {
            return identity;
          })
        )(dictApplicative);
      }
