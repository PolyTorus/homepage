...
var show1 = /* #__PURE__ */ Data_Show.show(
  Data_Interval_Duration.showDurationComponent
);
var eq = /* #__PURE__ */ Data_Eq.eq(Data_Interval_Duration.eqDuration);
var compare = /* #__PURE__ */ Data_Ord.compare(
  Data_Interval_Duration.ordDuration
);
var eq1 = /* #__PURE__ */ Data_Eq.eq(
  Data_Interval_Duration.eqDurationComponent
);
var compare1 = /* #__PURE__ */ Data_Ord.compare(
  Data_Interval_Duration.ordDurationComponent
);
...
var foldMap2 = /* #__PURE__ */ foldMap(
  /* #__PURE__ */ Data_Monoid_Additive.monoidAdditive(
...
var fold = /* #__PURE__ */ Data_Foldable.fold(Data_Foldable.foldableArray)(
  /* #__PURE__ */ Data_Monoid.monoidFn(Data_List_Types.monoidList)
);
var toUnfoldable = /* #__PURE__ */ Data_Map_Internal.toUnfoldable(
  Data_List_Types.unfoldableList
);
...
var showError = {
  show: function (v) {
    ...
    throw new Error(
      "Failed pattern match at Data.Interval.Duration.Iso (line 43, column 1 - line 47, column 76): " +
        [v.constructor.name]
    );
  }
};
var prettyError = function (v) {
  ...
  throw new Error(
    "Failed pattern match at Data.Interval.Duration.Iso (line 49, column 1 - line 49, column 31): " +
      [v.constructor.name]
  );
};
var eqIsoDuration = {
...
var eqError = {
  eq: function (x) {
    return function (y) {
      ...
      if (
        x instanceof InvalidWeekComponentUsage &&
        y instanceof InvalidWeekComponentUsage
      ) {
        return true;
      }
      if (
        x instanceof ContainsNegativeValue &&
        y instanceof ContainsNegativeValue
      ) {
        return eq1(x.value0)(y.value0);
      }
      if (
        x instanceof InvalidFractionalUse &&
...
var ordError = {
  compare: function (x) {
    return function (y) {
      ...
      throw new Error(
        "Failed pattern match at Data.Interval.Duration.Iso (line 0, column 0 - line 0, column 0): " +
...
var checkWeekUsage = function (v) {
  var $87 =
    Data_Maybe.isJust(lookup(Data_Interval_Duration.Week.value)(v.asMap)) &&
    Data_Map_Internal.size(v.asMap) > 1;
  if ($87) {
...
var checkFractionalUse = function (v) {
  ...
  var checkRest = function (rest) {
    return (
      unwrap(
        foldMap2(function ($108) {
          return Data_Monoid_Additive.Additive(
            Data_Number.abs(Data_Tuple.snd($108))
          );
        })(rest)
      ) > 0.0
    );
...
var mkIsoDuration = function (d) {
  ...
  throw new Error(
    "Failed pattern match at Data.Interval.Duration.Iso (line 60, column 19 - line 62, column 35): " +
      [v.constructor.name]
  );
};
export {
