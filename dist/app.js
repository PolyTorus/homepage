(() => {
  ...
  var ScrollTo = /* @__PURE__ */ function() {
    function ScrollTo2(value0) {
      this.value0 = value0;
    }
    ;
    ScrollTo2.create = function(value0) {
      return new ScrollTo2(value0);
    };
    return ScrollTo2;
  }();
  ...
  var renderHero = /* @__PURE__ */ section([/* @__PURE__ */ id2("home"), /* @__PURE__ */ class_("hero"), /* @__PURE__ */ style("min-height: calc(100vh - 80px); display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 4rem 0;")])([/* @__PURE__ */ h1([/* @__PURE__ */ style("font-size: 4rem; font-weight: 800; margin-bottom: 1.5rem; background: linear-gradient(135deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; line-height: 1.2;")])([/* @__PURE__ */ text5("\u7D14\u56FD\u7523\u30D6\u30ED\u30C3\u30AF\u30C1\u30A7\u30FC\u30F3"), br_, /* @__PURE__ */ text5("PolyTorus")]), /* @__PURE__ */ p([/* @__PURE__ */ style("font-size: 1.5rem; color: #666; margin-bottom: 3rem; max-width: 800px; line-height: 1.8;")])([/* @__PURE__ */ text5("\u30DD\u30B9\u30C8\u91CF\u5B50\u6642\u4EE3\u306B\u5BFE\u5FDC\u3057\u305F\u9769\u65B0\u7684\u306A4\u5C64\u30E2\u30B8\u30E5\u30E9\u30FC\u30D6\u30ED\u30C3\u30AF\u30C1\u30A7\u30FC\u30F3\u30D7\u30E9\u30C3\u30C8\u30D5\u30A9\u30FC\u30E0\u3002\u67D4\u8EDF\u306A\u6697\u53F7\u65B9\u5F0F\u3001\u30AB\u30B9\u30BF\u30DE\u30A4\u30BA\u53EF\u80FD\u306A\u30A2\u30FC\u30AD\u30C6\u30AF\u30C1\u30E3\u3001\u5B8C\u5168\u306A\u30EC\u30A4\u30E4\u30FC\u5206\u96E2\u3092\u5B9F\u73FE\u3002")]), /* @__PURE__ */ div3([/* @__PURE__ */ class_("buttons"), /* @__PURE__ */ style("display: flex; gap: 1.5rem; flex-wrap: wrap; justify-content: center;")])([/* @__PURE__ */ a([/* @__PURE__ */ href4("https://github.com/PolyTorus/polytorus"), /* @__PURE__ */ style("padding: 1rem 2.5rem; background: linear-gradient(135deg, #667eea, #764ba2); color: white; text-decoration: none; border-radius: 12px; font-weight: 600; font-size: 1.1rem; transition: transform 0.3s ease, box-shadow 0.3s ease; display: inline-block;"), /* @__PURE__ */ target6("_blank")])([/* @__PURE__ */ text5("\u4ECA\u3059\u3050\u59CB\u3081\u308B")]), /* @__PURE__ */ a([/* @__PURE__ */ href4("#docs"), /* @__PURE__ */ onClick(function(v) {
    return new ScrollTo("docs");
  }), /* @__PURE__ */ style("padding: 1rem 2.5rem; background: white; color: #667eea; text-decoration: none; border-radius: 12px; font-weight: 600; font-size: 1.1rem; border: 2px solid #667eea; transition: all 0.3s ease; display: inline-block;")])([/* @__PURE__ */ text5("\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8\u3092\u8AAD\u3080")])])]);
  var renderHeader = function(state3) {
    var renderNavItem = function(label5) {
      return function(href5) {
        return function(isActive) {
          return li_([a([href4(href5), onClick(function(v) {
            return new ScrollTo(drop2(1)(href5));
            ...
            ;
            return "#666";
          }() + "; text-decoration: none; font-weight: 500; transition: color 0.3s ease; position: relative;"))])([text5(label5)])]);
        };
      };
    };
    return header([style("position: fixed; top: 0; left: 0; right: 0; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); box-shadow: 0 2px 20px rgba(0,0,0,0.1); z-index: 1000; transition: all 0.3s ease;")])([nav([style("max-width: 1200px; margin: 0 auto; padding: 1rem 2rem; display: flex; justify-content: space-between; align-items: center;")])([div3([style("display: flex; align-items: center; gap: 0.5rem;")])([div3([style("width: 32px; height: 32px; background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 8px;")])([]), h1([style("font-size: 1.5rem; font-weight: 700; background: linear-gradient(135deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;")])([text5("PolyTorus")])]), ul([style("list-style: none; display: flex; gap: 2rem; align-items: center;")])([renderNavItem("\u30DB\u30FC\u30E0")("#home")(state3.activeSection === "home"), renderNavItem("\u7279\u5FB4")("#features")(state3.activeSection === "features"), renderNavItem("\u30A2\u30FC\u30AD\u30C6\u30AF\u30C1\u30E3")("#architecture")(state3.activeSection === "architecture"), renderNavItem("\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8")("#docs")(state3.activeSection === "docs"), li_([a([href4("https://github.com/PolyTorus/polytorus"), style("padding: 0.5rem 1.5rem; background: #333; color: white; text-decoration: none; border-radius: 8px; font-weight: 500; transition: all 0.3s ease;"), target6("_blank")])([text5("GitHub")])])])])]);
  };
  var renderGetStarted = /* @__PURE__ */ section([/* @__PURE__ */ id2("docs"), /* @__PURE__ */ class_("get-started"), /* @__PURE__ */ style("padding: 6rem 0; background: white; border-radius: 32px; margin: 2rem 0; box-shadow: 0 20px 60px rgba(0,0,0,0.1);")])([/* @__PURE__ */ div3([/* @__PURE__ */ style("max-width: 800px; margin: 0 auto; padding: 0 2rem;")])([/* @__PURE__ */ h2([/* @__PURE__ */ style("font-size: 3rem; font-weight: 700; text-align: center; margin-bottom: 3rem; color: #333;")])([/* @__PURE__ */ text5("\u30AF\u30A4\u30C3\u30AF\u30B9\u30BF\u30FC\u30C8")]), /* @__PURE__ */ div3([/* @__PURE__ */ style("background: #f8f9fa; padding: 2rem; border-radius: 16px; margin-bottom: 2rem;")])([/* @__PURE__ */ h3([/* @__PURE__ */ style("font-size: 1.5rem; font-weight: 600; margin-bottom: 1rem; color: #333;")])([/* @__PURE__ */ text5("\u5FC5\u8981\u74B0\u5883")]), /* @__PURE__ */ ul([/* @__PURE__ */ style("list-style: none; color: #666; line-height: 2;")])([/* @__PURE__ */ li_([/* @__PURE__ */ text5("\u2713 Rust 1.70\u4EE5\u964D\uFF08\u63A8\u5968\uFF1A\u6700\u65B0\u306E\u5B89\u5B9A\u7248\uFF09")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("\u2713 Cargo\uFF08Rust\u306B\u540C\u68B1\uFF09")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("\u2713 Git")]), /* @__PURE__ */ li_([/* @__PURE__ */ text5("\u2713 Linux\u3001macOS\u3001\u307E\u305F\u306FWSL2\u3092\u4F7F\u3063\u305FWindows")])])]), /* @__PURE__ */ div3([/* @__PURE__ */ style("margin-bottom: 3rem;")])([/* @__PURE__ */ h3([/* @__PURE__ */ style("font-size: 1.5rem; font-weight: 600; margin-bottom: 1rem; color: #333;")])([/* @__PURE__ */ text5("\u30A4\u30F3\u30B9\u30C8\u30FC\u30EB")]), /* @__PURE__ */ pre([/* @__PURE__ */ style("background: #1a1a1a; padding: 1.5rem; border-radius: 8px; overflow-x: auto; color: #f0f0f0;")])([/* @__PURE__ */ code_([/* @__PURE__ */ text5("git clone https://github.com/PolyTorus/polytorus.git\n"), /* @__PURE__ */ text5("cd polytorus\n"), /* @__PURE__ */ text5("cargo build --release")])])]), /* @__PURE__ */ div3([/* @__PURE__ */ style("text-align: center;")])([/* @__PURE__ */ a([/* @__PURE__ */ href4("https://github.com/PolyTorus/polytorus/blob/main/README.ja.md"), /* @__PURE__ */ style("display: inline-block; padding: 1rem 2.5rem; background: linear-gradient(135deg, #667eea, #764ba2); color: white; text-decoration: none; border-radius: 12px; font-weight: 600; font-size: 1.1rem; transition: transform 0.3s ease, box-shadow 0.3s ease;"), /* @__PURE__ */ target6("_blank")])([/* @__PURE__ */ text5("\u8A73\u7D30\u306A\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8\u3092\u898B\u308B")])])])]);
  var renderFooter = /* @__PURE__ */ footer([/* @__PURE__ */ style("padding: 4rem 2rem; text-align: center; color: rgba(255,255,255,0.8);")])([/* @__PURE__ */ div3([/* @__PURE__ */ style("max-width: 1200px; margin: 0 auto;")])([/* @__PURE__ */ div3([/* @__PURE__ */ style("display: flex; justify-content: center; gap: 2rem; margin-bottom: 2rem; flex-wrap: wrap;")])([/* @__PURE__ */ a([/* @__PURE__ */ href4("https://github.com/PolyTorus/polytorus"), /* @__PURE__ */ style("color: white; text-decoration: none;"), /* @__PURE__ */ target6("_blank")])([/* @__PURE__ */ text5("GitHub")]), /* @__PURE__ */ a([/* @__PURE__ */ href4("https://github.com/PolyTorus/polytorus/blob/main/README.ja.md"), /* @__PURE__ */ style("color: white; text-decoration: none;"), /* @__PURE__ */ target6("_blank")])([/* @__PURE__ */ text5("\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8")]), /* @__PURE__ */ a([/* @__PURE__ */ href4("https://github.com/PolyTorus/polytorus/issues"), /* @__PURE__ */ style("color: white; text-decoration: none;"), /* @__PURE__ */ target6("_blank")])([/* @__PURE__ */ text5("Issues")])]), /* @__PURE__ */ p([/* @__PURE__ */ style("font-size: 0.9rem; opacity: 0.8;")])([/* @__PURE__ */ text5("\xA9 2025 PolyTorus Project. All rights reserved.")])])]);
  var renderFeatures = /* @__PURE__ */ function() {
    var renderFeatureCard = function(icon) {
      return function(title3) {
        return function(description) {
          return div3([class_("feature-card"), style("background: #f8f9fa; padding: 2rem; border-radius: 16px; text-align: center; transition: all 0.3s ease; cursor: pointer;")])([div3([style("font-size: 3rem; margin-bottom: 1rem;")])([text5(icon)]), h3([style("font-size: 1.3rem; font-weight: 600; margin-bottom: 1rem; color: #333;")])([text5(title3)]), p([style("color: #666; line-height: 1.6;")])([text5(description)])]);
        };
      };
    };
    return section([id2("features"), class_("features"), style("padding: 6rem 0; background: white; border-radius: 32px; margin: 2rem 0; box-shadow: 0 20px 60px rgba(0,0,0,0.1);")])([div3([style("max-width: 1000px; margin: 0 auto; padding: 0 2rem;")])([h2([style("font-size: 3rem; font-weight: 700; text-align: center; margin-bottom: 1rem; color: #333;")])([text5("\u4E3B\u306A\u7279\u5FB4")]), p([style("text-align: center; color: #666; font-size: 1.2rem; margin-bottom: 4rem; max-width: 700px; margin-left: auto; margin-right: auto;")])([text5("PolyTorus\u306F\u6B21\u4E16\u4EE3\u306E\u30D6\u30ED\u30C3\u30AF\u30C1\u30A7\u30FC\u30F3\u6280\u8853\u3092\u7D71\u5408\u3057\u3001\u30B9\u30B1\u30FC\u30E9\u30D6\u30EB\u3067\u5B89\u5168\u306A\u30D7\u30E9\u30C3\u30C8\u30D5\u30A9\u30FC\u30E0\u3092\u63D0\u4F9B\u3057\u307E\u3059")]), div3([class_("grid"), style("display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;")])([renderFeatureCard("\u{1F510}")("Quantum-Resistant")("\u30DD\u30B9\u30C8\u91CF\u5B50\u6697\u53F7\u6280\u8853\u306B\u3088\u308A\u3001\u91CF\u5B50\u30B3\u30F3\u30D4\u30E5\u30FC\u30BF\u304B\u3089\u306E\u653B\u6483\u306B\u3082\u8010\u6027\u3092\u6301\u3064\u8A2D\u8A08"), renderFeatureCard("\u{1F9E9}")("\u30E2\u30B8\u30E5\u30E9\u30FC\u8A2D\u8A08")("\u5B9F\u884C\u5C64\u3001\u6C7A\u6E08\u5C64\u3001\u5408\u610F\u5C64\u3001\u30C7\u30FC\u30BF\u53EF\u7528\u6027\u5C64\u306E4\u5C64\u69CB\u9020\u3067\u9AD8\u3044\u67D4\u8EDF\u6027\u3092\u5B9F\u73FE"), renderFeatureCard("\u26A1")("\u9AD8\u6027\u80FD")("WebRTC P2P\u30CD\u30C3\u30C8\u30EF\u30FC\u30AF\u3068\u6700\u9069\u5316\u3055\u308C\u305FWASM\u30B9\u30DE\u30FC\u30C8\u30B3\u30F3\u30C8\u30E9\u30AF\u30C8\u5B9F\u884C\u74B0\u5883"), renderFeatureCard("\u{1F6E1}\uFE0F")("\u30BB\u30AD\u30E5\u30EA\u30C6\u30A3\u91CD\u8996")("Diamond IO\u306B\u3088\u308B\u30B9\u30DE\u30FC\u30C8\u30B3\u30F3\u30C8\u30E9\u30AF\u30C8\u306E\u96E3\u8AAD\u5316\u3068\u5305\u62EC\u7684\u306A\u30BB\u30AD\u30E5\u30EA\u30C6\u30A3\u6A5F\u80FD"), renderFeatureCard("\u{1F310}")("\u5B8C\u5168\u5206\u6563")("\u4E2D\u592E\u96C6\u6A29\u7684\u306A\u8981\u7D20\u3092\u6392\u9664\u3057\u305F\u3001\u771F\u306E\u5206\u6563\u578B\u30D6\u30ED\u30C3\u30AF\u30C1\u30A7\u30FC\u30F3\u30D7\u30E9\u30C3\u30C8\u30D5\u30A9\u30FC\u30E0"), renderFeatureCard("\u{1F527}")("\u958B\u767A\u8005\u30D5\u30EC\u30F3\u30C9\u30EA\u30FC")("\u5145\u5B9F\u3057\u305F\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8\u3068\u958B\u767A\u30C4\u30FC\u30EB\u3001\u30A2\u30AF\u30C6\u30A3\u30D6\u306A\u30B3\u30DF\u30E5\u30CB\u30C6\u30A3\u30B5\u30DD\u30FC\u30C8")])])]);
  }();
  var renderArchitecture = /* @__PURE__ */ function() {
    var renderLayerCard = function(title3) {
      return function(description) {
        return function(color) {
          return div3([class_("layer-card"), style("background: white; padding: 2rem; border-radius: 16px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.1); transition: all 0.3s ease; cursor: pointer; border-top: 4px solid " + (color + ";"))])([h3([style("font-size: 1.3rem; font-weight: 600; margin-bottom: 0.5rem; color: " + (color + ";"))])([text5(title3)]), p([style("color: #666; font-size: 0.95rem; line-height: 1.5;")])([text5(description)])]);
        };
      };
    };
    return section([id2("architecture"), class_("architecture"), style("padding: 6rem 0;")])([div3([style("max-width: 1000px; margin: 0 auto; padding: 0 2rem;")])([h2([style("font-size: 3rem; font-weight: 700; text-align: center; margin-bottom: 1rem; color: white;")])([text5("4\u5C64\u30E2\u30B8\u30E5\u30E9\u30FC\u30A2\u30FC\u30AD\u30C6\u30AF\u30C1\u30E3")]), p([style("text-align: center; color: rgba(255,255,255,0.9); font-size: 1.2rem; margin-bottom: 4rem; max-width: 700px; margin-left: auto; margin-right: auto;")])([text5("\u5404\u5C64\u304C\u72EC\u7ACB\u3057\u3066\u52D5\u4F5C\u3057\u3001\u5FC5\u8981\u306B\u5FDC\u3058\u3066\u30AB\u30B9\u30BF\u30DE\u30A4\u30BA\u53EF\u80FD\u306A\u9769\u65B0\u7684\u306A\u8A2D\u8A08")]), div3([class_("grid"), style("display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem;")])([renderLayerCard("\u5B9F\u884C\u5C64")("WASM \u30B9\u30DE\u30FC\u30C8\u30B3\u30F3\u30C8\u30E9\u30AF\u30C8\u5B9F\u884C")("#667eea"), renderLayerCard("\u6C7A\u6E08\u5C64")("Optimistic Rollup \u51E6\u7406")("#764ba2"), renderLayerCard("\u5408\u610F\u5C64")("Proof-of-Work \u30B3\u30F3\u30BB\u30F3\u30B5\u30B9")("#667eea"), renderLayerCard("\u30C7\u30FC\u30BF\u53EF\u7528\u6027\u5C64")("Merkle Tree \u3068\u30C7\u30FC\u30BF\u5206\u6563")("#764ba2")]), div3([style("margin-top: 4rem; background: rgba(255,255,255,0.1); padding: 2rem; border-radius: 16px; backdrop-filter: blur(10px);")])([h3([style("font-size: 1.5rem; font-weight: 600; margin-bottom: 1rem; color: white;")])([text5("Container Lab E2E\u30C6\u30B9\u30C8\u74B0\u5883")]), p([style("color: rgba(255,255,255,0.9); line-height: 1.8; margin-bottom: 1.5rem;")])([text5("\u672C\u756A\u74B0\u5883\u3092\u518D\u73FE\u3059\u308B\u5305\u62EC\u7684\u306A\u30C6\u30B9\u30C8\u74B0\u5883\u3092\u63D0\u4F9B\u3002WebRTC P2P\u30CD\u30C3\u30C8\u30EF\u30FC\u30AD\u30F3\u30B0\u3001\u30C8\u30E9\u30F3\u30B6\u30AF\u30B7\u30E7\u30F3\u4F1D\u64AD\u3001\u30DE\u30EB\u30C1\u30CE\u30FC\u30C9\u5354\u8ABF\u3092Docker\u30B3\u30F3\u30C6\u30CA\u3067\u7C21\u5358\u306B\u30C6\u30B9\u30C8\u53EF\u80FD\u3002")]), pre([style("background: rgba(0,0,0,0.3); padding: 1.5rem; border-radius: 8px; overflow-x: auto; color: #f0f0f0; font-size: 0.9rem;")])([code_([text5("# \u30C6\u30B9\u30C8\u30CD\u30C3\u30C8\u7528Docker\u30A4\u30E1\u30FC\u30B8\u306E\u30D3\u30EB\u30C9\n"), text5("docker build -f Dockerfile.testnet -t polytorus:testnet .\n\n"), text5("# 3\u30CE\u30FC\u30C9\u30C6\u30B9\u30C8\u30CD\u30C3\u30C8\u306E\u30C7\u30D7\u30ED\u30A4\n"), text5("./scripts/manual-test.sh start")])])])])]);
  }();
  var renderMain = /* @__PURE__ */ main([/* @__PURE__ */ style("padding: 80px 2rem 2rem 2rem; max-width: 1200px; margin: 0 auto;")])([renderHero, renderFeatures, renderArchitecture, renderGetStarted]);
  var component = /* @__PURE__ */ function() {
    var render = function(state3) {
      return div3([class_("app-root")])([renderHeader(state3), renderMain, renderFooter]);
    };
    ...
    var handleAction = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 45, column 18 - line 47, column 22): " + [v.constructor.name]);
    };
    return mkComponent({
      initialState,
      render,
...
setTimeout(function() { if(typeof main2 !== 'undefined') main2(); else console.error('main2 not found'); }, 0);